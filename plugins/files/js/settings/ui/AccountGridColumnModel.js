...
/**
 * @class Grommunio.plugins.files.settings.ui.AccountGridColumnModel
 * @extends Grommunio.common.ui.grid.ColumnModel
 */
Grommunio.plugins.files.settings.ui.AccountGridColumnModel = Ext.extend(Grommunio.common.ui.grid.ColumnModel, {
	...
	constructor: function (config) {
		...
		Grommunio.plugins.files.settings.ui.AccountGridColumnModel.superclass.constructor.call(this, config);
	},
	...
	createDefaultColumns: function () {
		return [
			new Ext.grid.RowNumberer(),
			{
				...
				width    : 40,
				sortable : false,
				renderer : Grommunio.plugins.files.settings.data.AccountRenderUtil.statusRenderer,
				...
				width    : 40,
				sortable : false,
				renderer : Grommunio.plugins.files.settings.data.AccountRenderUtil.backendRenderer,
				...
				items    : [{
					getClass: Grommunio.plugins.files.settings.data.AccountRenderUtil.featureRenderer.createDelegate(this, [Grommunio.plugins.files.data.AccountRecordFeature.QUOTA], true),
					...
					getClass: Grommunio.plugins.files.settings.data.AccountRenderUtil.featureRenderer.createDelegate(this, [Grommunio.plugins.files.data.AccountRecordFeature.VERSION_INFO], true),
					...
					getClass: Grommunio.plugins.files.settings.data.AccountRenderUtil.featureRenderer.createDelegate(this, [Grommunio.plugins.files.data.AccountRecordFeature.SHARING], true),
					...
					getClass: Grommunio.plugins.files.settings.data.AccountRenderUtil.featureRenderer.createDelegate(this, [Grommunio.plugins.files.data.AccountRecordFeature.STREAMING], true),
	 ...
	 * It will then display the {@link Grommunio.plugins.files.settings.ui.FeatureQuotaInfoContentPanel quota panel}.
	 *
	...
	showDialog: function(grid, rowIndex, componentType) {
		...
		Grommunio.core.data.UIFactory.openLayerComponent(Grommunio.core.data.SharedComponentType[componentType], undefined, {
			store  : grid.getStore(),
			item   : record,
