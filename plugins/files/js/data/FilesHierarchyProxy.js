...
/**
 * @class Grommunio.plugins.files.data.FilesHierarchyProxy
 * @extends Grommunio.core.data.MAPIProxy
 */
Grommunio.plugins.files.data.FilesHierarchyProxy = Ext.extend(Grommunio.core.data.MAPIProxy, {
	...
	constructor: function (config)
	{
		...
		Grommunio.plugins.files.data.FilesHierarchyProxy.superclass.constructor.call(this, config);
	},
	 ...
	 * @return {Object} An instance of the {@link Grommunio.plugins.files.data.FilesFolderResponseHandler ProxyResponseHandler}
