...
class PasskeyCredentialManager
{
    ...
    {
        $credential = [
            'id' => rtrim(strtr(base64_encode($publicKeyCredentialSource->publicKeyCredentialId), '+/', '-_'), '='),
            'rawId' => rtrim(strtr(base64_encode($publicKeyCredentialSource->publicKeyCredentialId), '+/', '-_'), '='),
            'publicKey' => rtrim(strtr(base64_encode($publicKeyCredentialSource->credentialPublicKey), '+/', '-_'), '='),
    ...
    {
        $credentials = PasskeyData::getCredentialsArray();
        $credentialId = rtrim(strtr(base64_encode($publicKeyCredentialSource->publicKeyCredentialId), '+/', '-_'), '=');
