 ...
 * SPDX-FileCopyrightText: Copyright 2012 Mads Freek Petersen, WAYF
...
class NemidCertificateCheck {
	public const GENERALIZED_TIME_FORMAT = 'YmdHis\Z';
	 ...
	 * @param mixed $nonce
	 * @param mixed $trustedroots
	 * @param mixed $disableocspcheck
	 */
