...
class SearchDistlistsTest extends grommunioTest {
	...
	public function providerDistlistProps() {
		...
		return [
			['subject', $distlist['subject']],
			['PR_SUBJECT', $distlist['subject']],
			['0x0037001e', $distlist['subject']],
			['display_name', $distlist['display_name']],
			['PR_DISPLAY_NAME', $distlist['display_name']],
			['0x3001001e', $distlist['display_name']],
		];
	}
}
