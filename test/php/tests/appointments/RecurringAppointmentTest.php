...
class RecurringAppointmentTest extends grommunioTest {
	...
	public function testDailyRecurringAppointment($props, $expectedCount) {
		...
		$items = $this->user->loadAppointments([
			'restriction' => [
	...
	public function providerDailyRecurringAppointment() {
		...
		return [
			...
			[['type' => 10, 'subtype' => 0, 'regen' => 0, 'everyn' => 1440, 'term' => 35], 5098],
			// Occur every day, end after 10 occurrences
			[['type' => 10, 'subtype' => 0, 'regen' => 0, 'everyn' => 1440, 'term' => 34, 'numoccur' => 10], 10],
			// Occur every day, end on given date
			[['type' => 10, 'subtype' => 0, 'regen' => 0, 'everyn' => 1440, 'term' => 33], 1828],

			// Occur every 5 days, no end limit
			[['type' => 10, 'subtype' => 0, 'regen' => 0, 'everyn' => 7200, 'term' => 35], 1020],
			// Occur every 5 days, end after 10 occurrences
			[['type' => 10, 'subtype' => 0, 'regen' => 0, 'everyn' => 7200, 'term' => 34, 'numoccur' => 10], 10],
			// Occur every 5 days, end on given date
			[['type' => 10, 'subtype' => 0, 'regen' => 0, 'everyn' => 7200, 'term' => 33], 366],

			// Occur every weekday, no end limit
			[['type' => 10, 'subtype' => 1, 'regen' => 0, 'everyn' => 1, 'term' => 35], 3642],
			// Occur every weekday, end after Y occurrences
			[['type' => 10, 'subtype' => 1, 'regen' => 0, 'everyn' => 1, 'term' => 34, 'numoccur' => 10], 10],
			// Occur every weekday, end on given date
			[['type' => 10, 'subtype' => 1, 'regen' => 0, 'everyn' => 1, 'term' => 33], 1306],
		];
	}
	...
	public function providerWeeklyRecurringAppointment() {
		...
		return [
			...
			[['type' => 11, 'subtype' => 1, 'regen' => 0, 'everyn' => 1, 'weekdays' => 8, 'term' => 35], 729],
			// Occur every week on Wednesday, end after 10 occurrences
			[['type' => 11, 'subtype' => 1, 'regen' => 0, 'everyn' => 1, 'weekdays' => 8, 'term' => 34, 'numoccur' => 10], 10],
			// Occur every week on wednesday, end on given date
			[['type' => 11, 'subtype' => 1, 'regen' => 0, 'everyn' => 1, 'weekdays' => 8, 'term' => 33], 262],

			// Occur every 5 weeks on Wednesday, no end limit
			[['type' => 11, 'subtype' => 1, 'regen' => 0, 'everyn' => 5, 'weekdays' => 8, 'term' => 35], 146],
			// Occur every 5weeks on Wednesday, end after 10 occurrences
			[['type' => 11, 'subtype' => 1, 'regen' => 0, 'everyn' => 5, 'weekdays' => 8, 'term' => 34, 'numoccur' => 10], 10],
			// Occur every 5 weeks on wednesday, end on given date
			[['type' => 11, 'subtype' => 1, 'regen' => 0, 'everyn' => 5, 'weekdays' => 8, 'term' => 33], 53],
		];
	}
	...
	public function providerMonthlyRecurringAppointment() {
		...
		return [
			...
			[['type' => 12, 'subtype' => 2, 'regen' => 0, 'everyn' => 1, 'monthday' => 17, 'term' => 35], 168],
			// Occur on every 17th of every month, end after 10 occurrences
			[['type' => 12, 'subtype' => 2, 'regen' => 0, 'everyn' => 1, 'monthday' => 17, 'term' => 34, 'numoccur' => 10], 10],
			// Occur on every 17th of every month, end on given date
			[['type' => 12, 'subtype' => 2, 'regen' => 0, 'everyn' => 1, 'monthday' => 17, 'term' => 33], 61],

			// Occur on every 17th of every 5 months, no end limit
			[['type' => 12, 'subtype' => 2, 'regen' => 0, 'everyn' => 5, 'monthday' => 17, 'term' => 35], 34],
			// Occur on every 17th of every 5 months, end after 10 occurrences
			[['type' => 12, 'subtype' => 2, 'regen' => 0, 'everyn' => 5, 'monthday' => 17, 'term' => 34, 'numoccur' => 10], 10],
			// Occur on every 17th of every 5 months, end on given date
			[['type' => 12, 'subtype' => 2, 'regen' => 0, 'everyn' => 5, 'monthday' => 17, 'term' => 33], 13],

			// Occur on every third Wednesday of every month, no end limit
			[['type' => 12, 'subtype' => 3, 'regen' => 0, 'everyn' => 1, 'nday' => 3, 'weekdays' => 8, 'term' => 35], 168],
			// Occur on every third Wednesday of every month, end after 10 occurrences
			[['type' => 12, 'subtype' => 3, 'regen' => 0, 'everyn' => 1, 'nday' => 3, 'weekdays' => 8, 'term' => 34, 'numoccur' => 10], 10],
			// Occur on every third Wednesday of every month, end on given date
			[['type' => 12, 'subtype' => 3, 'regen' => 0, 'everyn' => 1, 'nday' => 3, 'weekdays' => 8, 'term' => 33], 61],

			// Occur on every third Wednesday of every 5 months, no end limit
			[['type' => 12, 'subtype' => 3, 'regen' => 0, 'everyn' => 5, 'nday' => 3, 'weekdays' => 8, 'term' => 35], 34],
			// Occur on every third Wednesday of every 5 months, end after 10 occurrences
			[['type' => 12, 'subtype' => 3, 'regen' => 0, 'everyn' => 5, 'nday' => 3, 'weekdays' => 8, 'term' => 34, 'numoccur' => 10], 10],
			// Occur on every third Wednesday of every 5 months, end on given date
			[['type' => 12, 'subtype' => 3, 'regen' => 0, 'everyn' => 5, 'nday' => 3, 'weekdays' => 8, 'term' => 33], 13],
		];
	}
	...
	public function providerYearlyRecurringAppointment() {
		...
		return [
			...
			[['type' => 13, 'subtype' => 2, 'regen' => 0, 'everyn' => 12, 'month' => 305280, 'monthday' => 17, 'term' => 35], 14],
			// Occur on every August 17 of every year, end after 10 occurrences
			[['type' => 13, 'subtype' => 2, 'regen' => 0, 'everyn' => 12, 'month' => 305280, 'monthday' => 17, 'term' => 34, 'numoccur' => 10], 10],
			// Occur on every August 17 of every year, end on given date
			[['type' => 13, 'subtype' => 2, 'regen' => 0, 'everyn' => 12, 'month' => 305280, 'monthday' => 17, 'term' => 33], 6],

			// Occur on every third Wednesday of August, no end limit
			[['type' => 13, 'subtype' => 3, 'regen' => 0, 'everyn' => 12, 'nday' => 3, 'weekdays' => 8, 'month' => 305280, 'term' => 35], 14],
			// Occur on every third Wednesday of August, end after 10 occurrences
			[['type' => 13, 'subtype' => 3, 'regen' => 0, 'everyn' => 12, 'nday' => 3, 'weekdays' => 8, 'month' => 305280, 'term' => 34, 'numoccur' => 10], 10],
			// Occur on every third Wednesday of August, end on given date
			[['type' => 13, 'subtype' => 3, 'regen' => 0, 'everyn' => 12, 'nday' => 3, 'weekdays' => 8, 'month' => 305280, 'term' => 33], 6],

			// Occur on every July 17 of every year starting from same monthday of earlier month, no end limit
			[['type' => 13, 'subtype' => 2, 'regen' => 0, 'everyn' => 12, 'month' => 260640, 'monthday' => 17, 'term' => 35], 14],

			// Occur on every September 17 of every year starting from same monthday of later month, no end limit
			[['type' => 13, 'subtype' => 2, 'regen' => 0, 'everyn' => 12, 'month' => 349920, 'monthday' => 17, 'term' => 35], 14],
			...
			[['type' => 13, 'subtype' => 2, 'regen' => 0, 'everyn' => 12, 'month' => 305280, 'monthday' => 11, 'term' => 35], 13],

			// Occur on every August 21 of every year starting from same month, no end limit
			[['type' => 13, 'subtype' => 2, 'regen' => 0, 'everyn' => 12, 'month' => 305280, 'monthday' => 21, 'term' => 35], 14],

			// Occur on every July 11 of every year starting from earlier date, no end limit
			[['type' => 13, 'subtype' => 2, 'regen' => 0, 'everyn' => 12, 'month' => 260640, 'monthday' => 11, 'term' => 35], 14],

			// Occur on every September 21 of every year starting from later date, no end limit
			[['type' => 13, 'subtype' => 2, 'regen' => 0, 'everyn' => 12, 'month' => 349920, 'monthday' => 21, 'term' => 35], 14],
		];
	}
}
