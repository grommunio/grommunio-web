 ...
 * @coversNothing
 */
class BrokenEmlTest extends grommunioTest {
	/**
	...
	protected function setUp() {
		...
		$this->brokenEml = 'Return-Path: <shyam@grommunio.local>' . PHP_EOL .
			'Received: from grommunio.local (10.0.0.13:51400) by grommunio.local (grommunio-dagent)' . PHP_EOL .
			'  with LMTP; Mon, 7 May 2018 16:40:47 +0530' . PHP_EOL .
			'Received: from grommunio.local (localhost [127.0.0.1])  by grommunio.local' . PHP_EOL .
			' (Postfix) with ESMTP id 10841183A23 for <shyam@grommunio.local>; Mon, 7 May' . PHP_EOL .
			' 2018 16:40:47 +0530' . PHP_EOL .
			'Received: by grommunio.local (grommunio-spooler) with MAPI; Mon, 7 May 2018' . PHP_EOL .
			' 16:40:47 +0530' . PHP_EOL .
			'Subject: HTML mail' . PHP_EOL .
			'From: =?UTF-8?Q?Shyam_Shroff?= <shyam@grommunio.local>' . PHP_EOL;

		$this->validEml = 'Return-Path: <shyam@grommunio.local>' . PHP_EOL .
			'Received: from grommunio.local (10.0.0.13:51400) by grommunio.local (grommunio-dagent)' . PHP_EOL .
			'  with LMTP; Mon, 7 May 2018 16:40:47 +0530' . PHP_EOL .
			'Received: from grommunio.local (localhost [127.0.0.1])  by grommunio.local' . PHP_EOL .
			' (Postfix) with ESMTP id 10841183A23 for <shyam@grommunio.local>; Mon, 7 May' . PHP_EOL .
			...
			'Subject: HTML mail' . PHP_EOL .
			'From: =?UTF-8?Q?Shyam_Shroff?= <shyam@grommunio.local>' . PHP_EOL .
			'To: =?utf-8?Q?Shyam_Shroff?= <shyam@grommunio.local>' . PHP_EOL .
			...
			'X-Mailer: grommunio 8.6.80' . PHP_EOL .
			'Message-Id: <kcis.050E6953E8374CD9A904C3651BCCF237@grommunio.local>' . PHP_EOL;
	}
