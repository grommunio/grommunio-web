...
abstract class grommunioTest extends PHPUnit_Framework_TestCase {
	...
	public function providerSpecialCharacterProps()
	{
		return array(
			...
			array('Cron <root@intranet> /root/bin/backup/grommunio/.customer.de', 'Cron customer'),
			array('Cron <root@intranet> /root/bin/backup/grommunio/.customer.de', 'cron CUSTOMER'),
			array('Cron <root@intranet> /root/bin/backup/grommunio/.customer.de', 'grommunio/.de'),
			array('Cron <root@intranet> /root/bin/backup/grommunio/.customer.de', 'customer'),
			array('Cron <root@intranet> /root/bin/backup/grommunio/.customer.de', 'grommunio/ customer'),
			array('Cron <root@intranet> /root/bin/backup/grommunio/.customer.de', 'root@intranet'),
			array('Cron <root@intranet> /root/bin/backup/grommunio/.customer.de', 'backup'),
			array('Cron <root@intranet> /root/bin/backup/grommunio/.customer.de', '/root/bin/backup'),
			...
			array('dummy@grommunio/.com', 'grommunio/.com'),
			array('dummy@grommunio/.com', 'dummy'),
			array('dummy@grommunio/.com', 'micheal.schofield@grommunio/.com', false),
			array('micheal.schofield@grommunio/.com', 'micheal.schofield@grommunio/.co.eu', false)
		);
	}
}
