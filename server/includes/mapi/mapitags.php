...
define('PR_RECEIVED_BY_SMTP_ADDRESS', mapi_prop_tag(PT_TSTRING, 0x5D07));
...
define('PR_SENT_REPRESENTING_SMTP_ADDRESS', mapi_prop_tag(PT_STRING8, 0x5D02));
...
define('PR_RCVD_REPRESENTING_SMTP_ADDRESS', mapi_prop_tag(PT_TSTRING, 0x5D08));
...
define('PR_SENDER_SMTP_ADDRESS', mapi_prop_tag(PT_TSTRING, 0x5D01));
...
define('PR_EC_USER_LANGUAGE', mapi_prop_tag(PT_STRING8, PR_EC_BASE + 0x70));
define('PR_EC_USER_TIMEZONE', mapi_prop_tag(PT_STRING8, PR_EC_BASE + 0x71));
...
define('PR_EC_WA_FILES_ENCRYPTION_KEY', mapi_prop_tag(PT_BINARY, PR_EC_BASE + 0xE2));
...
define('PR_NATIVE_BODY', mapi_prop_tag(PT_LONG, 0x1016));
