...
/**
 * @class Grommunio.calendar.data.DayBoxConfiguration
 * @extends Object
 *
 * The configuration object for DayBoxes as used in the
 * {@link Grommunio.calendar.ui.AbstractCalendarBoxView CalendarBoxView}
 * for configuration of the individual DayBoxes.
 */
Grommunio.calendar.data.DayBoxConfiguration = Ext.extend(Object, {
	/**
	 * @constructor
	...
	/**
	 * The {@link Grommunio.core.mapi.BusyStatus BusyStatus} which is active on this day.
	 * This value depends on the allday events which might be scheduled for this {@link #date}.
	 * @property
	 * @type Grommunio.core.mapi.BusyStatus
	 */
	 ...
	 * within the requested {@link Grommunio.core.DateRange daterange} for which the appointments
	 * have been requested.
	 * @property
	 * @type Boolean
	 */
