...
/**
 * @class Grommunio.calendar.data.busytime.BusyTimeProxy
 * @extends Grommunio.core.data.MAPIProxy
 */
Grommunio.calendar.data.busytime.BusyTimeProxy = Ext.extend(Grommunio.core.data.MAPIProxy,
{
	/**
	 * @constructor
	...
	constructor: function(config)
	{
		...
		Ext.applyIf(config, {
			listModuleName: Grommunio.core.ModuleNames.getListName('busytime')
		});

		Grommunio.calendar.data.busytime.BusyTimeProxy.superclass.constructor.call(this, config);
	},
	...
	{
		return new Grommunio.calendar.data.busytime.BusyTimeResponseHandler({
			proxy: this,
			action: action,
			reader: reader,
			options: args,
