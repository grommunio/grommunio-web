...
/**
 * @class Grommunio.calendar.data.AppointmentBounds
 * @extends Object
 *
 * The configuration object for appointments as used in the
 * {@link Grommunio.calendar.ui.AbstractDateRangeView DateRangeView}
 * for configuration of the individual bodies or the header
 * of an appointment.
 */
Grommunio.calendar.data.AppointmentBounds = Ext.extend(Object, {
	/**
	 * @constructor
	...
	/**
	 * This indicates if this is the first {@link Grommunio.calendar.data.AppointmentBounds bound}
	 * for an {@link Grommunio.calendar.ui.AppointmentView appointment}. This implies that _if_ this
	...
	/**
	 * This indicates if this is the last {@link Grommunio.calendar.data.AppointmentBounds bound}
	 * for an {@link Grommunio.calendar.ui.AppointmentView appointment}. This implies that _if_ this
