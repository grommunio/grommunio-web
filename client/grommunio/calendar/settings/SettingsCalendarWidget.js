...
/**
 * @class Grommunio.calendar.settings.SettingsCalendarWidget
 ...
 * the general calendar options in the {@link Grommunio.calendar.settings.SettingsCalendarCategory calendar category}.
 */
Grommunio.calendar.settings.SettingsCalendarWidget = Ext.extend(Grommunio.settings.ui.SettingsWidget, {
	...
	constructor: function(config)
	{
		...
		Ext.applyIf(config, {
			...
			items: [{
				...
				name: 'grommunio/v1/main/week_start',
				store: dayStore,
				mode: 'local',
				triggerAction: 'all',
				displayField: 'name',
				...
				startFieldConfig: {
					...
					name: 'grommunio/v1/main/start_working_hour',
					incrementValue: 30,
				...
				endFieldConfig: {
					...
					name: 'grommunio/v1/main/end_working_hour',
					incrementValue: 30,
					alternateIncrementValue: 1,
				...
				name: 'grommunio/v1/contexts/calendar/default_zoom_level',
				store: zoomStore,
				mode: 'local',
				triggerAction: 'all',
				displayField: 'name',
				...
				plugins: [{
					ptype: 'grommunio.splitfieldlabeler',
					firstLabelCfg: {
				...
				items: [{
					...
					ref: '../durationSpinner',
					name: 'grommunio/v1/contexts/calendar/default_appointment_period',
					labelSplitter: '{A}',
					allowBlank: false,
					allowDecimals: false,
					allowNegative: false,
				...
				name: 'grommunio/v1/contexts/calendar/default_allday_busy_status',
				store: {
					xtype: 'jsonstore',
					fields: [ 'name', 'value' ],
				...
				name: 'grommunio/v1/main/working_days',
				width: 225,
				columns: 4,
				items: [
				{
				...
				hideLabel: true,
				name: 'grommunio/v1/contexts/calendar/datepicker_show_busy',
				listeners: {
				...
				hideLabel: true,
				name: 'grommunio/v1/contexts/calendar/remove_meetingrequest_on_calendar_response',
				listeners: {
		...
		Grommunio.calendar.settings.SettingsCalendarWidget.superclass.constructor.call(this, config);
	},
	 ...
	 * from {@link Grommunio.common.ui.SpinnerField duration} spinner field.
	 *
	 * @param {Grommunio.common.ui.SpinnerField} field The spinner field which holds
	...
	/**
	 * Event handler which is fired when the {@link Grommunio.common.ui.TimePeriodField}
	 * fires the {@link Grommunio.common.ui.TimePeriodField#change change} event.
	 * @param {Grommunio.common.ui.TimePeriodField} field The field which fired the event
	 * @param {Grommunio.core.DateRange} newValue The new value which is set on the field
	 * @param {Grommunio.core.DateRange} oldValue the old value which was previously set
	 * @private
	 */
...
Ext.reg('grommunio.settingscalendarwidget', Grommunio.calendar.settings.SettingsCalendarWidget);
