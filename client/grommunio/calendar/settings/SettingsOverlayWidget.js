...
/**
 * @class Grommunio.calendar.settings.SettingsOverlayWidget
 ...
 * the calendar overlay behavior in the {@link Grommunio.calendar.settings.SettingsCalendarCategory calendar category}.
 */
Grommunio.calendar.settings.SettingsOverlayWidget = Ext.extend(Grommunio.settings.ui.SettingsWidget, {
	...
	constructor: function(config)
	{
		...
		Ext.applyIf(config, {
			...
			items: [{
				...
				name: 'grommunio/v1/contexts/calendar/default_merge_state',
				store: overlayStore,
				mode: 'local',
				triggerAction: 'all',
				displayField: 'name',
...
Ext.reg('grommunio.settingsoverlaywidget', Grommunio.calendar.settings.SettingsOverlayWidget);
