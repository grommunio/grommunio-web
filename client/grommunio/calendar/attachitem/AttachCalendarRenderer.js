...
/**
 * @class Grommunio.calendar.attachitem.AttachCalendarRenderer
 * @extends Grommunio.common.attachment.dialogs.AttachItemBaseRenderer
 *
 * Renderer that can be used to get text data from {@link Grommunio.calendar.AppointmentRecord AppointmentRecord}.
 */
Grommunio.calendar.attachitem.AttachCalendarRenderer = Ext.extend(Grommunio.common.attachment.dialogs.AttachItemBaseRenderer, {
	/**
	...
	{
		Grommunio.calendar.attachitem.AttachCalendarRenderer.superclass.constructor.call(this, config);
	...
	{
		var data = Grommunio.calendar.attachitem.AttachCalendarRenderer.superclass.prepareData.apply(this, arguments);
		...
		if(record.get('busystatus') === Grommunio.core.mapi.BusyStatus.BUSY) {
