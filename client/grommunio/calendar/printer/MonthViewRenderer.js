 ...
 */
Grommunio.calendar.printer.MonthViewRenderer = Ext.extend(Grommunio.calendar.printer.AbstractViewRenderer, {
	...
	{
		config = config || {};
		Grommunio.calendar.printer.MonthViewRenderer.superclass.constructor.call(this, config);
	},
	 ...
	 * @param {Date} startDate The start date of {@link Grommunio.core.DateRange DateRange}.
	 * @param {Number} numDays The number of days belongs to selected {@link Grommunio.core.DateRange DateRange}.
	 * @param {Grommunio.calendar.CalendarContextModel} model The {@link Grommunio.calendar.CalendarContextModel CalendarContextModel}.
	...
	{
		var appointments = [];
		var dateRange = new Grommunio.core.DateRange();
	 ...
	 *
	 * @param {Grommunio.calendar.AppointmentRecord} records The {@link Grommunio.calendar.AppointmentRecord AppointmentRecord}
