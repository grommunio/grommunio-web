...
/**
 * @class Grommunio.calendar.printer.MeetingRenderer
 ...
 */
Grommunio.calendar.printer.MeetingRenderer = Ext.extend(Grommunio.common.printer.renderers.RecordRenderer, {
	/**
	...
	prepareData: function(record) {
		var data = Grommunio.calendar.printer.MeetingRenderer.superclass.prepareData.apply(this, arguments);
