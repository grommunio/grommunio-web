...
/**
 * @class Grommunio.calendar.ui.CalendarViewDragZone
 ...
 */
Grommunio.calendar.ui.CalendarViewDragZone = Ext.extend(Ext.dd.DragZone, {
	/**
	 * The calendar on which this DragZone is installed
	 * @property
	 * @type Grommunio.calendar.ui.AbstractCalendarView
	 * @private
	 */
	calendar: undefined,
	...
	/**
	 * @constructor
	 * @param {Grommunio.calendar.ui.AbstractCalendarView} calendar The calendar on which this Dragzone is installed
	...
	constructor: function(calendar, config)
	{
		...
		Grommunio.calendar.ui.CalendarViewDragZone.superclass.constructor.call(this, element, config);
	 ...
	 * <li><b>calendar</b>: Grommunio.calendar.ui.AbstractCalendarView<div class="sub-desc">The CalendarView from which the data is being dragged.</div></li>
	 ...
	 * <li><b>target</b: Grommunio.calendar.ui.AppointmentView<div class="sub-desc">The appointment on which the drag action started.</div></li>
	 * </ul></p>
	 * @private
	 */
	...
	{
		Grommunio.calendar.ui.CalendarViewDragZone.superclass.b4StartDrag.apply(this, arguments);
	...
	{
		Grommunio.calendar.ui.CalendarViewDragZone.superclass.startDrag.apply(this, arguments);
	...
	beforeDragOut: function(target, e, id)
	{
		...
		return this.dragData.state !== Grommunio.calendar.data.DragStates.SELECTING;
	},
	 ...
	 * is cleared in {@link #onInitDrag}. In this case we call {@link Grommunio.calendar.ui.AbstractCalendarView#handleMouseDown}
	 ...
	 * {@link Grommunio.calendar.ui.AbstractCalendarView#onMouseUp}
	...
	/**
	 * Search for the {@link Grommunio.calendar.ui.AppointmentView appointment} on which the
	 * given {@link Ext.EventObject event} tool place. This requires {@link Grommunio.calendar.ui.AppointmentView#eventOverBody}
	 * to be true when {@link #headerMode} is false, otherwise {@link Grommunio.calendar.ui.AppointmentView#eventOverHeader} must
	 * be true.
	 * @param {Ext.EventObject} e The event from where we obtain the appointment
	 * @return {Grommunio.calendar.ui.AppointmentView} The appointment on which the event occurred
	 * @private
	 */
	 ...
	 * and will return the appropriate {@link Grommunio.calendar.data.DragStates} value.
	 * @param {Ext.EventObject} e The event
	 * @param {Grommunio.calendar.ui.AppointmentView} appointment The appointment to check
	 * @return {Grommunio.calendar.data.DragStates} The Drag State for the current action
	 * @private
	 */
	getDragStateFromEvent: function(e, appointment)
	{
		if (this.headerMode !== true) {
			if (!Ext.isDefined(appointment)) {
				return Grommunio.calendar.data.DragStates.SELECTING;
			} else if (appointment.eventOverBodyStartHandle(e)) {
				return Grommunio.calendar.data.DragStates.RESIZING_START;
			} else if (appointment.eventOverBodyDueHandle(e)) {
				return Grommunio.calendar.data.DragStates.RESIZING_DUE;
			} else {
				return Grommunio.calendar.data.DragStates.DRAGGING;
			}
		} else {
			if (!Ext.isDefined(appointment)) {
				return Grommunio.calendar.data.DragStates.SELECTING;
