...
/**
 * @class Grommunio.calendar.ui.html.CalendarBoxView
 * @extends Grommunio.calendar.ui.AbstractCalendarBoxView
 *
 * HTML based implementation of {@link Grommunio.calendar.ui.AbstractCalendarBoxView AbstractCalendarBoxView}.
 *
 ...
 */
Grommunio.calendar.ui.html.CalendarBoxView = Ext.extend(Grommunio.calendar.ui.AbstractCalendarBoxView, {
	/**
	...
	constructor: function(config)
	{
		...
		Ext.applyIf(config, {
			...
			bodyDropConfig: {
				...
				draggingSnapMode: Grommunio.calendar.data.SnapModes.NONE
			}
		});

		Grommunio.calendar.ui.html.CalendarBoxView.superclass.constructor.call(this, config);
	},
	...
	{
		Grommunio.calendar.ui.html.CalendarBoxView.superclass.render.call(this, container);
	...
	{
		return new Grommunio.calendar.ui.html.AppointmentBoxView({
			parentView: this,
			record: record,
	...
	{
		return new Grommunio.calendar.ui.html.AppointmentProxy({ showTime: false });
	},
	...
	drawDays: function()
	{
		...
		var headerBgColor = Grommunio.core.ColorSchemes.createLightColor(this.calendarColorScheme.base, 1.6);
		...
		this.dayBoxConfigurations.forEach(function(dayBox, i) {
			...
			if (dayBox.active) {
				...
				bgColor = Grommunio.core.ColorSchemes.createLightColor(this.calendarColorScheme.base, 1.9);
			}
	 ...
	 * {@link Grommunio.calendar.ui.CalendarBlockPanel#onDayCLick onDayCLick} handler will process it.
	...
	{
		Grommunio.calendar.ui.html.CalendarBoxView.superclass.onAppointmentDeselect.call(this, selectionModel, record);
	...
	onLayout: function()
	{
		...
		// Parent layout
		Grommunio.calendar.ui.html.CalendarBoxView.superclass.onLayout.call(this);
