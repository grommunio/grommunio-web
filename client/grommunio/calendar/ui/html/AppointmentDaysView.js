...
/**
 * @class Grommunio.calendar.ui.html.AppointmentDaysView
 ...
 */
Grommunio.calendar.ui.html.AppointmentDaysView = Ext.extend(Grommunio.calendar.ui.AppointmentView, {
	...
	layoutAppointment: function(bounds, layer, showStartTime) {
		...
		var isDarkColor = Grommunio.core.ColorSchemes.isDark(color);
		...
		switch ( busyStatus ) {
			...
			case Grommunio.core.mapi.BusyStatus.WORKINGELSEWHERE:
				busyClass = ' k-status-workingelsewhere';
				break;
			default:
	...
	{
		Grommunio.calendar.ui.html.AppointmentDaysView.superclass.setSelected.call(this, selected);
