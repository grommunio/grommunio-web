...
/**
 * @class Grommunio.calendar.ui.html.AppointmentProxy
 * @extends Grommunio.calendar.ui.AppointmentView
 *
 * A special {@link Grommunio.calendar.ui.AppointmentView} which acts as proxy for the
 * {@link Grommunio.calendar.ui.CalendarViewDropZone} when an appointment is being resized or
 * dragged over the calendar.
 *
 * This will render the selected area as a grey block with some extra information text.
 */
Grommunio.calendar.ui.html.AppointmentProxy = Ext.extend(Grommunio.calendar.ui.AppointmentView, {
	...
	constructor: function(config)
	{
		...
		Grommunio.calendar.ui.html.AppointmentProxy.superclass.constructor.call(this, config);
	},
	...
	init: function()
	{
		Grommunio.calendar.ui.html.AppointmentProxy.superclass.init.call(this);
	...
	setDateRange: function(dateRange)
	{
		...
		Grommunio.calendar.ui.html.AppointmentProxy.superclass.setDateRange.call(this, dateRange);
		if (this.dateRange) {
	...
	{
		Grommunio.calendar.ui.html.AppointmentProxy.superclass.render.apply(this, arguments);
	...
	{
		Grommunio.calendar.ui.html.AppointmentProxy.superclass.setVisible.call(this, visible);

		if (visible) {
			this.setBodyClass('grommunio-calendar-selection grommunio-calendar-selection-dragging grommunio-calendar-dragproxy-time');
			this.setHeaderClass('grommunio-calendar-selection grommunio-calendar-selection-dragging');
		} else {
			this.setBodyClass('grommunio-calendar-selection');
			this.setHeaderClass('grommunio-calendar-selection');
		}
	 ...
	 * the view.
	 * @param {Grommunio.core.DateRange} dateRange the changed daterange
	 */
	...
	onLayout: function()
	{
		Grommunio.calendar.ui.html.AppointmentProxy.superclass.onLayout.call(this);
