...
/**
 * @class Grommunio.calendar.ui.html.AppointmentBoxView
 * @extends Grommunio.calendar.ui.AppointmentView
 *
 * Appointment view used in {@link Grommunio.calendar.ui.AbstractCalendarBoxView CalendarBoxView}. It represents each appointment as one
 ...
 */
Grommunio.calendar.ui.html.AppointmentBoxView = Ext.extend(Grommunio.calendar.ui.AppointmentView, {
	/**
	 * Array of objects containing the {@link Grommunio.calendar.data.AppointmentBounds bounds} for the
	 * {@link #body} elements which are part of the appointment. This field is initialized in
	 * {@link #layoutInBody} using the function
	 * {@link Grommunio.calendar.ui.AbstractCalendarBoxView#dateRangeToBodyBounds dateRangeToBodyBounds}.
	 * @property
	 * @type Array
	 */
	bounds: undefined,
	...
	{
		Grommunio.calendar.ui.html.AppointmentBoxView.superclass.setSelected.call(this, selected);
	...
	{
		return Grommunio.calendar.ui.html.AppointmentDaysView.prototype.eventOverStartHandle.call(this, event);
	},
	...
	{
		return Grommunio.calendar.ui.html.AppointmentDaysView.prototype.eventOverDueHandle.call(this, event);
	},
	...
	{
		return Grommunio.calendar.ui.html.AppointmentDaysView.prototype.eventOverAppointment.call(this, event);
	},
	 ...
	 * function {@link Grommunio.calendar.ui.AbstractCalendarBoxView.dateRangeToBodyBounds dateRangeToBodyBounds},
	...
	layoutInBody: function()
	{
		...
		if (!Ext.isEmpty(this.bounds)) {
			Grommunio.calendar.ui.html.AppointmentDaysView.prototype.layoutAppointment.call(this, this.bounds, this.parentView.bodyAppointmentLayer, true);
		}
	},
	 ...
	 * {@link Grommunio.calendar.data.DataModes#MONTH month view} mode.
