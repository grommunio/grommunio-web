...
Ext.namespace('Grommunio.calendar.ui.html');

/**
 * @class Grommunio.calendar.ui.html.CalendarDaysView
 * @extends Grommunio.calendar.ui.AbstractCalendarDaysView
 *
 * HTML based implementation of {@link Grommunio.calendar.ui.AbstractCalendarDaysView AbstractCalendarDaysView}.
 *
 ...
 */
Grommunio.calendar.ui.html.CalendarDaysView = Ext.extend(Grommunio.calendar.ui.AbstractCalendarDaysView, {
	/**
	 ...
	 * @property
	 * @type Grommunio.calendar.ui.html.AppointmentDaysView
	 */
	...
	constructor: function(config)
	{
		...
		Grommunio.calendar.ui.html.CalendarDaysView.superclass.constructor.call(this, config);
	...
	{
		Grommunio.calendar.ui.html.CalendarDaysView.superclass.render.call(this, container);
	...
	{
		return new Grommunio.calendar.ui.html.AppointmentDaysView({
			parentView: this,
			record: record,
	 ...
	 * @param {Grommunio.core.ui.View} child child view to be removed
	...
	removeChildView: function(child, destroy)
	{
		...
		return Grommunio.calendar.ui.html.CalendarDaysView.superclass.removeChildView.apply(this, arguments);
	},

	/**
	 * Create an Appointment Proxy object which can represent the selected time slot
	 * @return Grommunio.calendar.ui.html.AppointmentProxy
	 * @protected
	 */
	createAppointmentProxy: function()
	{
		return new Grommunio.calendar.ui.html.AppointmentProxy({ showTime: true });
	},
	 ...
	 * {@link Grommunio.calendar.ui.AbstractCalendarView#onLayout} from the {@link #width}
	 * the {@link Grommunio.calendar.ui.CalendarMultiView multiview} handed out, so calling
	 ...
	 *
	 * @param {Array} dayPositions The array of {@link Grommunio.calendar.data.DayLayoutPosition LayoutPositions} for the various days.
	 * @private
	 */
	drawHeader: function(dayPositions)
	{
		...
		var isDarkColor = Grommunio.core.ColorSchemes.isDark(this.calendarColorScheme.base);
		if ( isDarkColor ){
	...
	/**
	 * This will determine on which {@link Grommunio.core.data.IPMRecord record}
	 * the event was fired.
	 * @param {Ext.EventObject} event The event for which the selection must be updated.
	 * @return {Grommunio.core.data.IPMRecord} The record (if any) on which
	 * the event was fired.
	 * @private
	 */
	 ...
	 *
	 * @param {Grommunio.calendar.ui.AppointmentSelectionModel} selectionModel The selection model which fired the event.
	...
	{
		Grommunio.calendar.ui.html.CalendarDaysView.superclass.onAppointmentDeselect.call(this, selectionModel, record);
	...
	onLayout: function()
	{
		Grommunio.calendar.ui.html.CalendarDaysView.superclass.onLayout.call(this);
