...
/**
 * @class Grommunio.calendar.ui.CalendarGridColumnModel
 * @extends Grommunio.common.ui.grid.ColumnModel
 *
 * The {@link Grommunio.calendar.ui.CalendarGridColumnModel CalendarGridColumnModel
 * is the default {@link Ext.grid.ColumnModel ColumnModel} for the Calendar.
 */
Grommunio.calendar.ui.CalendarGridColumnModel = Ext.extend(Grommunio.common.ui.grid.ColumnModel, {
	/**
	 * @constructor
	...
	constructor: function(config)
	{
		...
		Grommunio.calendar.ui.CalendarGridColumnModel.superclass.constructor.call(this, config);
	},
	...
	createColumns: function()
	{
		return [{
			...
			width: 160,
			renderer: Grommunio.common.ui.grid.Renderers.meetingstatus
		},{
			header: _('Show as'),
			dataIndex: 'busystatus',
			tooltip: _('Sort by: Show as'),
			width: 160,
			renderer: Grommunio.common.ui.grid.Renderers.busystatus,
			hidden: true
		},{
			header: _('Categories'),
			...
			width: 160,
			renderer: Grommunio.common.ui.grid.Renderers.label,
			hidden: true
		},{
			header: _('Organizer'),
			...
			hidden: true,
			renderer: Grommunio.common.ui.grid.Renderers.organizer
		},{
			...
			width: 160,
			renderer: Grommunio.common.ui.grid.Renderers.date,
			hidden: true
		},{
			...
			width: 160,
			renderer: Grommunio.common.ui.grid.Renderers.sensitivity,
			hidden: true
		},{
			header: _('Importance'),
