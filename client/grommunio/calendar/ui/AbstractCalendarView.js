...
/**
 * @class Grommunio.calendar.ui.AbstractCalendarView
 * @extends Grommunio.core.ui.View
 *
 * Base class for calendar views. It supports containing multiple {@link Grommunio.hierarchy.data.MAPIFolderRecord folders},
 * and can display the different folders side-by-side using {@link Grommunio.calendar.ui.CalendarTabView tabs}.
 *
 * TODO refactor the use of separate startDate, dueDate parameters in the events to use the DateRange object.
 */
Grommunio.calendar.ui.AbstractCalendarView = Ext.extend(Grommunio.core.ui.View, {
	/**
	 * @cfg {Grommunio.calendar.ui.DateRangeSelectionModel} rangeSelectionModel The selection model
	 * used for selecting a particular {@link Grommunio.core.DateRange daterange}.
	 */
	rangeSelectionModel: undefined,

	/**
	 * @cfg {Grommunio.calendar.ui.AppointmentSelectionModel} selectionModel The selection model
	 * used for selecting {@link Grommunio.core.data.IPMRecord records}.
	 */
	selectionModel: undefined,

	/**
	 * @cfg {Grommunio.calendar.CalendarContextModel} contextModel A reference to the context model of the parent view
	 */
	contextModel: undefined,

	/**
	 * The array of {@link Grommunio.hierarchy.data.MAPIFolderRecord folders} which are opened
	 * by this {@link Grommunio.core.ui.View view}.
	 * @property
	 * @type Array
	 */
	folders: undefined,
	...
	/**
	 * The currently selected {@link Grommunio.hierarchy.data.MAPIFolderRecord folder} within
	 * this {@link Grommunio.core.ui.View view}. If set, this must be an element
	...
	/**
	 * The array of {@link Grommunio.calendar.ui.CalendarTabView tabs} which
	 * are visible within this {@link Grommunio.core.ui.View view}. Each
	 * {@link Grommunio.hierarchy.data.MAPIFolderRecord folder} from the {@link #folders} array
	 * will have one {@link Grommunio.calendar.ui.CalendarTabView tab} assigned
	 * to it.
	 * @property
	 * @type Grommunio.calendar.ui.CalendarTabView
	 */
	tabs: undefined,

	/**
	 * The {@link Grommunio.calendar.ui.SelectionRangeView view} element which displays
	 * the currently selected period in this calendar {@link Grommunio.core.ui.View view}.
	 * @property
	 * @type Grommunio.calendar.ui.SelectionRangeView
	 */
	selectionView: undefined,

	/**
	 * The {@link Grommunio.calendar.ui.TextEditView view} which is enabled when the
	 ...
	 * @property
	 * @type Grommunio.calendar.ui.TextEditView
	 */
	textEditView: undefined,

	/**
	 * The array of {@link Grommunio.calendar.ui.AppointmentView appointments} which
	 ...
	 * the {@link Grommunio.calendar.ui.AppointmentView appointments} which are rendered within this
	 ...
	 * the {@link Grommunio.calendar.ui.AppointmentView appointments} which are rendered within
	 ...
	 * @property
	 * @type Grommunio.calendar.ui.CalendarViewDragZone
	 * @private
	 */
	 ...
	 * @property
	 * @type Grommunio.calendar.ui.CalendarViewDropZone
	 * @private
	 */
	...
	/**
	 * @cfg {String} groupId The unique identifier for the {@link Grommunio.core.MultiFolderContextModel#getGroupings group}
	 * which refers to this calendar and the group of {@link #folders}.
	 */
	groupId: undefined,

	/**
	 * @cfg {Boolean} active Flag whether this view is the currently active one inside the {@link Grommunio.calendar.ui.CalendarMultiView}
	...
	constructor: function(config)
	{
		...
		this.addEvents(
			 ...
			 * @param {Grommunio.calendar.ui.AbstractCalendarDaysView} calendar The calendar which fired the event
			 * @param {Grommunio.calendar.ui.AbstractCalendarDaysView} source The calendar from where the appointment was dragged
			 * @param {Grommunio.calendar.AppointmentRecord} appointment the appointment record that was dropped
			 * @param {Grommunio.core.DateRange} dateRange The new daterange for the appointment
			 ...
			 * @param {Grommunio.calendar.ui.AbstractCalendarDaysView} calendar The calendar which fired the event
			 * @param {Grommunio.calendar.AppointmentRecord} record The appointment over which the mouse is moving
			 * @param {Ext.EventObject} event The original event object
			 */
			 ...
			 * @param {Grommunio.calendar.ui.AbstractCalendarDaysView} calendar The calendar which fired the event
			 * @param {Grommunio.calendar.AppointmentRecord} record The appointment over which the mouse has moved out
			 * @param {Ext.EventObject} event The original event object
			 */
			'appointmentmouseout',
			/**
			 ...
			 * @param {Grommunio.calendar.ui.AbstractCalendarDaysView} calendar The calendar which fired the event
			 * @param {Grommunio.calendar.AppointmentRecord} appointment the appointment record that was moved
			 * @param {Grommunio.core.DateRange} dateRange The new daterange for the appointment
			 * @param {Ext.EventObject} event The original event object
			 */
			'appointmentmove',
			 ...
			 * @param {Grommunio.calendar.ui.AbstractCalendarDaysView} calendar The calendar which fired the event
			 * @param {Grommunio.calendar.AppointmentRecord} appointment the appointment record that was resized
			 * @param {Grommunio.core.DateRange} dateRange The new daterange for the appointment
			 * @param {Ext.EventObject} event The original event object
			 */
			'appointmentresize',
			 ...
			 * @param {Grommunio.calendar.ui.AbstractCalendarDaysView} calendar The calendar which fired the event
			 * @param {Grommunio.core.DateRange} appointment date range.
			 ...
			 * This event is passed up to the {@link Grommunio.calendar.ui.CalendarPanel}
			 *
			 * @param {Grommunio.calendar.ui.CalendarMultiView} multiview The Calendar MultiView which fired the event
			 * @param {Ext.EventObject} event The mouse event
			 * @param {Grommunio.calendar.ui.AppointmentView} The appointment on which the event occurred
			 */
			'appointmentinitdrag',
			 ...
			 * @param {Grommunio.calendar.ui.AbstractCalendarDaysView} calendar Calendar view
			 * @param {Ext.EventObject} event right-click event.
			 * @param {Ext.Record} appointment record
			 * @param {Grommunio.core.DateRange} range The Datarange on which the contextmenu
			 ...
			 * @param {Grommunio.core.ui.View} source event source
		...
		Grommunio.calendar.ui.AbstractCalendarView.superclass.constructor.call(this, config);
	},
	...
	{
		// super.init
		Grommunio.calendar.ui.AbstractCalendarView.superclass.init.call(this);
		...
		this.textEditView = new Grommunio.calendar.ui.TextEditView();
	 ...
	 * @param {Grommunio.hierarchy.data.MAPIFolderRecord} folder MAPI folder to add to this view.
	 */
	addFolder: function(folder)
	{
		...
		var tab = new Grommunio.calendar.ui.CalendarTabView({
			parentView: this,
			folder: folder
		});
		...
		// the tab will be rendered automatically in the render() method through Grommunio.core.ui.View::renderChildren().
		if (this.rendered) {
	 ...
	 * @param {Grommunio.hierarchy.data.MAPIFolderRecord} folder MAPI folder to remove from this view.
	 */
	 ...
	 * @return {Grommunio.hierarchy.data.MAPIFolderRecord} folder object if the folder was found, or undefined otherwise.
	 */
	getFolderById: function(id)
	{
		// Find folder object to go with the folder ID.
		for (var i=0, folder; (folder = this.folders[i]); i++) {
			if (Grommunio.core.EntryId.compareEntryIds(folder.get('entryid'), id)) {
				return folder;
			}
		}
	},
	 ...
	 * @return {Grommunio.hierarchy.data.MAPIFolderRecord[]} MAPI folders currently in this view.
	 */
	getFolders: function()
	{
		return this.folders;
	 ...
	 * @param {Grommunio.hierarchy.data.MAPIFolderRecord} folder The folder which is currently selected
	 */
	 ...
	 * @return {Grommunio.hierarchy.data.MAPIFolderRecord} currently selected MAPI folder.
	 */
	 ...
	 * @param {Grommunio.hierarchy.data.MAPIFolderRecord} folder MAPI folders currently in this view.
	 ...
	 * @param {Grommunio.hierarchy.data.MAPIFolderRecord[]} folders Folder list.
	 */
	 ...
	 * @return {Grommunio.core.DateRange} The daterange
	 */
	...
	/**
	 * The {@link Grommunio.calendar.ui.CalendarMultiView CalendarMultiView} view has a header area that automatically
	...
	/**
	 * The {@link Grommunio.calendar.ui.CalendarMultiView CalendarMultiView} view has a tab area that is visible when there
	 ...
	 * @return {Grommunio.calendar.ui.AppointmentView} an appointment view iff found, undefined otherwise
	 */
	...
	/**
	 * Create a new {@link Grommunio.calendar.ui.AppointmentView Appointment} object
	 * for the given {@link Grommunio.core.data.IPMRecord record}.
	 * Subclasses must override this function to make the appointments visible
	 * in this view.
	 * @param {Grommunio.core.data.IPMRecord} record The record for which the AppointmentView
	 * must be created.
	 * @return {Grommunio.calendar.ui.AppointmentView} The new appointmentview
	 * @protected
	 */
	 ...
	 * @return Grommunio.calendar.ui.AbstractDateRangeView
	 * @protected
	 */
	...
	addAppointment: function(record, layout)
	{
		...
		if ( Grommunio.core.MessageClass.getDefaultFolderTypeFromMessageClass(record.get('message_class')) !== 'calendar' ){
			return false;
		}
	 ...
	 * @param {Boolean} layout (optional) if true layout() will be called after the appointment was added. Defaults to true.
	 * @return {Grommunio.calendar.ui.AppointmentView[]} a list of appointments that were removed.
	 */
	 ...
	 * @return {Grommunio.core.data.IPMRecord[]} records.
	 */
	 ...
	 * @param {Grommunio.core.DateRange} dateRange date range
	 ...
	 * {@link Grommunio.calendar.ui.CalendarMultiView CalendarMultiView} before layout.
	 ...
	 * @param {Number} x horizontal component of the location
	 * @param {Number} y vertical component of the location
	 * @return {Grommunio.core.DateRange} A DateRange object that corresponds to the given location
	 */
	 ...
	 *
	 * @param {Grommunio.calendar.ui.AppointmentView} a appointment A
	 * @param {Grommunio.calendar.ui.AppointmentView} b appointment B
	...
	render: function(container)
	{
		...
		this.createDiv(this.parentView.header, 'header', 'grommunio-calendar-header');
		...
		Grommunio.calendar.ui.AbstractCalendarView.superclass.render.call(this, container);
		this.renderChildren();
		...
		if (this.enableDD || this.enableBodyDD || this.enableBodyDrag) {
			if (!this.bodyDragZone && this.body) {
				this.bodyDragZone = new Grommunio.calendar.ui.CalendarViewDragZone(this, this.bodyDragConfig || {
		...
		if (this.enableDD || this.enableHeaderDD || this.enableHeaderDrag) {
			if (!this.headerDragZone && this.header) {
				this.headerDragZone = new Grommunio.calendar.ui.CalendarViewDragZone(this, this.headerDragConfig || {
					ddGroup: this.ddGroup || 'AppointmentDD',
					headerMode: true
				});
			}
		...
		if (this.enableDD || this.enableBodyDD || this.enableBodyDrop) {
			if (!this.bodyDropZone && this.body) {
				this.bodyDropZone = new Grommunio.calendar.ui.CalendarViewDropZone(this, this.bodyDropConfig || {
					ddGroup: this.ddGroup || 'AppointmentDD',
					headerMode: false,
					selectingSnapMode: Grommunio.calendar.data.SnapModes.ZOOMLEVEL,
					draggingSnapMode: Grommunio.calendar.data.SnapModes.ZOOMLEVEL
				});
		...
		if (this.enableDD || this.enableHeaderDD || this.enableHeaderDrop) {
			if (!this.headerDropZone && this.header) {
				this.headerDropZone = new Grommunio.calendar.ui.CalendarViewDropZone(this, this.headerDropConfig || {
					ddGroup: this.ddGroup || 'AppointmentDD',
					headerMode: true,
					selectingSnapMode: Grommunio.calendar.data.SnapModes.DAY,
					draggingSnapMode: Grommunio.calendar.data.SnapModes.DAY
				});
	 ...
	 * @param {Grommunio.calendar.ui.TextEditView} view The view which raised the event.
	...
	onLayout: function()
	{
		...
		if ( !selectedFolder ) {
			return Grommunio.calendar.ui.AbstractCalendarView.superclass.onLayout.call(this);
		}
		...
		Grommunio.calendar.ui.AbstractCalendarView.superclass.onLayout.call(this);

		this.layoutTabs();
	},

	/**
	 * This will call {@link Grommunio.core.ui.View#layout layout} on all the
	 * {@link #children}.
	 * @protected
	 */
	...
	/**
	 * Called by the {@link #parentView} when the {@link Grommunio.core.data.IPMStore#beforeload beforeload} event
	 * has been fired from the appointment {@link Grommunio.calendar.ui.CalendarMultiView#store store}.
	 * @param {Grommunio.core.data.IPMStore} store store that fired the event.
	...
	/**
	 * Called by the {@link #parentView} when the {@link Grommunio.core.data.IPMStore#load load} event
	 * has been fired from the appointment {@link Grommunio.calendar.ui.CalendarMultiView#store store}.
	 * @param {Grommunio.core.data.IPMStore} store store that fired the event.
	...
	/**
	 * Called by the {@link #parentView} when the {@link Grommunio.core.data.IPMStore#add add} event
	 * has been fired from the appointment {@link Grommunio.calendar.ui.CalendarMultiView#store store}.
	...
	/**
	 * Called by the {@link #parentView} when the {@link Grommunio.core.data.IPMStore#remove remove} event
	 * has been fired from the appointment {@link Grommunio.calendar.ui.CalendarMultiView#store store}.
	 ...
	 * {@link Grommunio.calendar.ui.AppointmentSelectionModel#appointmentselect appointmentselect} event.
	 * This will lookup which {@link Grommunio.calendar.ui.AppointmentView appointment} belongs to the
	 * given {@link Grommunio.core.data.IPMRecord record} and will use
	 * {@link Grommunio.calendar.ui.AppointmentView#setSelected setSelected} to mark the appointment
	 * as selected.
	 * @param {Grommunio.calendar.ui.AppointmentSelectionModel} selectionModel The selection model which
	 * fired the event.
	 * @param {Grommunio.core.data.IPMRecord} record The record which was selected.
	 * @private
	 */
	...
	/**
	 * Event handler which is fired when the {@link #selectionModel} fires the
	 * {@link Grommunio.calendar.ui.AppointmentSelectionModel#appointmentdeselect appointmentdeselect} event.
	 * This will lookup which {@link Grommunio.calendar.ui.AppointmentView appointment} belongs to the
	 * given {@link Grommunio.core.data.IPMRecord record} and will use
	 * {@link Grommunio.calendar.ui.AppointmentView#setSelected setSelected} to mark the appointment
	 * as unselected.
	 * @param {Grommunio.calendar.ui.AppointmentSelectionModel} selectionModel The selection model which
	 * fired the event.
	 * @param {Grommunio.core.data.IPMRecord} record The record which was deselected.
	 * @private
	 */
	...
	/**
	 * Event handler which is fired when the {@link #selectionModel} fires the
	 * {@link Grommunio.calendar.ui.AppointmentSelectionModel#selectionclear selectionclear} event.
	 * This will call {@link Grommunio.calendar.ui.AppointmentView#setSelected setSelected} for
	 ...
	 * set.
	 * @param {Grommunio.calendar.ui.DateRangeSelectionModel} selectionModel range selection model firing the event.
	 * @param {Grommunio.core.DateRange} dateRange selected date range, or undefined if not active.
	 * @param {Grommunio.calendar.ui.AbstractCalendarView} calendarView the calendar view the selection was made on.
	...
	/**
	 * Called by the {@link Grommunio.calendar.ui.CalendarViewDragZone} to determine the text
	 * of the {@link Grommunio.calendar.ui.AppointmentView appointment} which is being dragged.
	 ...
	 * @param {Grommunio.calendar.ui.AbstractCalendarView} calendar The calendar from where the appointment was dragged
	 * @param {Grommunio.calendar.ui.AppointmentView} appointment The appointment which was dropped
	 * @param {Grommunio.core.DateRange} dateRange The daterange for the appointment
	 * @private
	 */
	 ...
	 * @param {Ext.EventObject} event The event object
	 * @param {Grommunio.calendar.ui.AppointmentView} appointment The moved appointment
	 * @param {Grommunio.core.DateRange} dateRange The daterange for the appointment
	 * @private
	 */
	 ...
	 * @param {Ext.EventObject} event The event object
	 * @param {Grommunio.calendar.ui.AppointmentView} appointment The resized appointment
	 * @param {Grommunio.core.DateRange} dateRange The daterange for the appointment
	 * @private
	 */
	 ...
	 * @param {Grommunio.calendar.ui.AppointmentView} appointment The appointment object
	 * @private
	 */
	 ...
	 * If an {@link Grommunio.calendar.ui.AppointmentView appointment} was selected and moved this will mark
	 * the given appointment as selected.
	 * @param {Object} event The event object
	 * @param {Grommunio.calendar.ui.AppointmentView} appointment The selected appointment
	 * @private
	 */
	...
	/**
	 * Method called from {@link Grommunio.calendar.ui.CalendarViewDragZone#onInitDrag} when the user starts dragging
	 *
	 * @param {Ext.EventObject} event The mouse event
	 * @param {Grommunio.calendar.ui.AppointmentView} appointment The appointment on which the event occurred
	 * @private
	 */
	...
	/**
	 * Method called from {@link Grommunio.calendar.ui.CalendarViewDragZone#onInitDrag} when the user releases an appointment they had been dragging.
	 *
	 * @param {Ext.EventObject} event The mouse event
	 * @param {Grommunio.calendar.ui.AppointmentView} The appointment on which the event occurred
	 * @private
	...
	/**
	 * Event handler for the D&D proxy, which is called when an given {@link Grommunio.core.DateRange dateRange}
	 * has been selected. This will update the {@link #rangeSelectionModel}
	 * @param {Object} event The event object
	 * @param {Grommunio.core.DateRange} dateRange The dateRange which was selected.
	 * @private
	 */
	...
	destroy: function()
	{
		...
		Grommunio.calendar.ui.AbstractCalendarView.superclass.destroy.call(this);
	},

	/**
	 * Set this view to the currently active one in the {@link Grommunio.calendar.CalendarMultiView}
