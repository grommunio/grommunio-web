...
/**
 * @class Grommunio.calendar.printer.ListViewRenderer
 * @extends Grommunio.common.printer.renderers.BaseRenderer
 *
 * Prints a list of all calendar items in a folder
 */
Grommunio.calendar.printer.ListViewRenderer = Ext.extend(Grommunio.common.printer.renderers.BaseRenderer, {
	/**
	 ...
	 * @param {Grommunio.calendar.CalendarContext} context The calendar list view in the webapp
