...
/**
 * @class Grommunio.calendar.KeyMapping
 * @extends Object
 *
 * The map of keys used in the Calendar Context.
 * @singleton
 */
Grommunio.calendar.KeyMapping = Ext.extend(Object, {
	/**
	 * @constructor
	 */
	...
	{
		Grommunio.calendar.Actions.openCreateAppointmentContent(container.getContextByName('calendar').getModel());
	},
	...
	{
		Grommunio.calendar.Actions.openCreateMeetingRequestContent(container.getContextByName('calendar').getModel());
	},

	/**
	 * Event handler for the keydown event of the {@link Grommunio.core.KeyMap KeyMap} when the user wants
	 * switch between {@link Grommunio.core.ui.MainContentTabPanel MainContentTabs} calendar ranges.
	 * @param {Number} key Key code
	 * @param {Ext.EventObject} event The event
	 * @param {Ext.Component} component The component on which key event is fired.
	 */
	...
	{
		var records = Grommunio.common.KeyMapping.getSelectedRecords(component);
	...
	onPaste: function (key, event, component)
	{
		...
		if (component.isClipBoardDataRecurring) {
			...
			Grommunio.calendar.Actions.copyRecurringItemContent(record, config);
...
Grommunio.calendar.KeyMapping = new Grommunio.calendar.KeyMapping();
