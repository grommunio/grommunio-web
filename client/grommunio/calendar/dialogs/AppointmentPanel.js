...
/**
 * @class Grommunio.calendar.dialogs.AppointmentPanel
 * @extends Ext.Panel
 * @xtype grommunio.appointmentpanel
 *
 * Panel that is used to create Appointments and Meeting Requests.
 */
Grommunio.calendar.dialogs.AppointmentPanel = Ext.extend(Ext.Panel, {
	 ...
	 * @param {Grommunio.calendar.dialogs.AppointmentPanel} panel This appointmentpanel
	 */

	/**
	 * @cfg {Number} activeTab, the tab which should be active in {Grommunio.calendar.dialogs.AppointmentPanel tabs}
	...
	constructor: function(config)
	{
		...
		Grommunio.calendar.dialogs.AppointmentPanel.superclass.constructor.call(this, config);
	},
	...
	onTabPanelUpdate: function(record, contentReset)
	{
		...
		if (!contentReset && record.isModifiedSinceLastUpdate('meeting') && record.get('meeting') == Grommunio.core.mapi.MeetingStatus.NONMEETING) {
	...
	/**
	 * Event handler which is fired when data in {@link Grommunio.core.data.IPMRecipientStore} has changed.
	 * This will reset the flag {@link Grommunio.calendar.dialogs.AppointmentPanel enableNotifier}
	 * @private
	 */
...
Ext.reg('grommunio.appointmentpanel', Grommunio.calendar.dialogs.AppointmentPanel);
