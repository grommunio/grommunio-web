...
/**
 * @class Grommunio.calendar.widget.CalendarFolderSelectionLink
 ...
 */
Grommunio.calendar.widget.CalendarFolderSelectionLink = Ext.extend(Ext.BoxComponent, {
	/**
	...
	constructor: function(config)
	{
		...
		Grommunio.calendar.widget.CalendarFolderSelectionLink.superclass.constructor.call(this, config);
	},

	/**
	 * This function is called after the component has been rendered.
	 * This will update {@link Grommunio.widgets.folderwidgets.CalendarFolderSelectionLink} with selected folder
	 * and will register {@link #onClick} event handler.
	 * @private
	 */
	afterRender: function()
	{
		Grommunio.calendar.widget.CalendarFolderSelectionLink.superclass.afterRender.apply(this, arguments);
	...
	/**
	 * Called when user clicks on a {@link Grommunio.widgets.folderwidgets.CalendarFolderSelectionLink}
	...
	update: function(folder)
	{
		...
		Grommunio.calendar.widget.CalendarFolderSelectionLink.superclass.update.call(this, this.tpl.apply(data));
	}
});

Ext.reg('grommunio.calendarfolderselectionlink', Grommunio.calendar.widget.CalendarFolderSelectionLink);
