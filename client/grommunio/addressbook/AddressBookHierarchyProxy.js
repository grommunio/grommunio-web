...
/**
 * @class Grommunio.addressbook.AddressBookHierarchyProxy
 * @extends Grommunio.core.data.IPMProxy
 *
 * proxy object which will communicate between store and server side code
 */
Grommunio.addressbook.AddressBookHierarchyProxy = Ext.extend(Grommunio.core.data.IPMProxy, {
	/**
	 * @constructor
	...
	constructor: function(config)
	{
		...
		var module = Grommunio.core.ModuleNames.getModule('addressbook');
		...
		Grommunio.addressbook.AddressBookHierarchyProxy.superclass.constructor.call(this, config);
	},
	...
	{
		return new Grommunio.addressbook.AddressBookResponseHandler({
			proxy: this,
			action: action,
			reader: reader,
			options: args,
