...
/**
 * @class Grommunio.addressbook.dialogs.ABMultiUserSelectionContentPanel
 * @extends Grommunio.core.ui.ContentPanel
 * @xtype grommunio.abmultiuserselectioncontentpanel
 */
Grommunio.addressbook.dialogs.ABMultiUserSelectionContentPanel = Ext.extend(Grommunio.core.ui.ContentPanel, {
	/**
	...
	constructor: function(config)
	{
		...
		config = Ext.applyIf(config, {
			...
			stateful: Grommunio.core.BrowserWindowMgr.isMainWindowActive(),
			items: [{
		...
		Grommunio.addressbook.dialogs.ABMultiUserSelectionContentPanel.superclass.constructor.call(this, config);
	}
});


Ext.reg('grommunio.abmultiuserselectioncontentpanel', Grommunio.addressbook.dialogs.ABMultiUserSelectionContentPanel);
