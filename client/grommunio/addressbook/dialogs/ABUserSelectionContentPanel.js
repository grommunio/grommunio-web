...
/**
 * @class Grommunio.addressbook.dialogs.ABUserSelectionContentPanel
 * @extends Grommunio.core.ui.RecordContentPanel
 * @xtype grommunio.abuserselectioncontentpanel
 */
Grommunio.addressbook.dialogs.ABUserSelectionContentPanel = Ext.extend(Grommunio.core.ui.RecordContentPanel, {
	/**
	...
	constructor: function(config)
	{
		...
		Grommunio.addressbook.dialogs.ABUserSelectionContentPanel.superclass.constructor.call(this, config);
	}
});

Ext.reg('grommunio.abuserselectioncontentpanel', Grommunio.addressbook.dialogs.ABUserSelectionContentPanel);
