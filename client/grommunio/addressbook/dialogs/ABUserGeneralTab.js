...
/**
 * @class Grommunio.addressbook.dialogs.ABUserGeneralTab
 * @extends Ext.form.FormPanel
 * @xtype grommunio.abusergeneraltab
 *
 * This class is used to create layout of general tab in tab panel.
 */
Grommunio.addressbook.dialogs.ABUserGeneralTab = Ext.extend(Ext.form.FormPanel, {
	...
	constructor: function(config)
	{
		...
		Grommunio.addressbook.dialogs.ABUserGeneralTab.superclass.constructor.call(this, config);
	},
...
Ext.reg('grommunio.abusergeneraltab', Grommunio.addressbook.dialogs.ABUserGeneralTab);
