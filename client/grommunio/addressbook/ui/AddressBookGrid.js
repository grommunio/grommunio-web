...
/**
 * @class Grommunio.addressbook.ui.AddressBookGrid
 ...
 */
Grommunio.addressbook.ui.AddressBookGrid = Ext.extend(Grommunio.common.ui.grid.GridPanel, {
	/**
	...
	constructor: function(config)
	{
		...
		Ext.applyIf(config, {
			...
			cm: new Grommunio.addressbook.ui.GABColumnModel(),
			view: new Ext.ux.grid.BufferView(viewConfig)
		});

		Grommunio.addressbook.ui.AddressBookGrid.superclass.constructor.call(this, config);
		...
		this.mon(this, 'beforerender', function(){
			...
			Grommunio.core.PresenceManager.registerStore(this.getStore());
		}, this);
		this.mon(this, 'beforedestroy', function(){
			Grommunio.core.PresenceManager.unregisterStore(this.getStore());
		}, this);
	},
	...
	onRender: function()
	{
		Grommunio.addressbook.ui.AddressBookGrid.superclass.onRender.apply(this, arguments);
	 ...
	 * check what kind of folder has been loaded, and either loads the {@link Grommunio.addressbook.ui.GABColumnModel}
	 * or {@link Grommunio.addressbook.ui.GABPersonalColumnModel} column model.
	...
	{
		var columnModel = new Grommunio.addressbook.ui.GABColumnModel();
	 ...
	 * @return {Grommunio.common.ui.grid.RowSelectionModel} selection model object
	 * @private
	 */
	createSelectionModel: function(config)
	{
		return new Grommunio.common.ui.grid.RowSelectionModel({
	...
	getState: function()
	{
		var state = Grommunio.addressbook.ui.AddressBookGrid.superclass.getState.call(this);
	...
	applyState: function(state)
	{
		if (state) {
			...
			Grommunio.addressbook.ui.AddressBookGrid.superclass.applyState.call(this, wrap);
		}
	}
});

Ext.reg('grommunio.addressbookgrid', Grommunio.addressbook.ui.AddressBookGrid);
