...
/**
 * @class Grommunio.addressbook.ui.ABMultiUserSelectionPanel
 * @extends Ext.Panel
 * @xtype grommunio.abmultiuserselectionpanel
 */
Grommunio.addressbook.ui.ABMultiUserSelectionPanel = Ext.extend(Ext.Panel, {
	/**
	 ...
	 * {@link Grommunio.addressbook.AddressBookRecord user} to the correct type
	...
	/**
	 * @cfg {Array} selectionCfg Array of {@link Grommunio.common.ui.BoxField} configuration
	...
	constructor: function(config)
	{
		...
		Ext.each(config.selectionCfg, function(cfg) {
			...
			items.push({
				...
				cls: 'grommunio-addressbook-dialog-compositefield',
				hideLabel: true,
				anchor: '100%',
				autoHeight: false,
				items: [ btn, cfg ]
		...
		Grommunio.addressbook.ui.ABMultiUserSelectionPanel.superclass.constructor.call(this, config);
	},
	...
	initEvents: function()
	{
		Grommunio.addressbook.ui.ABMultiUserSelectionPanel.superclass.initEvents.apply(this, arguments);
	...
	/**
	 * Closes {@link Grommunio.core.ui.CreateFolderDialog CreateFolder} dialog
	 * @private
	 */
	onCancel: function()
	{
...
Ext.reg('grommunio.abmultiuserselectionpanel', Grommunio.addressbook.ui.ABMultiUserSelectionPanel);
