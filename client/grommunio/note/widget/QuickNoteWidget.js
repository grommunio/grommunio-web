Ext.namespace('Grommunio.note.widgets');

/**
 * @class Grommunio.note.widgets.QuickNoteWidget
 * @extends Grommunio.core.ui.widget.AbstractQuickItemWidget
 *
 * Widget for creating a Sticky note quickly with a minimum set of
 * input fields
 */
Grommunio.note.widgets.QuickNoteWidget = Ext.extend(Grommunio.core.ui.widget.AbstractQuickItemWidget, {
	...
	constructor: function(config)
	{
		...
		Grommunio.note.widgets.QuickNoteWidget.superclass.constructor.call(this, config);
	},
...
Grommunio.onReady(function() {
	container.registerWidget(new Grommunio.core.ui.widget.WidgetMetaData({
		name: 'quicknote',
		iconCls: 'icon_widget_new_note',
		displayName: _('Quick Note'),
		widgetConstructor: Grommunio.note.widgets.QuickNoteWidget
	}));
});
