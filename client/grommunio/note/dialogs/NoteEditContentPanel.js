...
/**
 * @class Grommunio.note.dialogs.NoteEditContentPanel
 * @extends Grommunio.core.ui.RecordContentPanel
 * @xtype grommunio.noteeditcontentpanel
 *
 * this class is used to create/view note edit content panel
 */
Grommunio.note.dialogs.NoteEditContentPanel = Ext.extend(Grommunio.core.ui.RecordContentPanel, {
	/**
	 * @constructor
	...
	constructor: function(config)
	{
		...
		Grommunio.note.dialogs.NoteEditContentPanel.superclass.constructor.call(this,config);
	},

	/**
	 * Add the main Window Panel to the content panel. This will contain
	 * a {@link Grommunio.core.ui.ContentPanelToolbar ContentPanelToolbar} and a {@link Grommunio.note.dialogs.NoteEditPanel NoteEditPanel}.
...
Ext.reg('grommunio.noteeditcontentpanel', Grommunio.note.dialogs.NoteEditContentPanel);
