...
/**
 * @class Grommunio.note.dialogs.NoteEditToolbar
 * @extends Grommunio.core.ui.ContentPanelToolbar
 * @xtype grommunio.noteedittoolbar
 *
 * this class is used to create/view note edit panel
 */
Grommunio.note.dialogs.NoteEditToolbar = Ext.extend(Grommunio.core.ui.ContentPanelToolbar, {
	 ...
	 * @param {Grommunio.note.dialogs.NoteEditToolbar} toolbar This toolbar
	 */
	/**
	...
	constructor: function(config)
	{
		...
		Grommunio.note.dialogs.NoteEditToolbar.superclass.constructor.call(this, config);
	},
	...
	onComboSelect: function(form, record, selectedIndex)
	{
		...
		var colorIndex = Grommunio.core.mapi.NoteColor.getColorValue(record.get('icon_index'));
	 ...
	 * This will call {@link Grommunio.common.Actions#openPrintDialog}.
	 * @private
	 */
...
Ext.reg('grommunio.noteedittoolbar', Grommunio.note.dialogs.NoteEditToolbar);
