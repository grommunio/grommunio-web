...
/**
 * @class Grommunio.note.KeyMapping
 * @extends Object
 *
 * The map of keys used in the Note Context.
 * @singleton
 */
Grommunio.note.KeyMapping = Ext.extend(Object, {
	/**
	 * @constructor
	 */
	...
	{
		Grommunio.note.Actions.openCreateNoteContent(container.getContextByName('note').getModel());
	}

});

Grommunio.note.KeyMapping = new Grommunio.note.KeyMapping();
