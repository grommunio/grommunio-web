...
/**
 * @class Grommunio.contact.dialogs.DistlistExternalMemberContentPanel
 ...
 *
 * @xtype grommunio.distlistexternalmembercontentpanel
 */
Grommunio.contact.dialogs.DistlistExternalMemberContentPanel = Ext.extend(Grommunio.core.ui.ContentPanel, {
	/**
	 * @cfg {Grommunio.core.data.IPMRecord} record The distlist record which
	 * contains memberStore for distribution list members
	 */
	parentRecord: undefined,

	/**
	 * @cfg {Grommunio.contact.DistlistMemberRecord} memberRecord The distlist member record
	...
	constructor: function(config)
	{
		...
		if (Ext.isDefined(container.getSettingsModel().get("grommunio/v1/state/dialogs/distlistexternalmembercontentpanel"))) {
			container.getSettingsModel().remove("grommunio/v1/state/dialogs/distlistexternalmembercontentpanel");
		}
		...
		Grommunio.contact.dialogs.DistlistExternalMemberContentPanel.superclass.constructor.call(this, config);
	...
	onOk: function()
	{
		...
		if(this.record) {
			...
			var newRecord = Grommunio.core.data.RecordFactory.createRecordObjectByCustomType(Grommunio.core.data.RecordCustomObjectType.GROMMUNIO_DISTLIST_MEMBER);
...
// register panel
Ext.reg('grommunio.distlistexternalmembercontentpanel', Grommunio.contact.dialogs.DistlistExternalMemberContentPanel);
