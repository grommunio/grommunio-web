...
/**
 * @class Grommunio.contact.dialogs.ContactDetailTab
 * @extends Ext.form.FormPanel
 * @xtype grommunio.contactdetailtab
 *
 * This class is used to create layout of details tab panel.
 */
Grommunio.contact.dialogs.ContactDetailTab = Ext.extend(Ext.form.FormPanel, {
	/**
	 * @constructor
	...
	constructor: function(config)
	{
		...
		Ext.applyIf(config, {
			xtype: 'grommunio.contactdetailtab',
			cls: 'grommunio-contactdetailtab',
			title: _('Details'),
			autoScroll: true,
			labelWidth: 120,
			labelAlign: 'left',
		...
		Grommunio.contact.dialogs.ContactDetailTab.superclass.constructor.call(this, config);
	},
	...
	/**
	 * Function will return {@link Grommunio.contact.data.ContactDetailsParser ContactDetailsParser} that is a parser object to parse contact details
...
Ext.reg('grommunio.contactdetailtab', Grommunio.contact.dialogs.ContactDetailTab);
