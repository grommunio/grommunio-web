...
/**
 * @class Grommunio.contact.dialogs.ContactToolbar
 * @extends Grommunio.core.ui.ContentPanelToolbar
 * @xtype grommunio.contacttoolbar
 */
Grommunio.contact.dialogs.ContactToolbar = Ext.extend(Grommunio.core.ui.ContentPanelToolbar, {
	 ...
	 * @param {Grommunio.contact.dialogs.ContactToolbar} toolbar This toolbar
	 */
	/**
	...
	constructor: function(config)
	{
		...
		Grommunio.contact.dialogs.ContactToolbar.superclass.constructor.call(this, config);
	},
	...
	onAttachmentButtonAdded: function(item)
	{
		if ( item.isXType('menuitem') ){
			...
			item.update = Grommunio.common.attachment.ui.AttachmentButton.prototype.update.createDelegate(this.addAttachment);
		}
	},
	 ...
	 * This will save the {@link Grommunio.core.data.IPMRecord IPMRecord}.
	 * @private
	 */
	onSave: function()
	{
	 ...
	 * This will delete the {@link Grommunio.core.data.IPMRecord IPMRecord}.
	 * @private
	 */
	onDelete: function()
	{
	 ...
	 * This will print the {@link Grommunio.core.data.IPMRecord IPMRecord}.
	 * @private
	 */
	onPrint: function()
	{
...
Ext.reg('grommunio.contacttoolbar', Grommunio.contact.dialogs.ContactToolbar);
