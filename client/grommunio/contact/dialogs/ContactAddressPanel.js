...
/**
 * @class Grommunio.contact.dialogs.ContactAddressPanel
 * @extends Ext.form.FormPanel
 * @xtype grommunio.contactaddresspanel
 */
Grommunio.contact.dialogs.ContactAddressPanel = Ext.extend(Ext.form.FormPanel, {
	/**
	...
	constructor: function(config)
	{
		...
		Grommunio.contact.dialogs.ContactAddressPanel.superclass.constructor.call(this, config);
	},
	...
	createFormItems: function(propertyPrefix)
	{
		return [{
			...
			hideLabel: true,
			checked: container.getSettingsModel().get('grommunio/v1/contexts/contact/show_address_dialog')
		}];
	},
	...
	updateRecord: function(record)
	{
		...
		if (this.settingCheckField.isDirty()) {
			container.getSettingsModel().set('grommunio/v1/contexts/contact/show_address_dialog', this.settingCheckField.getValue());
		}
...
Ext.reg('grommunio.contactaddresspanel', Grommunio.contact.dialogs.ContactAddressPanel);
