/*
 * #dependsFile client/grommunio/contact/dialogs/DistlistMemberGridColumnModel.js
 */
Ext.namespace('Grommunio.contact.dialogs');

/**
 * @class Grommunio.contact.dialogs.DistlistMembersTab
 * @extends Ext.form.FormPanel
 * @xtype grommunio.distlistmemberstab
 *
 * This class is used to create layout of members tab panel.
 */
Grommunio.contact.dialogs.DistlistMembersTab = Ext.extend(Ext.form.FormPanel, {
	/**
	 * @constructor
	...
	constructor: function(config)
	{
		...
		Ext.applyIf(config, {
			xtype: 'grommunio.distlistmemberstab',
			cls: 'grommunio-distlist-createpanel-memberstab',
			title: _('Members'),
			layout: 'vbox',
			layoutConfig: {
				align: 'stretch',
		...
		Grommunio.contact.dialogs.DistlistMembersTab.superclass.constructor.call(this, config);
	},
	...
	getMembersTabItems: function()
	{
		return [{
					...
					colModel: new Grommunio.contact.dialogs.DistlistMemberGridColumnModel()
				}];
	},
	...
	/**
	 * Function Opens a {@link Grommunio.addressbook.dialogs.ABMultiUserSelectionContentPanel ABMultiUserSelectionContentPanel}
	 * to select members from addressbook.
	 */
	showAddressBookContent: function()
	{
		Grommunio.contact.Actions.openMembersSelectionContent(this.record);
	},

	/**
	 * Function will open {@link Grommunio.contact.dialogs.ABMultiUserSelectionContentPanel ABMultiUserSelectionContentPanel}
	 * for adding external member.
	 */
	addExternalMember: function()
	{
		Grommunio.contact.Actions.openDistlistExternalMemberContent(undefined, { parentRecord: this.record });
	},
	...
	onRowDblClick: function(grid, rowIndex, event)
	{
		...
		Grommunio.contact.Actions.openDistlistMember(record, this.record);
	}
});

Ext.reg('grommunio.distlistmemberstab', Grommunio.contact.dialogs.DistlistMembersTab);
