...
/**
 * @class Grommunio.contact.dialogs.ContactPhonePanel
 * @extends Ext.form.FormPanel
 * @xtype grommunio.contactphonepanel
 */
Grommunio.contact.dialogs.ContactPhonePanel = Ext.extend(Ext.form.FormPanel, {
	/**
	...
	constructor: function(config)
	{
		...
		Grommunio.contact.dialogs.ContactPhonePanel.superclass.constructor.call(this, config);
	},
...
Ext.reg('grommunio.contactphonepanel', Grommunio.contact.dialogs.ContactPhonePanel);
