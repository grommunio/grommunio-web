/*
 * #dependsFile client/grommunio/contact/data/ContactDetailsParser.js
 */
Ext.namespace('Grommunio.contact.dialogs');

/**
 * @class Grommunio.contact.dialogs.ContactPanel
 * @extends Ext.Panel
 ...
 */
Grommunio.contact.dialogs.ContactPanel = Ext.extend(Ext.Panel, {
	 ...
	 * @param {Grommunio.contact.dialogs.ContactPanel} panel This contactpanel
	 */
	...
	constructor: function(config)
	{
		...
		Ext.applyIf(config, {
			xtype: 'grommunio.contactpanel',
			cls: 'grommunio-contactcreatepanel',
			border: false,
			layout: 'fit',
			items: this.createTabPanel()
		});

		Grommunio.contact.dialogs.ContactPanel.superclass.constructor.call(this, config);
	},
...
Ext.reg('grommunio.contactpanel', Grommunio.contact.dialogs.ContactPanel);
