...
/**
 * @class Grommunio.contact.ui.ContactCardView
 ...
 */
Grommunio.contact.ui.ContactCardView = Ext.extend(Grommunio.common.ui.DraggableDataView, {
	/**
	 * @cfg {Grommunio.contact.ContactContext} context The context to which this view belongs
	 */
	context: undefined,
	...
	constructor: function(config)
	{
		...
		Ext.apply(this, config, {
			 ...
			 */
			itemSelector: 'div.grommunio-contact-cardview-card',
			multiSelect: true,
			selectedClass: 'grommunio-contact-cardview-card-selected',
			enableDrag: true,
			ddGroup: 'dd.mapiitem'
		});

		Grommunio.contact.ui.ContactCardView.superclass.constructor.call(this, config);
	 ...
	 * @param {Grommunio.contact.ContactCardView} dataView data view object
	...
	{
		Grommunio.contact.Actions.openDialog(dataView.getSelectedRecords());
	},

	/**
	 * Event handler which is triggered when the {@link Grommunio.contact.ui.ContactCardView ContactCardView}
	 ...
	 *
	 * @param {Grommunio.contact.ui.ContactCardView} dataView The view object.
	 ...
	 *
	 * @param {Grommunio.contact.ContactStore} store The {@link Grommunio.contact.ContactStore} which contains all contacts.
	...
	{
		var templateStrArr = [
			'<div class="grommunio-contact-cardview">',
				'<tpl for=".">',
					'<div class="grommunio-contact-cardview-card">',
						'<div class="x-panel">',
							...
							'<div class="x-panel-bwrap">',
								'<div class="x-panel-body grommunio-card-body">',
									// content
									'<p class="grommunio-contact-cardview-card-title">{display_name:htmlEncode}</p>',
		...
		return new Ext.XTemplate(templateStrArr.join(''), {
			...
			getCategories: function(values)
			{
				...
				return Grommunio.common.categories.Util.getCategoriesHtml(categories);
			}
		});
	}
});

Ext.reg('grommunio.contactcardview', Grommunio.contact.ui.ContactCardView);
