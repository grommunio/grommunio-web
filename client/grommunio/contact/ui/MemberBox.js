...
/**
 * @class Grommunio.contact.ui.MemberBox
 * @extends Grommunio.common.recipientfield.ui.RecipientBox
 * @xtype grommunio.memberbox
 *
 * Special {@link Grommunio.common.ui.Box box} which is used
 * for displaying Distlist Member records in the {@link Grommunio.contact.ui.MemberBoxField}.
 ...
 */
Grommunio.contact.ui.MemberBox = Ext.extend(Grommunio.common.recipientfield.ui.RecipientBox, {
	/**
	...
	isValidRecord: function(record)
	{
		...
		if(Ext.isDefined(Grommunio.core.mapi.DistlistType.getName(distlistType))) {
			return true;
		}
	...
	{
		var prepared = Grommunio.contact.ui.MemberBox.superclass.prepareData.apply(this, arguments);
...
Ext.reg('grommunio.memberbox', Grommunio.contact.ui.MemberBox);
