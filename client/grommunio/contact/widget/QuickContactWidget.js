...
Ext.namespace('Grommunio.contact.widget');

/**
 * @class Grommunio.contact.widget.QuickContactWidget
 * @extends Grommunio.core.ui.widget.AbstractQuickItemWidget
 *
 * Widget for creating a contact quickly with a minimum set of
 * input fields
 */
Grommunio.contact.widget.QuickContactWidget = Ext.extend(Grommunio.core.ui.widget.AbstractQuickItemWidget, {
	...
	constructor: function(config)
	{
		...
		Grommunio.contact.widget.QuickContactWidget.superclass.constructor.call(this, config);
	},
	 ...
	 * and it will call function that will open the {@link Grommunio.contact.dialogs.ContactPhoneContentPanel ContactPhoneContentPanel}.
	...
	{
		Grommunio.contact.Actions.openDetailedNameContent(this.wrap.record, { parser: this.contactParser, parsedData: parsedData });
	},
	...
	{
		Grommunio.contact.Actions.openDetailedPhoneContent(this.wrap.record, { parser: this.contactParser, property: property });
	},
...
Grommunio.onReady(function() {
	container.registerWidget(new Grommunio.core.ui.widget.WidgetMetaData({
		...
		widgetConstructor: Grommunio.contact.widget.QuickContactWidget
	}));
});
