...
/**
 * @class Grommunio.contact.attachitem.AttachContactColumnModel
 * @extends Grommunio.common.ui.grid.ColumnModel
 *
 * The {@link Grommunio.contact.attachitem.AttachContactColumnModel AttachContactColumnModel} is the column model containing
 ...
 */
Grommunio.contact.attachitem.AttachContactColumnModel = Ext.extend(Grommunio.common.ui.grid.ColumnModel, {
	/**
	 * @constructor
	...
	constructor: function(config)
	{
		...
		Grommunio.contact.attachitem.AttachContactColumnModel.superclass.constructor.call(this, config);
	},

	/**
	 * Create an array of {@link Ext.grid.Column columns} which will be visible when loading data from
	 * contact folder into {@link Grommunio.common.attachment.dialog.AttachItemGrid AttachItemGrid}.
	 *
