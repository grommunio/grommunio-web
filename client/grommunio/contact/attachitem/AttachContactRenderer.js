...
/**
 * @class Grommunio.contact.attachitem.AttachContactRenderer
 ...
 */
Grommunio.contact.attachitem.AttachContactRenderer = Ext.extend(Grommunio.common.attachment.dialogs.AttachItemBaseRenderer, {
	/**
	...
	{
		Grommunio.contact.attachitem.AttachContactRenderer.superclass.constructor.call(this, config);
