...
Ext.namespace('Grommunio.contact.printer');

/**
 * @class Grommunio.contact.printer.DistlistRenderer
 ...
 */
Grommunio.contact.printer.DistlistRenderer = Ext.extend(Grommunio.common.printer.renderers.RecordRenderer, {

	/**
	 * Generate the XTemplate HTML text for printing a single contact or distlist.
	 * @param {Grommunio.core.data.MAPIRecord} record The task item to print
	...
	prepareData: function(record) {
		var data = Grommunio.contact.printer.DistlistRenderer.superclass.prepareData.apply(this, arguments);
