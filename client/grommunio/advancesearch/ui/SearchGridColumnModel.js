...
/**
 * @class Grommunio.advancesearch.ui.SearchGridColumnModel
 * @extends Grommunio.common.ui.grid.ColumnModel
 *
 */
Grommunio.advancesearch.ui.SearchGridColumnModel = Ext.extend(Grommunio.common.ui.grid.ColumnModel, {
	...
	constructor: function(config)
	{
		...
		Grommunio.advancesearch.ui.SearchGridColumnModel.superclass.constructor.call(this, config);
	},
	...
	createDefaultColumns: function (config)
	{
		...
		return [{
			...
			width: 125,
			fixed: true,
			renderer: Grommunio.advancesearch.ui.SearchGridRenderers.nameColumn
		}, {
			id: grid.getId() + '-col0',
			sortable: false,
			hideable: false,
			renderer: Grommunio.advancesearch.ui.SearchGridRenderers.subjectWithBodyColumn
		}, {
			dataIndex: 'hasattach',
			width: 24,
			...
			hideable: false,
			renderer: Grommunio.advancesearch.ui.SearchGridRenderers.dateColumn,
	...
	/**
	 * This will switch the {@link Grommunio.advancesearch.ui.SearchGridColumnModel columnmodel}
