...
/**
 * @class Grommunio.task.attachitem.AttachTaskRenderer
 * @extends Grommunio.common.attachment.dialogs.AttachItemBaseRenderer
 *
 * Renderer that can be used to get text data from {@link Grommunio.task.TaskRecord TaskRecord}.
 */
Grommunio.task.attachitem.AttachTaskRenderer = Ext.extend(Grommunio.common.attachment.dialogs.AttachItemBaseRenderer, {
	/**
	...
	{
		Grommunio.task.attachitem.AttachTaskRenderer.superclass.constructor.call(this, config);
	...
	{
		var data = Grommunio.task.attachitem.AttachTaskRenderer.superclass.prepareData.apply(this, arguments);

		// remove default values
		if (data['status'] === Grommunio.core.mapi.TaskStatus.NOT_STARTED) {
			delete data['status'];
		}
