...
/**
 * @class Grommunio.settings.ui.SettingsQuotaInfoWidget
 ...
 */
Grommunio.settings.ui.SettingsQuotaInfoWidget = Ext.extend(Grommunio.settings.ui.SettingsWidget, {
	/**
	 * @constructor
	...
	constructor: function(config)
	{
		...
		Grommunio.settings.ui.SettingsQuotaInfoWidget.superclass.constructor.call(this, config);
	...
	updateQuotaInfo: function()
	{
		...
		var quotaInfoHTML = '<span class="grommunio-quota-string">' + quotaInfo + '</span>';
...
Ext.reg('grommunio.settingsquotainfowidget', Grommunio.settings.ui.SettingsQuotaInfoWidget);
