...
/**
 * @class Grommunio.settings.ui.SettingsSearchField
 ...
 */
Grommunio.settings.ui.SettingsSearchField = Ext.extend(Ext.form.TriggerField, {
	/**
	...
	constructor: function(config)
	{
		...
		Grommunio.settings.ui.SettingsSearchField.superclass.constructor.call(this, config);
	...
	onRender: function()
	{
		Grommunio.settings.ui.SettingsSearchField.superclass.onRender.apply(this, arguments);
	...
	{
		Grommunio.settings.ui.SettingsSearchField.superclass.onResize.call(this, w, h);
	 ...
	 * @return {Grommunio.settings.ui.SettingsCategoryPanel} The tab panel
	 * @private
	 */
	getTabPanel: function()
	{
		return this.findParentByType('grommunio.settingsmainpanel').findByType('grommunio.settingscategorypanel')[0];
	},

	/**
	 * Returns the panel holding the categories.
	 * @return {Grommunio.settings.ui.SettingsCategoryWidgetPanel} The widget panel
	 * @private
	 */
	getWidgetPanel: function()
	{
		return this.findParentByType('grommunio.settingsmainpanel').findByType('grommunio.settingscategorywidgetpanel')[0];
	},
	...
	{
		this.searchTask.cancel();
		Grommunio.settings.ui.SettingsSearchField.superclass.onDestroy.apply(this, arguments);
	}
});

Ext.reg('grommunio.settingssearchfield', Grommunio.settings.ui.SettingsSearchField);
