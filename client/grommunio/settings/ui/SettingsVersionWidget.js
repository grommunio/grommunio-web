...
/**
 * @class Grommunio.settings.ui.SettingsVersionWidget
 ...
 */
Grommunio.settings.ui.SettingsVersionWidget = Ext.extend(Grommunio.settings.ui.SettingsWidget, {
	...
	constructor: function(config)
	{
		...
		Grommunio.settings.ui.SettingsVersionWidget.superclass.constructor.call(this, config);
	},
	...
	{
		Grommunio.common.categories.CategoryListManager.onListResponse(response);
	 ...
	 * @param {Grommunio.settings.SettingsModel} model
...
Ext.reg('grommunio.settingsversionwidget', Grommunio.settings.ui.SettingsVersionWidget);
