...
/**
 * @class Grommunio.settings.ui.SettingsAdvancedCategory
 ...
 * load the {@link Grommunio.settings.ui.SettingsTreePanel Settings Tree}
 * to display all available settings which are available for the user.
 */
Grommunio.settings.ui.SettingsAdvancedCategory = Ext.extend(Grommunio.settings.ui.SettingsCategory, {
	...
	constructor: function(config)
	{
		...
		Ext.applyIf(config, {
			title: _('Advanced'),
			categoryIndex: 9999,
			iconCls: 'grommunio-settings-category-advanced',
			...
			items: [{
				...
				items: [{
					...
					items:[{
						xtype: 'checkbox',
						name: 'grommunio/v1/main/kdeveloper_tool/kdeveloper',
						...
						xtype: 'checkbox',
						name: 'grommunio/v1/main/kdeveloper_tool/itemdata',
		...
		Grommunio.settings.ui.SettingsAdvancedCategory.superclass.constructor.call(this, config);
	},
	...
	update: function(settingsModel)
	{
		...
		Grommunio.settings.ui.SettingsAdvancedCategory.superclass.update.apply(this, arguments);
	...
	{
		Grommunio.settings.ui.SettingsAdvancedCategory.superclass.updateSettings.apply(this, arguments);
...
Ext.reg('grommunio.settingsadvancedcategory', Grommunio.settings.ui.SettingsAdvancedCategory);
