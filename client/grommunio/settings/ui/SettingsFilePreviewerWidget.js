...
/**
 * @class Grommunio.settings.ui.SettingsFilePreviewerWidget
 ...
 */
Grommunio.settings.ui.SettingsFilePreviewerWidget = Ext.extend(Grommunio.settings.ui.SettingsWidget, {
	/**
	...
	constructor: function (config)
	{
	    ...
	    var items = [{
	        xtype: 'checkbox',
	        name: 'grommunio/v1/main/file_previewer/enable',
	        pluginSettingPath: 'grommunio/v1/plugins/filepreviewer/enable',
	    ...
	    items = items.concat(this.createZoomDropdownBox([{
	            name:'grommunio/v1/main/file_previewer/odf_zoom',
	            ref: 'odfZoom',
	            store: zoomStore,
	            fieldLabel: _('Document default zoom')
	        },{
	            name:'grommunio/v1/main/file_previewer/pdf_zoom',
	            ref: 'pdfZoom',
	            store: zoomStore,
	    ...
	    var targets = Grommunio.common.Actions.getFilePreviewerTargets().map(function(target) {
	        return {
	            xtype: 'radio',
	            name: 'previewTarget',
	            inputValue: target,
	    ...
	    Grommunio.settings.ui.SettingsFilePreviewerWidget.superclass.constructor.call(this, config);
	},
	...
	update: function (settingsModel)
	{
		...
		var pluginSetting = settingsModel.get('grommunio/v1/plugins/filepreviewer/enable');
	...
	updateSettings: function (settingsModel)
	{
		...
		if (this.pluginSettingsApplied) {
			settingsModel.remove('grommunio/v1/plugins/filepreviewer', {type: 'deprecated'});
		}
...
Ext.reg('grommunio.settingsfilepreviewerwidget', Grommunio.settings.ui.SettingsFilePreviewerWidget);
