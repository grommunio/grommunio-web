...
/**
 * @class Grommunio.settings.ui.SettingsInboxNavigationWidget
 ...
 */
Grommunio.settings.ui.SettingsInboxNavigationWidget = Ext.extend(Grommunio.settings.ui.SettingsWidget, {
	...
	constructor: function (config)
	{
		...
		Ext.applyIf(config, {
			...
			items: [{
				...
				xtype: 'radiogroup',
				name: 'grommunio/v1/contexts/mail/enable_live_scroll',
				ref: 'liveScroll',
		...
		Grommunio.settings.ui.SettingsInboxNavigationWidget.superclass.constructor.call(this, config);
	},
	 ...
	 * @return {Grommunio.common.ui.CompositeField}
	 */
	createPageSizeField: function()
	{
		...
		return new Grommunio.common.ui.CompositeField({
				...
				items: [{
					labelSplitter: '{A}',
					xtype: 'combo',
					name: 'grommunio/v1/main/page_size',
					ref: 'pageSize',
					width: 70,
					hideLabel: true,
					store: pageSizeStore,
...
Ext.reg('grommunio.settingsinboxnavigationwidget', Grommunio.settings.ui.SettingsInboxNavigationWidget);
