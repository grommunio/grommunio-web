...
/**
 * @class Grommunio.settings.ui.SettingsCategory
 * @extends Ext.Container
 * @xtype grommunio.settingscategory
 *
 * The main category object which defines the {@link #title name} of the category
 * and all the {@link Grommunio.settings.ui.SettingsWidget widgets} ({@link #items})
 * which should be displayed in the {@link Grommunio.settings.ui.SettingsCategoryWidgetPanel widget panel}.
 *
 * This object should be used for registering new categories through the
 * {@link Grommunio.settings.ui.SettingsMainPanel#context.settings.categories insertion point}.
 */
Grommunio.settings.ui.SettingsCategory = Ext.extend(Ext.Container, {
	/**
	 * @cfg {Array} items The array of configuration
	 * objects for the {@link Grommunio.settings.ui.SettingsWidget Settings Widgets}
	...
	/**
	 * Each widget can have different saving methods (saving settings through the {@link Grommunio.settings.SettingsModel settings}
	...
	constructor: function(config)
	{
		...
		Grommunio.settings.ui.SettingsCategory.superclass.constructor.call(this, config);
	},
	...
	onShow: function()
	{
		Grommunio.settings.ui.SettingsCategory.superclass.onShow.apply(this, arguments);
	...
	onHide: function()
	{
		Grommunio.settings.ui.SettingsCategory.superclass.onHide.apply(this, arguments);
	...
	/**
	 * Event handler which is fired when the {@link Grommunio.settings.SettingsModel SettingsModel} fires
	 * the {@link Grommunio.settings.SettingsModel#beforesave beforesave} event.
	...
	/**
	 * Event handler which is fired when the {@link Grommunio.settings.SettingsModel SettingsModel}
	 * fires the {@link Grommunio.settings.SettingsModel#save save} event. This will update the
	...
	/**
	 * Show a {@link Grommunio.core.ui.notifier.Notifier Notification} to the user indicating that the
	...
	/**
	 * Hide the {@link Grommunio.core.ui.notifier.Notifier Notification} from {@link #displaySavingMask}
	 ...
	 *
	 * By default this will call {@link Grommunio.settings.ui.SettingsWidget#update} on all
	 * {@link #items}
	 *
	...
	{
		var widgets = this.findByType('grommunio.settingswidget');
	 ...
	 *
	 * By default this will call {@link Grommunio.settings.ui.SettingsWidget#updateSettings} on all
	 * {@link #items}
	 *
...
Ext.reg('grommunio.settingscategory', Grommunio.settings.ui.SettingsCategory);
