...
/**
 * @class Grommunio.settings.SettingsContextModel
 * @extends Grommunio.core.ContextModel
 */
Grommunio.settings.SettingsContextModel = Ext.extend(Grommunio.core.ContextModel, {

	/**
	 * The settings model of the active settings, this is a reference
	 * to {@link Grommunio.core.Container#getSettingsModel}. This model is
	 * used to save the changes to the server. However
	 * {@link Grommunio.settings.ui.SettingsCategory categories} should not
	 ...
	 * {@link Grommunio.settings.ui.SettingsCategory categories} using
	...
	constructor: function(config)
	{
		...
		this.editModel = new Grommunio.settings.SettingsModel({
			autoSave: false
		});
		...
		this.addEvents(
			 ...
			 * {@link Grommunio.settings.ContextModel#save saved}. At this
			 * time the settings might still be changed.
			 * @param {Grommunio.settings.SettingsContextModel} model This model
			 * @param {Grommunio.settings.SettingsModel} settingsModel The
			 ...
			 * {@link Grommunio.settings.ContextModel#save saved}.
			 * @param {Grommunio.settings.SettingsContextModel} model This model
			 * @param {Grommunio.settings.SettingsModel} settingsModel The
		...
		Grommunio.settings.SettingsContextModel.superclass.constructor.call(this, config);
	...
	{
		Grommunio.settings.SettingsContextModel.superclass.enable.apply(this, arguments);
	 ...
	 * {@link Grommunio.settings.ui.SettingsCategory categories} for loading
	 * and editing settings.
	 * @return {Grommunio.settings.SettingsModel} The settings model to be
	 * used for editing.
	 */
	 ...
	 * the {@link Grommunio.settings.SettingsModel#setsetting} event.
	...
	/**
	 * Event handler which is fired when the {@link #editModel} fires
	 * the {@link Grommunio.settings.SettingsModel#removesetting} event.
