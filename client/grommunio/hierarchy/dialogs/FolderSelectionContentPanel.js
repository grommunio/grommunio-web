...
/**
 * @class Grommunio.hierarchy.dialogs.FolderSelectionContentPanel
 * @extends Grommunio.core.ui.ContentPanel
 * @xtype grommunio.folderselectioncontentpanel
 *
 * Content Panel to allow the user to select a folder
 */
Grommunio.hierarchy.dialogs.FolderSelectionContentPanel = Ext.extend(Grommunio.core.ui.ContentPanel, {
	/**
	...
	/**
	 * @cfg {Grommunio.hierarchy.data.MAPIFolderRecord} folder The folder which is selected by
	 ...
	 * {@link Grommunio.hierarchy.data.MAPIFolderRecord #folder} as first argument.
	 */
	...
	constructor: function(config)
	{
		...
		Grommunio.hierarchy.dialogs.FolderSelectionContentPanel.superclass.constructor.call(this, config);
	},
	...
	onNewFolder: function() {
		...
		Grommunio.hierarchy.Actions.openCreateFolderContent(parentFolder);
...
Ext.reg('grommunio.folderselectioncontentpanel', Grommunio.hierarchy.dialogs.FolderSelectionContentPanel);
