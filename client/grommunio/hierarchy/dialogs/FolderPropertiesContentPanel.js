...
/**
 * @class Grommunio.hierarchy.dialogs.FolderPropertiesContentPanel
 * @extends Grommunio.core.ui.RecordContentPanel
 * @xtype foldergrommunio.propertiescontentpanel
 *
 * This will display a {@link Grommunio.core.ui.ContentPanel contentpanel}
 * for general properties of {@link Grommunio.hierarchy.data.MAPIFolderRecord folder} and set permissions on same.
 */
Grommunio.hierarchy.dialogs.FolderPropertiesContentPanel = Ext.extend(Grommunio.core.ui.RecordContentPanel, {
	/**
	 * @constructor
	...
	constructor: function(config)
	{
		...
		Ext.applyIf(config, {
			...
			xtype: 'grommunio.folderpropertiescontentpanel',
			layout: 'fit',
		...
		Grommunio.hierarchy.dialogs.FolderPropertiesContentPanel.superclass.constructor.call(this, config);
	},
...
Ext.reg('grommunio.folderpropertiescontentpanel', Grommunio.hierarchy.dialogs.FolderPropertiesContentPanel);
