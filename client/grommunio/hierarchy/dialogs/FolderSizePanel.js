...
/**
 * @class Grommunio.hierarchy.dialogs.FolderSizePanel
 * @extends Ext.Panel
 ...
 */
Grommunio.hierarchy.dialogs.FolderSizePanel = Ext.extend(Ext.Panel, {
	...
	constructor: function(config)
	{
		...
		Grommunio.hierarchy.dialogs.FolderSizePanel.superclass.constructor.call(this, config);
	},
	...
	createSubfolderSizePanel: function()
	{
		return {
				...
				ref: 'subfolderView',
				flex: 1,
				store: new Grommunio.hierarchy.data.IPFSubStore(),
	...
	/**
	 * Event handler which is fired when the {@link Grommunio.core.data.MAPIStore store}
	 * fires the {@link Grommunio.core.data.MAPIStore#open} event. This will load all
...
Ext.reg('grommunio.foldersizepanel', Grommunio.hierarchy.dialogs.FolderSizePanel);
