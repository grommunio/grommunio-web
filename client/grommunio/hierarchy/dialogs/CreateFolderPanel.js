...
/**
 * @class Grommunio.hierarchy.dialogs.CreateFolderPanel
 * @extends Ext.Panel
 * @xtype grommunio.createfolderpanel
 */
Grommunio.hierarchy.dialogs.CreateFolderPanel = Ext.extend(Ext.Panel, {
	/**
	...
	constructor: function(config)
	{
		...
		Grommunio.hierarchy.dialogs.CreateFolderPanel.superclass.constructor.call(this, config);
	},

	/**
	 * Creates body for {@link Grommunio.hierarchy.dialogs.CreateFolderContentPanel CreateFolderContentPanel}
	...
	initEvents: function()
	{
		Grommunio.hierarchy.dialogs.CreateFolderPanel.superclass.initEvents.apply(this, arguments);
	...
	/**
	 * Fired when a node has been selected from the {@link Grommunio.hierarchy.ui.Tree HierarchyTree}.
	...
	/**
	 * First validates submission and calls {@link Grommunio.hierarchy.data.HierarchyStore HierarchyStore} to
	 * create new folder.
	 * @private
	 */
	onSubmit: function()
	...
	/**
	 * Closes {@link Grommunio.core.ui.CreateFolderContentPanel CreateFolderContentPanel} contentpanel
	 * @private
	 */
	onCancel: function()
	{
...
Ext.reg('grommunio.createfolderpanel', Grommunio.hierarchy.dialogs.CreateFolderPanel);
