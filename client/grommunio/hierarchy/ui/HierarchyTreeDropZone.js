...
/**
 * @class Grommunio.hierarchy.ui.HierarchyTreeDropZone
 * @extends Ext.tree.TreeDropZone
 *
 * Specialized {@link Ext.tree.TreeDropZone Drop Zone} which
 * is used for dragging and dropping over the {@link Grommunio.hierarchy.ui.HierarchyTreePanel Hierarchy Tree}.
 * This adds support for changing the icon depending if the Ctrl-key has been pressed.
 */
Grommunio.hierarchy.ui.HierarchyTreeDropZone = Ext.extend(Ext.tree.TreeDropZone, {
	/**
	...
	onNodeEnter: function(target, dd, e, data)
	{
		...
		this.onDragKeyDown = Grommunio.hierarchy.ui.HierarchyTreeDropZone.prototype.onDragKeyDown.createDelegate({ dd: dd, dz: this });
		this.onDragKeyUp = Grommunio.hierarchy.ui.HierarchyTreeDropZone.prototype.onDragKeyUp.createDelegate({ dd: dd, dz: this });
		...
		return Grommunio.hierarchy.ui.HierarchyTreeDropZone.superclass.onNodeEnter.apply(this, arguments);
	},
	...
	{
		var ret = Grommunio.hierarchy.ui.HierarchyTreeDropZone.superclass.onContainerOver.apply(this, arguments);
	...
	{
		var ret = Grommunio.hierarchy.ui.HierarchyTreeDropZone.superclass.onNodeOver.apply(this, arguments);
	...
	onNodeOut: function(target, dd, e, data)
	{
		...
		return Grommunio.hierarchy.ui.HierarchyTreeDropZone.superclass.onNodeOut.apply(this, arguments);
	},
