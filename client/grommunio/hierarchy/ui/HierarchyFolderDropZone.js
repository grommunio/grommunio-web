...
/**
 * @class Grommunio.hierarchy.ui.HierarchyFolderDropZone
 * @extends Grommunio.hierarchy.ui.HierarchyTreeDropZone
 *
 * Specialized {@link Ext.tree.TreeDropZone Drop Zone} which
 * is used for dragging and dropping {@link Grommunio.hierarchy.data.MAPIFolderRecord folders}
 * in the {@link Grommunio.hierarchy.ui.HierarchyTreePanel Hierarchy Tree}.
 */
Grommunio.hierarchy.ui.HierarchyFolderDropZone = Ext.extend(Grommunio.hierarchy.ui.HierarchyTreeDropZone, {
	...
	{
		Grommunio.hierarchy.ui.HierarchyFolderDropZone.superclass.constructor.call(this, tree, config);
	...
	getDropPoint: function(e, n, dd)
	{
		...
		if (Grommunio.hierarchy.ui.HierarchyFolderDropZone.isReorderableNode(dragNode)) {
	...
	/**
	 * Called by {@link #processDrop} to perform the final step of dropping the item.
	 ...
	 * the {@link Grommunio.hierarchy.data.MAPIFolderRecord#isDropTargetForFolders special} folders.
	 *
	 * @param {Object} n The object which describes the node over which
	 * the item is being hovered
	 ...
	 * @param {Object} data The data object describing the {@link Grommunio.hierarchy.ui.FolderNode folder} node Item which
	 * are being dragged
	 * @private
	 */
	isValidDropPoint: function(n, pt, dd, e, data)
	{
		...
		var zone = Grommunio.hierarchy.ui.HierarchyFolderDropZone;
...
Ext.apply(Grommunio.hierarchy.ui.HierarchyFolderDropZone, {
	/**
	 ...
	 * (see {@link Grommunio.hierarchy.data.HierarchyTreeLoader#directFn}).
	...
	isReorderableNode: function(node)
	{
		...
		return Grommunio.hierarchy.data.StoreOrder.isReorderable(node.getFolder().getMAPIStore());
	},
