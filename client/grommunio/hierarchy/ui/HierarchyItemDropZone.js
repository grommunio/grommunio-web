...
/**
 * @class Grommunio.hierarchy.ui.HierarchyItemDropZone
 * @extends Grommunio.hierarchy.ui.HierarchyTreeDropZone
 *
 * Specialized {@link Ext.tree.TreeDropZone Drop Zone} which
 * is used for dragging and dropping {@link Grommunio.core.data.MAPIRecord messages}
 * in the {@link Grommunio.hierarchy.ui.HierarchyTreePanel Hierarchy Tree}.
 */
Grommunio.hierarchy.ui.HierarchyItemDropZone = Ext.extend(Grommunio.hierarchy.ui.HierarchyTreeDropZone, {
	...
	isValidDropPoint: function(n, pt, dd, e, data)
	{
		...
		if (
			...
			if (!folder.isIPMSubTree()) {
				...
				ret = !Grommunio.core.EntryId.compareEntryIds(folderEntryId, itemEntryId);
				if (ret === true) {
					...
					if (ret !== true) {
						...
						ret = Grommunio.core.MessageClass.isContainerClassCompatible(messageClass, containerClass);
					}
				}
			}
		}
