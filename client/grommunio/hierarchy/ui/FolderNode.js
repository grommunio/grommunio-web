...
/**
 * @class Grommunio.hierarchy.ui.FolderNode
 ...
 */
Grommunio.hierarchy.ui.FolderNode = Ext.extend(Ext.tree.AsyncTreeNode, {
	/**
	...
	constructor: function(config)
	{
		...
		Grommunio.hierarchy.ui.FolderNode.superclass.constructor.call(this, config);
	...
	/**
	 * @return {Boolean} true, if {@link Grommunio.hierarchy.ui.FolderNode folderNode} is checked else false
	 */
	isChecked: function()
	{
		var ui = this.getUI();
	 ...
	 * This uses {@link Grommunio.common.ui.IconClass#getIconClass} to
	 * obtain the correct class for the {@link #folder}.
	 * @param {Grommunio.hierarchy.data.MAPIFolderRecord} folder The folder for which the icon class is requested
	 * @return {String} The iconclass for this folder
	 * @protected
	 */
	getIconFromFolder: function(folder)
	{
		return Grommunio.common.ui.IconClass.getIconClass(folder);
	},
...
Ext.tree.TreePanel.nodeTypes.folder = Grommunio.hierarchy.ui.FolderNode;
