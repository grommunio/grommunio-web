...
/**
 * @class Grommunio.hierarchy.data.HierarchyProxy
 * @extends Grommunio.core.data.MAPIProxy
 */
Grommunio.hierarchy.data.HierarchyProxy = Ext.extend(Grommunio.core.data.MAPIProxy, {
	/**
	 * @constructor
	...
	constructor: function(config)
	{
		...
		var module = Grommunio.core.ModuleNames.getModule('hierarchy');
		...
		Grommunio.hierarchy.data.HierarchyProxy.superclass.constructor.call(this, config);
	},
	...
	{
		return new Grommunio.hierarchy.data.HierarchyResponseHandler({
			proxy: this,
			action: action,
			reader: reader,
			sendRecords: records,
