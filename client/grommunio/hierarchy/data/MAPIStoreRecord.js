 ...
 * #dependsFile client/grommunio/hierarchy/data/IPFSubStore.js
 */
Ext.namespace('Grommunio.hierarchy.data');

/**
 * @class Grommunio.hierarchy.data.MAPIStoreRecordFields
 * Array of {@link Ext.data.Field field} configurations for the
 * {@link Grommunio.core.data.IPFRecord IPFRecord} object.
 */
Grommunio.hierarchy.data.MAPIStoreRecordFields = [
	{name: 'store_entryid'},
	{name: 'common_view_entryid'},
	{name: 'object_type', type: 'int', defaultValue: Grommunio.core.mapi.ObjectType.MAPI_STORE},
...
Grommunio.core.data.RecordFactory.addFieldToObjectType(Grommunio.core.mapi.ObjectType.MAPI_STORE, Grommunio.hierarchy.data.MAPIStoreRecordFields);
Grommunio.core.data.RecordFactory.setSubStoreToObjectType(Grommunio.core.mapi.ObjectType.MAPI_STORE, 'folders', Grommunio.hierarchy.data.IPFSubStore);
Grommunio.core.data.RecordFactory.setSubStoreToObjectType(Grommunio.core.mapi.ObjectType.MAPI_STORE, 'favorites', Grommunio.common.favorites.data.MAPIFavoritesSubStore);

Grommunio.core.data.RecordFactory.addListenerToObjectType(Grommunio.core.mapi.ObjectType.MAPI_STORE, 'createphantom', function(record) {
	// Phantom records must always be marked as opened (they contain the full set of data)
	record.afterOpen();
});

/**
 * @class Grommunio.hierarchy.data.MAPIStoreRecord
 * @extends Grommunio.core.data.IPFRecord
 *
 */
Grommunio.hierarchy.data.MAPIStoreRecord = Ext.extend(Grommunio.core.data.IPFRecord, {
	/**
	 ...
	 * @return {Grommunio.hierarchy.data.MAPIFolderRecord} folder object or undefined if not found.
	 */
	...
	hasSearchSupport: function()
	{
		if (this.get('store_support_mask')) {
			if(Grommunio.core.mapi.StoreSupportMask.hasSearchSupport(this.get('store_support_mask'))) {
				return true;
			}
		}
	...
	/**
	 * @return {Boolean} True if this is the public {@link Grommunio.core.MAPIStore store}.
	 */
	isPublicStore: function()
	{
		return (this.get('mdb_provider') === Grommunio.core.mapi.MDBProvider.GROMMUNIO_STORE_PUBLIC_GUID);
	},

	/**
	 * @return {Boolean} True if this is the default {@link Grommunio.core.MAPIStore store}.
	 */
	isDefaultStore: function()
	{
		return (this.get('mdb_provider') === Grommunio.core.mapi.MDBProvider.GROMMUNIO_SERVICE_GUID);
	},
	...
	{
		return (this.get('mdb_provider') === Grommunio.core.mapi.MDBProvider.GROMMUNIO_STORE_DELEGATE_GUID);
	},
	...
	{
		return (this.get('mdb_provider') === Grommunio.core.mapi.MDBProvider.GROMMUNIO_STORE_ARCHIVER_GUID);
	},
	...
	/**
	 * Function will return default {@link Grommunio.hierarchy.data.MAPIFolderRecord MAPIFolderRecord}
	 * of this {@link Grommunio.hierarchy.data.MAPIStoreRecord MAPIStoreRecord}.
	 * @param {String} name name of the default folder (i.e. 'inbox' or 'contacts')
	 * @return {Grommunio.hierarchy.data.MAPIFolderRecord} folder if a default folder
	...
	/**
	 * Function will return shared {@link Grommunio.hierarchy.data.MAPIFolderRecord MAPIFolderRecord}
	 * of this {@link Grommunio.hierarchy.data.MAPIStoreRecord MAPIStoreRecord}.
	 * @param {String} name name of the shared folder (i.e. 'inbox' or 'contacts')
	 * @return {Grommunio.hierarchy.data.MAPIFolderRecord} folder if a shared folder
	 * with the given name was found, or undefined otherwise.
	 */
	...
	/**
	 * @return {Grommunio.hierarchy.data.MAPIFolderRecord} subtree folder.
	 */
	 ...
	 * @return {Grommunio.hierarchy.data.MAPIFolderRecord} favorites root folder.
	 */
	...
	/**
	 * Not to be implemented by {@link Grommunio.hierarchy.data.MAPIStoreRecord MAPIStoreRecord}
	...
	/**
	 * Not to be implemented bby {@link Grommunio.hierarchy.data.MAPIStoreRecord MAPIStoreRecord}
	...
	/**
	 * Not to be implemented by {@link Grommunio.hierarchy.data.MAPIStoreRecord MAPIStoreRecord}
	 * Copy the {@link Grommunio.hierarchy.data.MAPIFolderRecord MAPIFolderRecord} to a different {@link Grommunio.hierarchy.data.MAPIFolderRecord MAPIFolderRecord}.
	...
	/**
	 * Not to be implemented by {@link Grommunio.hierarchy.data.MAPIStoreRecord MAPIStoreRecord}
	 * Move the {@link Grommunio.hierarchy.data.MAPIFolderRecord MAPIFolderRecord} to a different {@link Grommunio.hierarchy.data.MAPIFolderRecord MAPIFolderRecord}.
	 * @param {Grommunio.hierarchy.data.MAPIFolderRecord} folder The folder to copy the record to
	 * @hide
	 */
	moveTo: Ext.emptyFn,
	...
	/**
	 * Creates a Folder store for the {@link Grommunio.hierarchy.data.IPFRecord IPFRecord} (See {@link #createSubStore}).
	 * @return {Grommunio.hierarchy.data.IPFSubStore} The new Folder store.
	 */
	...
	/**
	 * Set the Folder store for the {@link Grommunio.hierarchy.data.IPFRecord IPFRecord} (See {@link #setSubStore}).
	 * @param {Grommunio.hierarchy.data.IPFSubStore} folderStore The Folder store.
	 * @return {Grommunio.hierarchy.data.IPFSubStore} The Folder store.
	 */
	...
	/**
	 * Get the Folder store for the {@link Grommunio.core.data.IPFRecord IPFRecord} (See {@link #getSubStore}).
	 * @return {Grommunio.hierarchy.data.IPFSubStore} The Folder store.
	 */
	...
	/**
	 * Get the favorites store for the {@link Grommunio.core.data.IPFRecord IPFRecord}.
	 * @returns {Grommunio.hierarchy.data.IPFSubStore} The Favorites store.
	 */
...
Grommunio.core.data.RecordFactory.setBaseClassToObjectType(Grommunio.core.mapi.ObjectType.MAPI_STORE, Grommunio.hierarchy.data.MAPIStoreRecord);
