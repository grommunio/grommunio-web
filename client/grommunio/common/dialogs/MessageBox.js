...
/**
 * @class Grommunio.common.dialogs.MessageBox
...
Grommunio.common.dialogs.MessageBox = Ext.apply({}, {
   ...
   * @return {Grommunio.common.dialogs.MessageBox} this
   */
	 ...
	 * @return {Grommunio.common.dialogs.RadioMessageBox} this
	 */
	...
	onButtonClick: function(button, event, callback, radioGroup)
	{
		...
		Grommunio.common.dialogs.MessageBox.hide();
		if(radioGroup) {
