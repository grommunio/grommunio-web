...
/**
 * @class Grommunio.common.dialogs.CustomMessageBox
 * @extends Ext.Window
 *
 ...
 */
Grommunio.common.dialogs.CustomMessageBox = Ext.extend(Ext.Window, {
	...
	constructor: function (config)
	{
		...
		Grommunio.common.dialogs.CustomMessageBox.superclass.constructor.call(this, config);
		this.show();
	},
	...
	onBeforeShow: function ()
	{
		...
		// Set default button which has 'grommunio-action' class.
		var defaultButton = this.buttons.find(function (btn) {
			if (btn.getEl()) {
				return btn.getEl().hasClass('grommunio-action');
			}
			return false;
		});
		Ext.applyIf(this, {
	...
	/**
	 * Initialize the {@link Grommunio.common.dialogs.CustomMessageBox Dialog} with {@link #customItems}.
