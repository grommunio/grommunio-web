...
/**
 * @class Grommunio.common.rules.dialogs.RulesConditionContainer
 ...
 */
Grommunio.common.rules.dialogs.RulesConditionContainer = Ext.extend(Grommunio.common.rules.dialogs.BaseContainer, {
	...
	constructor: function(config)
	{
		...
		Grommunio.common.rules.dialogs.RulesConditionContainer.superclass.constructor.call(this, config);
	},
	...
	createComboBoxContainer: function(index)
	{
		...
		var profileStore = {
			...
			data: Grommunio.common.rules.data.ConditionProfiles
		};

		return Grommunio.common.rules.dialogs.RulesConditionContainer.superclass.createComboBoxContainer.call(this, id, profileStore);
	},
	...
	removeComboBoxContainer: function()
	{
		if (this.boxContainerCount > 1) {
			...
			if (conditionFlag === Grommunio.common.rules.data.ConditionFlags.ATMOST_SIZE) {
				this.record.set('rule_msg_atmost_size_unit', '');
			} else if (conditionFlag === Grommunio.common.rules.data.ConditionFlags.ATLEAST_SIZE) {
		...
		if (contentReset || isConditionsChanged) {
			...
			for (var i = 0, len = conditions.length; i < len; i++) {
				...
				if (conditions[i]) {
					...
					var isAtleastSizeCondition = conditionFlag === Grommunio.common.rules.data.ConditionFlags.ATLEAST_SIZE;
					var isAtmostSizeCondition = conditionFlag === Grommunio.common.rules.data.ConditionFlags.ATMOST_SIZE;
...
Ext.reg('grommunio.rulesconditioncontainer', Grommunio.common.rules.dialogs.RulesConditionContainer);
