...
/**
 * @class Grommunio.common.rules.dialogs.DeleteLink
 * @extends Grommunio.common.rules.dialogs.FolderSelectionLink
 * @xtype grommunio.deletelink
 *
 * Extension of the {@link Grommunio.common.rules.dialogs.FolderSelectionLink Folder Selection Link}
 * especially for the {@link Grommunio.common.rules.data.ActionFlags#DELETE DELETE ActionFlag}.
 *
 * This will not show anything to the user, but during {@link #setAction} this will force
 * the {@link #actionFlag} to be {@link Grommunio.common.rules.data.ActionFlags#MOVE MOVE}
 * and the {@link #folder} to be set to the 'Deleted Items' folder.
 */
Grommunio.common.rules.dialogs.DeleteLink = Ext.extend(Grommunio.common.rules.dialogs.FolderSelectionLink, {
	...
	setAction: function(actionFlag, action)
	{
		...
		this.actionFlag = Grommunio.common.rules.data.ActionFlags.MOVE;
		this.action = action;
...
Ext.reg('grommunio.deletelink', Grommunio.common.rules.dialogs.DeleteLink);
