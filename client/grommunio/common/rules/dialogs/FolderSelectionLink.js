...
/**
 * @class Grommunio.common.rules.dialogs.FolderSelectionLink
 * @extends Ext.BoxComponent
 * @xtype grommunio.folderselectionlink
 *
 * Action component for the {@link Grommunio.common.rules.data.ActionFlags#MOVE MOVE}
 * and {@link Grommunio.common.rules.data.ActionFlags#COPY COPY} Action Flags. This
 * will show the currently selected {@link #folder} to the user, and allows
 * the user to select the desired destination folder.
 */
Grommunio.common.rules.dialogs.FolderSelectionLink = Ext.extend(Ext.BoxComponent, {
	/**
	...
	constructor: function(config)
	{
		...
		Ext.applyIf(config,{
			...
			tpl: new Ext.XTemplate(
				'<div class="grommunio-folder-link">' +
		...
		Grommunio.common.rules.dialogs.FolderSelectionLink.superclass.constructor.call(this, config);
	},
	...
	{
		Grommunio.common.rules.dialogs.FolderSelectionLink.superclass.afterRender.apply(this, arguments);

		this.mon(this.getActionEl(), 'click', this.onClick, this);
	},

	/**
	 * Called when user clicks on a {@link Grommunio.common.rules.dialogs.FolderSelectionLink}
	 ...
	 * the {@link #folder}.
	 * @param {Grommunio.hierarchy.data.MAPIFolderRecord} folder The folder to show
	 */
	update: function(folder)
	{
		var data = folder ? folder.data : { display_name: this.emptyText };
		Grommunio.common.rules.dialogs.FolderSelectionLink.superclass.update.call(this, this.tpl.apply(data));
	}
});

Ext.reg('grommunio.folderselectionlink', Grommunio.common.rules.dialogs.FolderSelectionLink);
