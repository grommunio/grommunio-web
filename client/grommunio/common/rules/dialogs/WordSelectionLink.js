...
/**
 * @class Grommunio.common.rules.dialogs.WordSelectionLink
 * @extends Ext.BoxComponent
 * @xtype grommunio.wordselectionlink
 */
Grommunio.common.rules.dialogs.WordSelectionLink = Ext.extend(Ext.BoxComponent, {
	/**
	...
	constructor: function(config)
	{
		...
		Grommunio.common.rules.dialogs.WordSelectionLink.superclass.constructor.call(this, config);
	},
	...
	{
		Grommunio.common.rules.dialogs.WordSelectionLink.superclass.initComponent.apply(this, arguments);

		this.mon(this.getActionEl(), 'click', this.onClick, this);
	},

	/**
	 * Called when user clicks on a {@link Grommunio.common.rules.dialogs.WordSelectionLink}
	...
	onClick: function(dataView, index, node, evt)
	{
		...
		Grommunio.common.Actions.openRulesWordsEditContent({
			store: tmpStore,
	...
	/**
	 * Callback function for {@link Grommunio.common.rules.dialogs.RulesWordsEditDialog}
					...
					for (var i = 0, len = subs.length; i < len; i++) {
						...
						Ext.iterate(value, function(key, value) {
							if(!Ext.isEmpty(value)) {
								this.isValid = true;
								if (conditionFlag === Grommunio.common.rules.data.ConditionFlags.SENDER_WORDS) {
									value = Grommunio.core.Util.hexToString(value);
								}
	...
	update: function(store)
	{
		...
		Grommunio.common.rules.dialogs.WordSelectionLink.superclass.update.call(this, this.tpl.apply(data));
	}
});

Ext.reg('grommunio.wordselectionlink', Grommunio.common.rules.dialogs.WordSelectionLink);
