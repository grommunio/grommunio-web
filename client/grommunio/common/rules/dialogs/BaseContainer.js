...
/**
 * @class Grommunio.common.rules.dialogs.BaseContainer
 * @extends Ext.Container
 * @xtype grommunio.basecontainer
 *
 * The base container is base class of {@link Grommunio.common.rules.dialogs.RulesConditionContainer RulesConditionContainer}
 * and {@link Grommunio.common.rules.dialogs.RulesExceptionContainer RulesExceptionContainer}.
 * This container manages adding, removing and creating combo box containers.
 * And includes common functionality of {@link Grommunio.common.rules.dialogs.RulesConditionContainer RulesConditionContainer}
 * and {@link Grommunio.common.rules.dialogs.RulesExceptionContainer RulesExceptionContainer}.
 * This class can be expanded to create containers like conditions container and exception container, and is able to parse
 * the rules_condition property of a {@link Grommunio.common.rules.data.RulesRecord rule}.
 */
Grommunio.common.rules.dialogs.BaseContainer = Ext.extend(Ext.Container, {
  /**
  ...
  constructor: function(config)
  {
    ...
    Grommunio.common.rules.dialogs.BaseContainer.superclass.constructor.call(this, config);
  },
  ...
  createContentPanels: function(baseId) {
    return [{
      ...
      xtype: 'grommunio.userselectionlink',
      id: baseId + '-from'
    }, {
      xtype: 'grommunio.wordselectionlink',
      ...
      xtype: 'grommunio.sentccmelink',
      id: baseId + '-cc-me'
    }, {
      xtype: 'grommunio.namebcclink',
      id: baseId + '-name-to-bcc'
    }, {
      xtype: 'grommunio.nametocclink',
      id: baseId + '-name-to-cc'
    }, {
      xtype: 'grommunio.sensitivitylink',
  ...
  /**
   * This function will update 'rule_condition' property of {@link Grommunio.core.data.IPMRecord record}.
     ...
     * @param {Grommunio.core.data.IPMRecord} record which needs to be updated.
    ...
    updateConditionsInRecord: function(record, conditionsToSet, isException)
    {
        ...
        if (isException) {
            ...
            if (conditions.length > 1) {
                conditions = Grommunio.core.data.RestrictionFactory.createResAnd(conditions);
            } else {
            ...
            if (conditionsToSet.length > 1) {
                conditionsToSet = Grommunio.core.data.RestrictionFactory.createResAnd(conditionsToSet);
            } else {
    ...
    /**
     * Convert the conditions object as stored in a {@link Grommunio.common.rules.data.RulesRecord rule}
    ...
    getConditionsArray: function(conditions)
    {
        ...
        if (conditions[0] === Grommunio.core.mapi.Restrictions.RES_AND) {
            var single = false;
            ...
            if (totalConditions >= 3) {
                ...
                for (var i = 0; i < totalConditions; i++) {
                    ...
                    if (innerCondition) {
                        if (innerCondition[0] === Grommunio.core.mapi.Restrictions.RES_PROPERTY) {
                            var ulPropTagValue = innerCondition[1][Grommunio.core.mapi.Restrictions.ULPROPTAG];
                        ...
                        } else if (innerCondition[0] === Grommunio.core.mapi.Restrictions.RES_NOT) {
                            innerCondition = innerCondition[1];
                            if (innerCondition[1][Grommunio.core.mapi.Restrictions.ULPROPTAG] === 'PR_DISPLAY_TO') {
                                conditionCounter++;
                            }
                        }
    ...
    /**
     * Load a Condition from a {@Link Grommunio.common.rules.data.RulesRecord} and apply it
     ...
     * @param {Grommunio.common.data.SizeUnits} sizeUnit selected size unit for the at least and at most size condition components.
     * @private
     */
    applyCondition: function(panel, condition, sizeUnit)
    {
        ...
        if (index >= 0) {
            ...
            conditionFlag = Grommunio.common.rules.data.ConditionFlags.UNKNOWN;
        ...
        switch (conditionFlag) {
            case Grommunio.common.rules.data.ConditionFlags.UNKNOWN:
            /* falls through*/
            default:
                break;
            case Grommunio.common.rules.data.ConditionFlags.ATLEAST_SIZE:
            case Grommunio.common.rules.data.ConditionFlags.ATMOST_SIZE:
                layout.activeItem.setCondition(conditionFlag, condition, sizeUnit);
                break;
            case Grommunio.common.rules.data.ConditionFlags.SUBJECT_WORDS:
            case Grommunio.common.rules.data.ConditionFlags.BODY_WORDS:
            case Grommunio.common.rules.data.ConditionFlags.TRANSPORTHEADER_WORDS:
            case Grommunio.common.rules.data.ConditionFlags.IMPORTANCE:
            case Grommunio.common.rules.data.ConditionFlags.RECEIVED_AFTER:
            case Grommunio.common.rules.data.ConditionFlags.RECEIVED_BEFORE:
            case Grommunio.common.rules.data.ConditionFlags.RECEIVED_FROM:
            case Grommunio.common.rules.data.ConditionFlags.SENDER_WORDS:
            case Grommunio.common.rules.data.ConditionFlags.RECIPIENT_WORDS:
            case Grommunio.common.rules.data.ConditionFlags.SENSITIVITY:
            case Grommunio.common.rules.data.ConditionFlags.SENT_TO:
            case Grommunio.common.rules.data.ConditionFlags.SENT_TO_ME:
            case Grommunio.common.rules.data.ConditionFlags.SENT_TO_ME_ONLY:
            case Grommunio.common.rules.data.ConditionFlags.NAME_BCC:
            case Grommunio.common.rules.data.ConditionFlags.SENT_CC_ME:
            case Grommunio.common.rules.data.ConditionFlags.NONE:
    ...
    /**
     * Read a Condition object as located in the {@link Grommunio.common.rules.data.RulesRecord Rule}
     ...
     * @return {Grommunio.common.rules.data.ConditionFlags} The Condition Flag
     * @private
     */
        ...
        switch (condition[0]) {
            case Restrictions.RES_COMMENT:
                switch (condition[1][Restrictions.RESTRICTION][1][Restrictions.ULPROPTAG]) {
                    case 'PR_SENDER_SEARCH_KEY':
                        return Grommunio.common.rules.data.ConditionFlags.RECEIVED_FROM;
                    default:
                        return Grommunio.common.rules.data.ConditionFlags.UNKNOWN;
                }
            ...
            case Restrictions.RES_BITMASK:
                switch (condition[1][Restrictions.ULPROPTAG]) {
                    case 'PR_BODY':
                        return Grommunio.common.rules.data.ConditionFlags.BODY_WORDS;
                    case 'PR_TRANSPORT_MESSAGE_HEADERS':
                        return Grommunio.common.rules.data.ConditionFlags.TRANSPORTHEADER_WORDS;
                    case 'PR_SUBJECT':
                        return Grommunio.common.rules.data.ConditionFlags.SUBJECT_WORDS;
                    case 'PR_IMPORTANCE':
                        return Grommunio.common.rules.data.ConditionFlags.IMPORTANCE;
                    case 'PR_MESSAGE_RECIPIENTS':
                        ...
                        if (condition[0] === Restrictions.RES_SUBRESTRICTION) {
                            ...
                            if (isRecepientWordsRes) {
                                return Grommunio.common.rules.data.ConditionFlags.RECIPIENT_WORDS;
                            }
                            return Grommunio.common.rules.data.ConditionFlags.SENT_TO;
                        }
                        break;
                    case 'PR_MESSAGE_TO_ME':
                        return Grommunio.common.rules.data.ConditionFlags.SENT_TO_ME;
                    case 'PR_SENDER_SEARCH_KEY':
                        return Grommunio.common.rules.data.ConditionFlags.SENDER_WORDS;
                    case 'PR_MESSAGE_FLAGS':
                        return Grommunio.common.rules.data.ConditionFlags.ATTACHMENT;
                    case 'PR_MESSAGE_RECIP_ME':
                        return Grommunio.common.rules.data.ConditionFlags.NAME_TO_CC;
                    case 'PR_MESSAGE_SIZE':
                        if (condition[1][1] === Restrictions.RELOP_LE) {
                            return Grommunio.common.rules.data.ConditionFlags.ATMOST_SIZE;
                        } else if (condition[1][1] === Restrictions.RELOP_GE) {
                            return Grommunio.common.rules.data.ConditionFlags.ATLEAST_SIZE;
                        }
                        break;
                    case 'PR_SENSITIVITY':
                        return Grommunio.common.rules.data.ConditionFlags.SENSITIVITY;
                    case 'PR_MESSAGE_DELIVERY_TIME':
                        if (condition[1][1] === Restrictions.RELOP_LT) {
                            return Grommunio.common.rules.data.ConditionFlags.RECEIVED_BEFORE;
                        } else if (condition[1][1] === Restrictions.RELOP_GT) {
                            return Grommunio.common.rules.data.ConditionFlags.RECEIVED_AFTER;
                        }
                    /* falls through*/
                    default:
                        return Grommunio.common.rules.data.ConditionFlags.UNKNOWN;
            ...
            case Restrictions.RES_AND:
                ...
                for (var i = 0, len = condition[1].length; i < len; i++) {
                    ...
                    if (sub[0] === Restrictions.RES_PROPERTY &&
                        ...
                        return Grommunio.common.rules.data.ConditionFlags.SENT_CC_ME;
                    }
                    // Check if the RES_AND contains the restriction for PR_MESSAGE_TO_ME,
                    ...
                    if (sub[0] === Restrictions.RES_PROPERTY &&
                        ...
                        return Grommunio.common.rules.data.ConditionFlags.SENT_TO_ME_ONLY;
                    }
                }

                // if all three conditions is matched with bcc rule's restriction then only return BCC flag.
                if (bccLinkFlag === 3) {
                    return Grommunio.common.rules.data.ConditionFlags.NAME_BCC;
                }
                return Grommunio.common.rules.data.ConditionFlags.UNKNOWN;
            case Restrictions.RES_OR:
                for (var i = 0, len = condition[1].length; i < len; i++) {
                    ...
                    if (type !== Grommunio.common.rules.data.ConditionFlags.UNKNOWN) {
                        return type;
                    }
                }
                return Grommunio.common.rules.data.ConditionFlags.UNKNOWN;
            case Restrictions.RES_EXIST:
                return Grommunio.common.rules.data.ConditionFlags.NONE;
            default:
                return Grommunio.common.rules.data.ConditionFlags.UNKNOWN;
        }
    },
    ...
    onComboSelect: function(combo, record, index)
    {
        ...
        switch (value) {
            ...
            case Grommunio.common.rules.data.ConditionFlags.SENT_TO_ME:
                ...
                layout.activeItem.setCondition(value);
                break;
            case Grommunio.common.rules.data.ConditionFlags.ATTACHMENT:
            ...
            case Grommunio.common.rules.data.ConditionFlags.SENT_CC_ME:
                ...
                layout.activeItem.setCondition(value);
                break;
            case Grommunio.common.rules.data.ConditionFlags.NAME_TO_CC:
...
Ext.reg('grommunio.basecontainer', Grommunio.common.rules.dialogs.BaseContainer);
