...
/**
 * @class Grommunio.common.rules.dialogs.MarkAsReadLink
 * @extends Ext.Container
 * @xtype grommunio.markasreadlink
 *
 * Extension of the {@link Ext.Container Container}
 * especially for the {@link Grommunio.common.rules.data.ActionFlags#MARK_AS_READ MARK_AS_READ ActionFlag}.
 ...
 * the {@link #actionFlag} to be {@link Grommunio.common.rules.data.ActionFlags#MARK_AS_READ MARK_AS_READ}
 */
Grommunio.common.rules.dialogs.MarkAsReadLink = Ext.extend(Ext.Container,{
...
Ext.reg('grommunio.markasreadlink', Grommunio.common.rules.dialogs.MarkAsReadLink);
