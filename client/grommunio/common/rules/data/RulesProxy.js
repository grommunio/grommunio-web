...
/**
 * @class Grommunio.common.rulesdata.RulesProxy
 * @extends Grommunio.core.data.IPMProxy
 *
 ...
 * them as a batch.
 */
Grommunio.common.rules.data.RulesProxy = Ext.extend(Grommunio.core.data.IPMProxy, {
	/**
	...
	{
		return new Grommunio.common.rules.data.RulesResponseHandler({
			proxy: this,
			action: action,
			reader: reader,
			sendRecords: records,
	...
	createUpdateAction: function(action, records, parameters, reader, callback, scope, args)
	{
		...
		Grommunio.common.rules.data.RulesProxy.superclass.createUpdateAction.apply(this, arguments);
	},
	...
	destroyAction: function(action, records, parameters, reader, callback, scope, args)
	{
		...
		Grommunio.common.rules.data.RulesProxy.superclass.destroyAction.apply(this, arguments);
	},
	...
	openAction: function(action, records, parameters, reader, callback, scope, args)
	{
		...
		Grommunio.common.rules.data.RulesProxy.superclass.openAction.apply(this, arguments);
	}
});
