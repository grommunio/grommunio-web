...
/**
 * @class Grommunio.common.rules.data.RulesStore
 * @extends Grommunio.core.data.MAPIStore
 *
 * Delegate store that will be used to load delegates information from server.
 */
Grommunio.common.rules.data.RulesStore = Ext.extend(Grommunio.core.data.MAPIStore, {
	/**
	...
	constructor: function(config)
	{
		...
		Ext.applyIf(config, {
			...
			reader: new Grommunio.common.rules.data.JsonRulesReader(),

			proxy: new Grommunio.common.rules.data.RulesProxy({
				listModuleName: Grommunio.core.ModuleNames.getListName('RULES'),
				itemModuleName: Grommunio.core.ModuleNames.getItemName('RULES')
			})
		});

		Grommunio.common.rules.data.RulesStore.superclass.constructor.call(this, config);
	},

	/**
	 * Event handler which is raised when a {@link Grommunio.common.rules.data.RulesRecord RulesRecord} has been added
	 * to this {@link Grommunio.common.rules.data.RulesStore RulesStore}. This will generate unique value for rule_sequence
	 * property.
	 *
	 * @param {Grommunio.common.rules.data.RulesStore} store The {@link Grommunio.common.rules.data.RulesStore} to which the store was added.
	 * @param {Grommunio.common.rules.data.RulesRecord[]} records The array of {@link Grommunio.common.rules.data.RulesRecord records} which have been added.
	...
	createRecords: function(store, records, index)
	{
		...
		Grommunio.common.rules.data.RulesStore.superclass.createRecords.apply(this, arguments);
	},
	...
	load: function(options)
	{
		...
		return Grommunio.common.rules.data.RulesStore.superclass.load.call(this, options);
	}
});
