...
/**
 * @class Grommunio.common.rules.ui.RulesGrid
 * @extends Grommunio.common.ui.grid.GridPanel
 * @xtype grommunio.rulesgrid
 *
 * {@link Grommunio.common.rules.ui.RulesGrid RulesGrid} will be used to display
 * rules information of the current user.
 */
Grommunio.common.rules.ui.RulesGrid = Ext.extend(Grommunio.common.ui.grid.GridPanel, {
	/**
	 * @constructor
	...
	constructor: function(config)
	{
		...
		Grommunio.common.rules.ui.RulesGrid.superclass.constructor.call(this, config);
	},
	...
	initEvents: function()
	{
		Grommunio.common.rules.ui.RulesGrid.superclass.initEvents.call(this);
	...
	{
		var stateOnlyWhenOOF = value & Grommunio.core.mapi.RuleStates.ST_ONLY_WHEN_OOF;

		if (stateOnlyWhenOOF === Grommunio.core.mapi.RuleStates.ST_ONLY_WHEN_OOF) {
			p.css += ' icon_rule_oof';
		}
		return '';
	},
	...
	{
		value = ((value & Grommunio.core.mapi.RuleStates.ST_ENABLED) === Grommunio.core.mapi.RuleStates.ST_ENABLED);
	 ...
	 * @param {Grommunio.common.ui.grid.GridPanel} grid grid panel which holds this {@link Grommunio.common.ui.grid.ColumnModel ColumnModel}
	...
	onRuleStateColumnProcessEvent: function(name, e, grid, rowIndex, colIndex)
	{
		if(name === 'mousedown') {
			...
			if ((rule_state & Grommunio.core.mapi.RuleStates.ST_ENABLED) === Grommunio.core.mapi.RuleStates.ST_ENABLED) {
				record.set('rule_state', rule_state & ~Grommunio.core.mapi.RuleStates.ST_ENABLED);
			} else {
				record.set('rule_state', rule_state | Grommunio.core.mapi.RuleStates.ST_ENABLED);
			}
		}
	...
	{
		Grommunio.common.rules.ui.RulesGrid.superclass.onViewReady.apply(this, arguments);
	...
	{
		Grommunio.common.rules.ui.RulesGrid.superclass.onStoreLoad.apply(this, arguments);
	...
	/**
	 * Event handler which is fired when the {@link Grommunio.common.rules.ui.RulesGrid RulesGrid} is double clicked.
	 * @private
	 */
	onRowDblClick: function(grid, rowIndex)
	{
		// open rule edit dialog
		Grommunio.common.Actions.openRulesEditContent(grid.getStore().getAt(rowIndex));
	},

	/**
	 * Event handler will be called when selection in {@link Grommunio.common.rules.ui.RulesGrid RulesGrid}
	 * has been changed
	...
	{
		// open rule edit dialog
		var ruleRecord = Grommunio.core.data.RecordFactory.createRecordObjectByCustomType(Grommunio.core.data.RecordCustomObjectType.GROMMUNIO_RULE);
		this.getStore().add(ruleRecord);

		Grommunio.common.Actions.openRulesEditContent(ruleRecord, { removeRecordOnCancel: true });
	},
	...
	onRuleEdit: function()
	{
		...
		// open rule edit dialog
		Grommunio.common.Actions.openRulesEditContent(ruleRecord);
	},
	 ...
	 * the {@link #store}.
	 * @param {Grommunio.common.rules.data.RulesRecord} a The first rule
	 * @param {Grommunio.common.rules.data.RulesRecord} b The second rule
	 * @private
	 */
...
Ext.reg('grommunio.rulesgrid', Grommunio.common.rules.ui.RulesGrid);
