...
/**
 * @class Grommunio.common.printer.renderers.RecordRenderer
 ...
 */
Grommunio.common.printer.renderers.RecordRenderer = Ext.extend(Grommunio.common.printer.renderers.BaseRenderer, {
	/**
	 ...
	 * @param {Grommunio.core.data.MAPIRecord} record to get data value from
	 * @param {String} header to place in the table before the record value
