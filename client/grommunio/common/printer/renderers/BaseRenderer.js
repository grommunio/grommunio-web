...
/**
 * @class Grommunio.common.printer.renderers.BaseRenderer
 * @extends Object
 * Abstract base renderer class. Don't use this directly, use a subclass instead.
 */
Grommunio.common.printer.renderers.BaseRenderer = Ext.extend(Object, {
	/**
	 * @constructor
	 ...
	 * @param {Grommunio.core.data.MAPIRecord} record The record(s)
	 * that will be printed, or the context for which the items in the store will be printed.
	 ...
	 * @param {Grommunio.core.data.MAPIRecord|Grommunio.core.Context} objectToPrint The object being printed
