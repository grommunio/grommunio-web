...
Grommunio.common.recipientfield.ui.RecipientBox = Ext.extend(Grommunio.common.ui.Box, {
	 ...
	 */
	expandBtnCls: 'x-grommunio-boxfield-item-expand',
	 ...
	 */
	expandBtnHoverCls: 'x-grommunio-boxfield-item-expand-hover',
	...
	constructor: function(config)
	{
		...
		Ext.applyIf(config, {
			cls: 'x-grommunio-boxfield-recipient-item',
			textTpl:
		...
		Grommunio.common.recipientfield.ui.RecipientBox.superclass.constructor.call(this, config);
	},
	...
	{
		Grommunio.common.recipientfield.ui.RecipientBox.superclass.renderButtons.apply(this, arguments);

		// Render the expand button only if the recipient is distribution list.
		if(this.record.get('object_type') == Grommunio.core.mapi.ObjectType.MAPI_DISTLIST) {
	...
	{
		Grommunio.common.recipientfield.ui.RecipientBox.superclass.afterRender.call(this, ct);
	...
	{
		Grommunio.common.recipientfield.ui.RecipientBox.superclass.setEditable.call(this, value);
	...
	doExpand: function(buttonClicked, text)
	{
		if (buttonClicked == 'ok') {
			...
			Grommunio.common.recipientfield.ui.RecipientBox.superclass.onClickRemove.apply(this, arguments);
		}
	},
	...
	prepareIcon: function(record)
	{
		if (record.isResolved() || (record.attemptedToResolve() && record.isValidSMTP())) {
			return Grommunio.common.recipientfield.ui.RecipientBox.superclass.prepareIcon.apply(this, arguments);
		}
	},
	 ...
	 * or if the user is a valid {@link Grommunio.core.data.IPMRecipientRecord#isValidSMTP SMTP address}.
	 *
	...
	{
		Grommunio.common.recipientfield.ui.RecipientBox.superclass.update.apply(this, arguments);
...
Ext.reg('grommunio.recipientbox', Grommunio.common.recipientfield.ui.RecipientBox);
