...
/**
 * @class Grommunio.common.recipientfield.ui.RecipientHoverCardButton
 * @extends Ext.Button
 * The base class for all button that render into {@link Grommunio.common.recipientfield.ui.RecipientHoverCard}.
 * RecipientHoverCardButton provides click event handler and hide parent card view
 * @xtype grommunio.recipienthovercardbutton
 */
Grommunio.common.recipientfield.ui.RecipientHoverCardButton = Ext.extend(Ext.Button, {
	...
	/**
	 * @cfg {Grommunio.common.recipientfield.ui.RecipientHoverCard} parentCard parent card view component.
	 */
	...
	constructor: function (config)
	{
		...
		config = Ext.applyIf(config, {
			cls: 'k-recipient-hover-card-button grommunio-normal'
		});

		Grommunio.common.recipientfield.ui.RecipientHoverCardButton.superclass.constructor.call(this, config);
	},
	...
	{
		Grommunio.common.recipientfield.ui.RecipientHoverCardButton.superclass.initComponent.call(this);
	...
	{
		Grommunio.common.recipientfield.ui.RecipientHoverCardButton.superclass.onRender.apply(this, arguments);
		var parentCard = this.findParentByType('grommunio.recipienthovercardview');
		if (parentCard) {
	...
	beforeDestroy: function ()
	{
		...
		Grommunio.common.recipientfield.ui.RecipientHoverCardButton.superclass.beforeDestroy.call(this);
	},

	/**
	 * @return {Ext.data.Record} record which was registered in {@link Grommunio.common.recipientfield.ui.RecipientHoverCard}.
	 */
	getRecords: function ()
	{
...
Ext.reg('grommunio.recipienthovercardbutton', Grommunio.common.recipientfield.ui.RecipientHoverCardButton);
