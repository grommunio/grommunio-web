...
/**
 * @class Grommunio.common.recipientfield.ui.RecipientHoverCardView
 * @extends Ext.Window
 * @xtype grommunio.recipienthovercardview
 *
 ...
 */
Grommunio.common.recipientfield.ui.RecipientHoverCardView = Ext.extend(Ext.Window, {
	// Insertion points for this class
	/**
	 * @insert context.common.recipientfield.hovercardview.actions
	 * @param {Grommunio.common.recipientfield.ui.RecipientHoverCardView} recipienthovercardview This hover card view
	 */
	...
	/**
	 * @cfg {Grommunio.common.ui.messagepanel.RecipientLinks | Grommunio.common.ui.messagepanel.SentInfoLinks} recipient
	...
	constructor: function (config)
	{
		...
		Grommunio.common.recipientfield.ui.RecipientHoverCardView.superclass.constructor.call(this, config);
	},
	...
	initComponent: function ()
	{
		...
		Grommunio.common.recipientfield.ui.RecipientHoverCardView.superclass.initComponent.call(this);
	},
	 ...
	 *
	 * @param {Ext.data.Store} store The store can be {@link Grommunio.common.ui.messagepanel.RecipientLinks RecipientLinks} or
	 * {@link Grommunio.common.ui.messagepanel.SentInfoLinks SentInfoLinks}.
	...
	hideButton: function(store, record)
	{
		...
		var recipients = Grommunio.common.Actions.getRecipientsByType(store, record.get('recipient_type'));
	...
	hide: function ()
	{
		...
		Grommunio.common.recipientfield.ui.RecipientHoverCardView.superclass.hide.call(this);
	 ...
	 * the {@link Grommunio.core.data.IPMRecipientRecord recipient}
	 ...
	 * @param {Grommunio.common.recipientfield.ui.RecipientHoverCardButton} item The item can be
	...
	copyEmail: function (item)
	{
		...
		Grommunio.common.Actions.copyEmailAddress(this.records, this.store, copyAll);
	},
	...
	{
		return '<span class="grommunio-presence-status ' + Grommunio.core.data.PresenceStatus.getCssClass(record.get('presence_status')) + '">' +
			' <span class="grommunio-presence-status-icon" aria-hidden="true"></span>' + Ext.util.Format.ellipsis(record.get('display_name'), 30) + '</span>';
	},
...
Ext.reg('grommunio.recipienthovercardview', Grommunio.common.recipientfield.ui.RecipientHoverCardView);
