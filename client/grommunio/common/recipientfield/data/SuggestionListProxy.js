...
/**
 * @class Grommunio.common.recipientfield.data.SuggestionListProxy
 * @extends Grommunio.core.data.MAPIProxy
 */
Grommunio.common.recipientfield.data.SuggestionListProxy = Ext.extend(Grommunio.core.data.MAPIProxy,
{
	/**
	 * @constructor
	...
	constructor: function(config)
	{
		...
		var module = Grommunio.core.ModuleNames.getModule('suggestemailaddress');
		...
		Grommunio.common.recipientfield.data.SuggestionListProxy.superclass.constructor.call(this, config);
	},
	...
	{
		return new Grommunio.common.recipientfield.data.SuggestionListResponseHandler({
			proxy: this,
			action: action,
			reader: reader,
			options: args,
