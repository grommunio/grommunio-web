...
/**
 * @class Grommunio.common.data.ActionRulesFactory
 * The factory class which holds and manages definition of Rules Actions.
 *
 * @singleton
 */
Grommunio.common.data.ActionRulesFactory = Ext.extend(Object,{

	/**
	 * Key-value map of Action Definitions as registered by
	 * {@link Grommunio.common.rules.data.RulesData#getAction}.
	 *
	 * @property
	 * @type Object
	 */
	...
	{
		config = config || {};
		this.actionDefinitions = Grommunio.common.rules.data.RulesData.getAction();

		Grommunio.common.data.ActionRulesFactory.superclass.constructor.call(this, config);
	},
	 ...
	 *
	 * @param {Grommunio.common.rules.data.ActionFlags} key The key value on how the definition is stored
...
Grommunio.common.data.AbstractRulesFactory.registerFactory(Grommunio.common.data.RulesFactoryType.ACTION, new Grommunio.common.data.ActionRulesFactory());
