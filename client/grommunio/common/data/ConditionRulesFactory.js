/*
 * #dependsFile client/grommunio/common/rules/data/RulesData.js
...
/**
 * @class Grommunio.common.data.ConditionRuleFactory
 * The factory class which holds and manages definition of Rules Condition.
 * It also has function to get Exception restriction {@link Grommunio.common.data.ConditionRuleFactory#getExceptionById}
 *
 * @singleton
 */
Grommunio.common.data.ConditionRuleFactory = Ext.extend(Object,{

	/**
	 * Key-value map of condition Definition as registered by
	 * {@link Grommunio.common.rules.data.RulesData#getConditionRestriction}.
	 *
	 * @property
	 * @type Object
	 */
	...
	{
		config = config || {};
		this.conditionDefinitions = Grommunio.common.rules.data.RulesData.getConditionRestriction();

		Grommunio.common.data.ConditionRuleFactory.superclass.constructor.call(this, config);
	},
	 ...
	 *
	 * @param {Grommunio.common.rules.data.ConditionFlags} key The key value on how the definition is stored
...
Grommunio.common.data.AbstractRulesFactory.registerFactory(Grommunio.common.data.RulesFactoryType.CONDITION, new Grommunio.common.data.ConditionRuleFactory());
