...
/**
 * @class Grommunio.common.recurrence.dialogs.DailyPanel
 * @extends Grommunio.common.recurrence.dialogs.RecurrenceSubPanel
 * @xtype grommunio.recurrencedailypanel
 *
 * The Panel used for configuring a Daily Recurrence
 */
Grommunio.common.recurrence.dialogs.DailyPanel = Ext.extend(Grommunio.common.recurrence.dialogs.RecurrenceSubPanel, {
	/**
	 * @constructor
	...
	constructor: function(config)
	{
		...
		Ext.applyIf(config, {
			xtype: 'grommunio.recurrencedailypanel',
			recurrenceType: Grommunio.common.recurrence.data.RecurrenceType.DAILY,
			recurrenceSubtypes: [
				Grommunio.common.recurrence.data.RecurrenceSubtype.DAILY_EVERY_N_DAYS,
				Grommunio.common.recurrence.data.RecurrenceSubtype.DAILY_WEEKDAYS,
				Grommunio.common.recurrence.data.RecurrenceSubtype.DAILY_REGENERATE
			],
			defaults: {
				border: false,
		...
		Grommunio.common.recurrence.dialogs.DailyPanel.superclass.constructor.call(this, config);
	},
	...
	createEveryNDaysPanel: function()
	{
		return {
			...
			items: [{
				xtype: 'radio',
				name: 'daily_pattern',
				patternValue: Grommunio.common.recurrence.data.RecurrenceSubtype.DAILY_EVERY_N_DAYS,
				hideLabel: true,
				width: 25,
				listeners: {
	...
	createEveryWeekdayPanel: function()
	{
		return {
			...
			items: [{
				xtype: 'radio',
				name: 'daily_pattern',
				patternValue: Grommunio.common.recurrence.data.RecurrenceSubtype.DAILY_WEEKDAYS,
				hideLabel: true,
				width: 25,
				listeners: {
					check: this.onSubtypeChange,
	...
	createRegeneratePanel: function()
	{
		return {
			...
			items: [{
				xtype: 'radio',
				name: 'daily_pattern',
				patternValue: Grommunio.common.recurrence.data.RecurrenceSubtype.DAILY_REGENERATE,
				hideLabel: true,
				width: 25,
				listeners: {
					check: this.onSubtypeChange,
	 ...
	 * {@link Grommunio.common.recurrence.data.RecurrenceSubtype#DAILY_EVERY_N_DAYS} recurrence type has been changed.
	...
	{
		this.onSubtypePropertyChange(Grommunio.common.recurrence.data.RecurrenceSubtype.DAILY_EVERY_N_DAYS, field, value * (24 * 60));
	},

	/**
	 * Event handler which is fired when one of the components belonging to the
	 * {@link Grommunio.common.recurrence.data.RecurrenceSubtype#DAILY_REGENERATE} recurrence type has been changed.
	 * This will call {@link #onSubtypePropertyChange}.
	 * @param {Ext.form.Field} field The field which was changed
	 * @param {Mixed} value The new value of the field
	 * @private
	...
	{
		this.onSubtypePropertyChange(Grommunio.common.recurrence.data.RecurrenceSubtype.DAILY_REGENERATE, field, value * (24 * 60));
	},
...
Ext.reg('grommunio.recurrencedailypanel', Grommunio.common.recurrence.dialogs.DailyPanel);
