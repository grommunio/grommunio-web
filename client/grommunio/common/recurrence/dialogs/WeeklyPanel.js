...
/**
 * @class Grommunio.common.recurrence.dialogs.WeeklyPanel
 * @extends Grommunio.common.recurrence.dialogs.RecurrenceSubPanel
 * @xtype grommunio.recurrenceweeklypanel
 *
 * The Panel used for configuring a Weekly Recurrence
 */
Grommunio.common.recurrence.dialogs.WeeklyPanel = Ext.extend(Grommunio.common.recurrence.dialogs.RecurrenceSubPanel, {
	/**
	 * @constructor
	...
	constructor: function(config)
	{
		...
		Ext.applyIf(config, {
			xtype: 'grommunio.recurrenceweeklypanel',
			recurrenceType: Grommunio.common.recurrence.data.RecurrenceType.WEEKLY,
			recurrenceSubtypes: [
				Grommunio.common.recurrence.data.RecurrenceSubtype.WEEKLY_REGENERATE,
				Grommunio.common.recurrence.data.RecurrenceSubtype.WEEKLY
			],
			defaults: {
				border: false,
		...
		Grommunio.common.recurrence.dialogs.WeeklyPanel.superclass.constructor.call(this, config);
	},
	...
	createEveryNWeeksPanel: function()
	{
		return {
			...
			items: [{
				xtype: 'radio',
				name: 'weekly_pattern',
				patternValue: Grommunio.common.recurrence.data.RecurrenceSubtype.WEEKLY,
				hideLabel: true,
				width: 25,
				listeners: {
	...
	createRegeneratePanel: function()
	{
		return {
			...
			items: [{
				xtype: 'radio',
				name: 'weekly_pattern',
				patternValue: Grommunio.common.recurrence.data.RecurrenceSubtype.WEEKLY_REGENERATE,
				hideLabel: true,
				width: 25,
				listeners: {
					check: this.onSubtypeChange,
	 ...
	 * {@link Grommunio.common.recurrence.data.RecurrenceSubtype#WEEKLY} recurrence type has been changed.
	...
	{
		this.onSubtypePropertyChange(Grommunio.common.recurrence.data.RecurrenceSubtype.WEEKLY, field, value);
	},
	...
	onWeeklyDayChange: function(field, value)
	{
		...
		this.onSubtypePropertyChange(Grommunio.common.recurrence.data.RecurrenceSubtype.WEEKLY, field, oldValue);
	},

	/**
	 * Event handler which is fired when one of the components belonging to the
	 * {@link Grommunio.common.recurrence.data.RecurrenceSubtype#WEEKLY_REGENERATE} recurrence type has been changed.
	 * This will call {@link #onSubtypePropertyChange}.
	 * @param {Ext.form.Field} field The field which was changed
	 * @param {Mixed} value The new value of the field
	 * @private
	...
	{
		this.onSubtypePropertyChange(Grommunio.common.recurrence.data.RecurrenceSubtype.WEEKLY_REGENERATE, field, value * (7 * 24 * 60));
	},
...
Ext.reg('grommunio.recurrenceweeklypanel', Grommunio.common.recurrence.dialogs.WeeklyPanel);
