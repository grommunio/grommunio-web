Ext.namespace('Grommunio.common.recurrence.dialogs');

/**
 * @class Grommunio.common.recurrence.dialogs.YearlyPanel
 * @extends Grommunio.common.recurrence.dialogs.RecurrenceSubPanel
 * @xtype grommunio.recurrenceyearlypanel
 *
 * The Panel used for configuring a Yearly Recurrence
 */
Grommunio.common.recurrence.dialogs.YearlyPanel = Ext.extend(Grommunio.common.recurrence.dialogs.RecurrenceSubPanel, {
	/**
	 * @constructor
	...
	constructor: function(config)
	{
		...
		Ext.applyIf(config, {
			xtype: 'grommunio.recurrenceyearlypanel',
			recurrenceType: Grommunio.common.recurrence.data.RecurrenceType.YEARLY,
			recurrenceSubtypes: [
				Grommunio.common.recurrence.data.RecurrenceSubtype.YEARLY_MONTH,
				Grommunio.common.recurrence.data.RecurrenceSubtype.YEARLY_N_WEEKDAY,
				Grommunio.common.recurrence.data.RecurrenceSubtype.YEARLY_REGENERATE
			],
			defaults: {
				border: false,
		...
		Grommunio.common.recurrence.dialogs.YearlyPanel.superclass.constructor.call(this, config);
	},
	...
	createEveryNWeekdayPanel: function()
	{
		return {
			...
			items: [{
				xtype: 'radio',
				name: 'yearly_pattern',
				patternValue: Grommunio.common.recurrence.data.RecurrenceSubtype.YEARLY_MONTH,
				hideLabel: true,
				width: 25,
				listeners: {
				...
				items: [{
					...
					store: {
						xtype: 'jsonstore',
						fields: ['name', 'value'],
						data: Grommunio.common.recurrence.data.MonthData
					},
					mode: 'local',
					triggerAction: 'all',
					displayField: 'name',
	...
	createEveryMonthPanel: function()
	{
		return {
			...
			items: [{
				xtype: 'radio',
				name: 'yearly_pattern',
				patternValue: Grommunio.common.recurrence.data.RecurrenceSubtype.YEARLY_N_WEEKDAY,
				hideLabel: true,
				width: 25,
				listeners: {
					change: this.onSubtypeChange,
				...
				items: [{
					...
					store: {
						xtype: 'jsonstore',
						fields: ['name', 'value'],
						data: Grommunio.common.recurrence.data.DayRankData
					},
					mode: 'local',
					triggerAction: 'all',
					displayField: 'name',
					...
					store: {
						xtype: 'jsonstore',
						fields: ['name', 'value'],
						data: Grommunio.common.recurrence.data.DayData
					},
					mode: 'local',
					triggerAction: 'all',
					displayField: 'name',
	...
	createRegeneratePanel: function()
	{
		return {
			...
			items: [{
				xtype: 'radio',
				name: 'yearly_pattern',
				patternValue: Grommunio.common.recurrence.data.RecurrenceSubtype.YEARLY_REGENERATE,
				hideLabel: true,
				width: 25,
				listeners: {
					change: this.onSubtypeChange,
	 ...
	 * {@link Grommunio.common.recurrence.data.RecurrenceSubtype#YEARLY_N} recurrence type has been changed.
	...
	/**
	 * Event handler which is fired when one of the components belonging to the
	 * {@link Grommunio.common.recurrence.data.RecurrenceSubtype#YEARLY_MONTH} recurrence type has been changed.
	 * This will call {@link #onSubtypePropertyChange}.
	 * @param {Ext.form.Field} field The field which was changed
	 * @param {Mixed} value The new value of the field
	 * @private
	...
	{
		this.onSubtypePropertyChange(Grommunio.common.recurrence.data.RecurrenceSubtype.YEARLY_MONTH, field, value);
	},

	/**
	 * Event handler which is fired when one of the components belonging to the
	 * {@link Grommunio.common.recurrence.data.RecurrenceSubtype#YEARLY_N_WEEKDAY} recurrence type has been changed.
	 * This will call {@link #onSubtypePropertyChange}.
	 * @param {Ext.form.Field} field The field which was changed
	 * @param {Mixed} value The new value of the field
	 * @private
	...
	{
		this.onSubtypePropertyChange(Grommunio.common.recurrence.data.RecurrenceSubtype.YEARLY_N_WEEKDAY, field, value);
	},

	/**
	 * Event handler which is fired when one of the components belonging to the
	 * {@link Grommunio.common.recurrence.data.RecurrenceSubtype#YEARLY_REGENERATE} recurrence type has been changed.
	 * This will call {@link #onSubtypePropertyChange}.
	 * @param {Ext.form.Field} field The field which was changed
	 * @param {Mixed} value The new value of the field
	 * @private
	...
	{
		this.onSubtypePropertyChange(Grommunio.common.recurrence.data.RecurrenceSubtype.YEARLY_REGENERATE, field, value);
	},
	 ...
	 *
	 * @param {Grommunio.core.data.IPMRecord} record The record which is loaded in this panel
	 ...
	 * {@link Grommunio.common.recurrence.data.RecurrenceSubtype subtype}.
	 * @param {Grommunio.core.data.MAPIRecord} record The record from where the values must be read
	 * @param {Grommunio.common.recurrence.data.RecurrenceSubtype} subtype The subtype for which the UI
	 ...
	 * given {@link Grommunio.common.recurrence.data.RecurrenceSubtype recurrence subtype}. The record
	 * itself is already in {@link Grommunio.core.data.MAPIRecord#editing editing} mode.
	 * @param {Grommunio.core.data.MAPIRecord} record The record which must be updated from the UI
	 * @param {Grommunio.common.recurrence.data.RecurrenceSubtype} pattern The Subtype which is
...
Ext.reg('grommunio.recurrenceyearlypanel', Grommunio.common.recurrence.dialogs.YearlyPanel);
