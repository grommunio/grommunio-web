...
/**
 * @class Grommunio.common.recurrence.dialogs.MonthlyPanel
 * @extends Grommunio.common.recurrence.dialogs.RecurrenceSubPanel
 * @xtype grommunio.recurrencemonthlypanel
 *
 * The Panel used for configuring a Monthly Recurrence
 */
Grommunio.common.recurrence.dialogs.MonthlyPanel = Ext.extend(Grommunio.common.recurrence.dialogs.RecurrenceSubPanel, {
	/**
	 * @constructor
	...
	constructor: function(config)
	{
		...
		Ext.applyIf(config, {
			xtype: 'grommunio.recurrencemonthlypanel',
			recurrenceType: Grommunio.common.recurrence.data.RecurrenceType.MONTHLY,
			recurrenceSubtypes: [
				Grommunio.common.recurrence.data.RecurrenceSubtype.MONTHLY_N_DAY_OF_MONTH,
				Grommunio.common.recurrence.data.RecurrenceSubtype.MONTHLY_N_WEEKDAY_OF_MONTH,
				Grommunio.common.recurrence.data.RecurrenceSubtype.MONTHLY_REGENERATE
			],
			defaults: {
				border: false,
		...
		Grommunio.common.recurrence.dialogs.MonthlyPanel.superclass.constructor.call(this, config);
	},
	...
	createEveryNDayOfMonthPanel: function()
	{
		return {
			...
			items: [{
				...
				patternValue: Grommunio.common.recurrence.data.RecurrenceSubtype.MONTHLY_N_DAY_OF_MONTH,
				hideLabel: true,
				width: 25,
				listeners: {
	...
	createEveryNWeekDayOfMonthPanel: function()
	{
		return {
			...
			items: [{
				xtype: 'radio',
				name: 'monthly_pattern',
				patternValue: Grommunio.common.recurrence.data.RecurrenceSubtype.MONTHLY_N_WEEKDAY_OF_MONTH,
				hideLabel: true,
				width: 25,
				listeners: {
					check: this.onSubtypeChange,
	...
	createRegeneratePanel: function()
	{
		return {
			...
			items: [{
				xtype: 'radio',
				name: 'monthly_pattern',
				patternValue: Grommunio.common.recurrence.data.RecurrenceSubtype.MONTHLY_REGENERATE,
				hideLabel: true,
				width: 25,
				listeners: {
					check: this.onSubtypeChange,
	 ...
	 * {@link Grommunio.common.recurrence.data.RecurrenceSubtype#MONTHLY_N_DAY_OF_MONTH} recurrence type has been changed.
	...
	{
		this.onSubtypePropertyChange(Grommunio.common.recurrence.data.RecurrenceSubtype.MONTHLY_N_DAY_OF_MONTH, field, value);
	},

	/**
	 * Event handler which is fired when one of the components belonging to the
	 * {@link Grommunio.common.recurrence.data.RecurrenceSubtype#MONTHLY_N_WEEKDAY_OF_MONTH} recurrence type has been changed.
	 * This will call {@link #onSubtypePropertyChange}.
	 * @param {Ext.form.Field} field The field which was changed
	 * @param {Mixed} value The new value of the field
	 * @private
	...
	{
		this.onSubtypePropertyChange(Grommunio.common.recurrence.data.RecurrenceSubtype.MONTHLY_N_WEEKDAY_OF_MONTH, field, value);
	},

	/**
	 * Event handler which is fired when one of the components belonging to the
	 * {@link Grommunio.common.recurrence.data.RecurrenceSubtype#MONTHLY_REGENERATE} recurrence type has been changed.
	 * This will call {@link #onSubtypePropertyChange}.
	 * @param {Ext.form.Field} field The field which was changed
	 * @param {Mixed} value The new value of the field
	 * @private
	...
	{
		this.onSubtypePropertyChange(Grommunio.common.recurrence.data.RecurrenceSubtype.MONTHLY_REGENERATE, field, value);
	},
...
Ext.reg('grommunio.recurrencemonthlypanel', Grommunio.common.recurrence.dialogs.MonthlyPanel);
