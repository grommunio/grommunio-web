...
/**
 * @class Grommunio.common.recurrence.dialogs.RecurrenceSubPanel
 * @extends Ext.Panel
 * @xtype grommunio.recurrencesubpanel
 *
 * The Panel used for configuring the {@link Grommunio.common.recurrence.data.RecurrenceSubtype subtypes}.
 * This class should be inherited by the different {@link Grommunio.common.recurrence.data.RecurrenceType types}.
 */
Grommunio.common.recurrence.dialogs.RecurrenceSubPanel = Ext.extend(Ext.Panel, {
	/**
	 * The record on which this panel is operating. This s provided in {@link #update} by
	 * the {@link Grommunio.core.plugins.RecordComponentUpdaterPlugin Record ComponentUpdater plugin}.
	 * @property
	...
	/**
	 * @cfg {Grommunio.common.recurrence.data.RecurrenceType} recurrenceType The recurrence type on
	 * which is panel is operating.
	 */
	recurrenceType: undefined,

	/**
	 * @cfg {Grommunio.common.recurrence.data.RecurrenceSubtype|Array} recurrenceSubtypes The possible
	...
	constructor: function(config)
	{
		...
		Grommunio.common.recurrence.dialogs.RecurrenceSubPanel.superclass.constructor.call(this, config);
	},

	/**
	 * Compare 2 {@link Grommunio.common.recurrence.data.RecurrenceSubtype} instances to see if they are equal
	 * @param {Grommunio.common.recurrence.data.RecurrenceSubtype} left The first object to compare to
	 * @param {Grommunio.common.recurrence.data.RecurrenceSubtype} right The second object to compare to
	 * @return {Boolean} True when the two {@link Grommunio.common.recurrence.data.RecurrenceSubtype subtype}
	 * objects are equal
	 * @protected
	 */
	...
	/**
	 * Compare if the given {@link Grommunio.core.data.MAPIRecord} has a subtype configured which matches the given
	 * {@link Grommunio.common.recurrence.data.RecurrenceSubtype subtype}.
	 * @param {Grommunio.core.data.MAPIRecord} record The record to compare to
	 * @param {Grommunio.common.recurrence.data.RecurrenceSubtype} pattern the Subtype pattern to compare with
	 ...
	 * @param {Grommunio.common.recurrence.data.RecurrenceSubtype} pattern The subtype pattern to which
	 ...
	 * using the given {@link Grommunio.core.data.MAPIRecord record}.
	 * @param {Grommunio.core.data.MAPIRecord} record The record to update the panel with
	 ...
	 * the data from the {@link Grommunio.core.data.MAPIRecord record}.
	 *
	 * @param {Grommunio.core.data.MAPIRecord} record The record used to update the panel
	 * @param {Boolean} contentReset force the component to perform a full update of the data.
	 */
...
Ext.reg('grommunio.recurrencesubpanel', Grommunio.common.recurrence.dialogs.RecurrenceSubPanel);
