...
/**
 * @class Grommunio.common.sendas.ui.SendAsPanel
 * @extends Ext.Panel
 * @xtype grommunio.sendaspanel
 * Will generate UI for the {@link Grommunio.common.settings.SettingsSendAsWidget SettingsSendAsWidget}.
 */
Grommunio.common.sendas.ui.SendAsPanel = Ext.extend(Ext.Panel, {
	/**
	 * @constructor
	...
	constructor: function(config)
	{
		...
		Grommunio.common.sendas.ui.SendAsPanel.superclass.constructor.call(this, config);
	},

	/**
	 * Function will create panel items for {@link Grommunio.common.sendas.ui.SendAsPanel SendAsPanel}
	...
	initEvents: function()
	{
		Grommunio.common.sendas.ui.SendAsPanel.superclass.initEvents.call(this);
	...
	onSendAsAdd: function()
	{
		...
		var record = Grommunio.core.data.RecordFactory.createRecordObjectByCustomType(Grommunio.core.data.RecordCustomObjectType.GROMMUNIO_FROM_RECIPIENT, {
			// rowid is the {@link Ext.data.JsonReader#idProperty} in {@link Grommunio.core.data.IPMRecipientStore IPMRecipientStore}
	...
	/**
	 * Event handler will be called when selection in {@link Grommunio.common.ui.SendAsGrid SendAsGrid}
	 * has been changed.
	...
	/**
	 * Function will be call to get the selected contact from {@link Grommunio.common.ui.SendAsGrid SendAsGrid}
	 * @return {Ext.data.Record} The record which is selected from {@link Grommunio.common.ui.SendAsGrid SendAsGrid}.
	 * @private
	 */
...
Ext.reg('grommunio.sendaspanel', Grommunio.common.sendas.ui.SendAsPanel);
