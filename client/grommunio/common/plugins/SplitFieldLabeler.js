...
/**
 * @class Grommunio.common.plugins.splitFieldLabeler
 * @extends Ext.util.Observable
 * @ptype grommunio.splitfieldlabeler
 *
 * This plugin functions similarly as the {@link Grommunio.common.plugins.FieldLabeler FieldLabeler}.
 ...
 * Each component should have the {@link Grommunio.common.plugins.FieldLabeler.labelSplitter labelSplitter}
 ...
 */
Grommunio.common.plugins.SplitFieldLabeler = Ext.extend(Ext.util.Observable, {
	/**
	...
	createLabelDistribution: function(items, label)
	{
		...
		return Grommunio.util.Translations.MultiSplitTranslation(label, splitters);
	},
...
Ext.preg('grommunio.splitfieldlabeler', Grommunio.common.plugins.SplitFieldLabeler);
