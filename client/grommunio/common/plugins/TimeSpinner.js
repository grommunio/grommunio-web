...
/**
 * @class Grommunio.common.plugins.TimeSpinner
 * @extends Grommunio.common.plugins.SpinnerPlugin
 * @ptype grommunio.timespinner
 * Extension to the {@link Grommunio.common.plugins.SpinnerPlugin} object,
 * to correctly parse times. This is used by the
 * {@link Grommunio.common.ui.SpinnerField SpinnerField}
 */
Grommunio.common.plugins.TimeSpinner = Ext.extend(Grommunio.common.plugins.SpinnerPlugin, {
	/**
	 * @cfg {String} format The string format which is applied for
	 * displaying the time in the {@link Grommunio.common.ui.SpinnerField SpinnerField}.
	 */
	format: _('G:i'),
	/**
	...
	constructor: function(config)
	{
		...
		Grommunio.common.plugins.TimeSpinner.superclass.constructor.call(this, config);
	},
	...
	init: function(field)
	{
		Grommunio.common.plugins.TimeSpinner.superclass.init.call(this, field);
	 ...
	 * {@link Grommunio.common.ui.SpinnerField SpinnerField} must be changed.
	 *
...
Ext.preg('grommunio.timespinner', Grommunio.common.plugins.TimeSpinner);
