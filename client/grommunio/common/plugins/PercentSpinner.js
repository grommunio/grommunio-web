...
/**
 * @class Grommunio.common.plugins.PercentSpinner
 * @extends Grommunio.common.plugins.NumberSpinner
 * @ptype grommunio.percentspinner
 *
 * Extension to the {@link Grommunio.common.plugins.NumberSpinner} object,
 * to correctly parse percentages. This is used by the {@link Grommunio.common.ui.SpinnerField SpinnerField}.
 *
 * We inherit from the {@link Grommunio.common.plugins.NumberSpinner} class because
 * percentages are represented as Floats, and only our raw DOM value is a string
 * where the % sign is postfixed.
 */
Grommunio.common.plugins.PercentSpinner = Ext.extend(Grommunio.common.plugins.NumberSpinner, {
	/**
	 * @constructor
	...
	constructor: function(config)
	{
		...
		Grommunio.common.plugins.PercentSpinner.superclass.constructor.call(this, config);
	},

	/**
	 * Initializes the {@link Grommunio.common.ui.SpinnerField SpinnerField} to which
	 * this plugin has been hooked.
	 * @param {Grommunio.common.ui.SpinnerField} The parent field to which this component is connected
	 */
	init: function(field)
	{
		...
		Grommunio.common.plugins.PercentSpinner.superclass.init.call(this, field);
	},
	...
	setValue: function(value)
	{
		...
		Grommunio.common.plugins.PercentSpinner.superclass.setValue.call(this, value);
	}
});

// Register as plugin, so that it can be used using lazy loading
// with the Grommunio.common.ui.SpinnerField
Ext.preg('grommunio.percentspinner', Grommunio.common.plugins.PercentSpinner);
