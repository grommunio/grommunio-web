...
/**
 * @class Grommunio.common.plugins.NumberSpinner
 * @extends Grommunio.common.plugins.SpinnerPlugin
 * @ptype grommunio.numberspinner
 * Extension to the {@link Grommunio.common.plugins.SpinnerPlugin Spinner} object,
 * to correctly parse numbers This is used by the
 * {@link Grommunio.common.ui.SpinnerField SpinnerField}
 */
Grommunio.common.plugins.NumberSpinner = Ext.extend(Grommunio.common.plugins.SpinnerPlugin, {
	/**
	...
	constructor: function(config)
	{
		...
		Grommunio.common.plugins.NumberSpinner.superclass.constructor.call(this, config);
	},
	...
	init: function(field)
	{
		Grommunio.common.plugins.NumberSpinner.superclass.init.call(this, field);
...
Ext.preg('grommunio.numberspinner', Grommunio.common.plugins.NumberSpinner);
