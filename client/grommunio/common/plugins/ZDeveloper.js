...
/**
 * @class Grommunio.common.plugins.ZDeveloperPlugin
 * @extends Grommunio.core.Plugin
 *
 * Shows possible insertion points inside application.
 */
Grommunio.common.plugins.ZDeveloperPlugin = Ext.extend(Grommunio.core.Plugin, {
	...
	initPlugin: function()
	{
		Grommunio.common.plugins.ZDeveloperPlugin.superclass.initPlugin.apply(this, arguments);

		var isAdvancedSettingsEnabled = container.getServerConfig().isAdvancedSettingsEnabled();
		if (container.getSettingsModel().get("grommunio/v1/main/kdeveloper_tool/kdeveloper") === true && isAdvancedSettingsEnabled === true)  {
		...
		if (container.getSettingsModel().get('grommunio/v1/main/kdeveloper_tool/itemdata') === true && isAdvancedSettingsEnabled === true) {
...
Grommunio.onReady(function() {
	container.registerPlugin(new Grommunio.core.PluginMetaData({
		...
		pluginConstructor: Grommunio.common.plugins.ZDeveloperPlugin
	}));
});
