...
/**
 * @class Grommunio.common.searchfield.ui.SearchDropdownPanel
 * @extends Ext.Panel
 *
 ...
 */
Grommunio.common.searchfield.ui.SearchDropdownPanel = Ext.extend(Ext.Panel, {

	/**
	 * @cfg {Grommunio.common.searchfield.ui.SearchTextField} searchTextField
	 * The parent search text field that owns this dropdown.
	 */
	searchTextField: undefined,

	/**
	 * @cfg {Grommunio.common.searchfield.ui.SearchFolderCombo} searchFolderCombo
	...
	{
		var labels = Grommunio.advancesearch.KQLParser.getKeywordLabels();
	...
	constructor: function(config)
	{
		...
		Grommunio.common.searchfield.ui.SearchDropdownPanel.superclass.constructor.call(this, config);
	},
	...
	{
		Grommunio.common.searchfield.ui.SearchDropdownPanel.superclass.onRender.call(this, ct, position);
	...
	beforeDestroy: function()
	{
		...
		Grommunio.common.searchfield.ui.SearchDropdownPanel.superclass.beforeDestroy.call(this);
	}
});
