...
/**
 * @class Grommunio.common.attachment.ui.AttachmentDownloader
 * @extends Ext.Component
 * @xtype grommunio.attachmentdownloader
 *
 ...
 */
Grommunio.common.attachment.ui.AttachmentDownloader = Ext.extend(Ext.Component, {
	/**
	 * @constructor
	...
	constructor: function(config)
	{
		...
		Grommunio.common.attachment.ui.AttachmentDownloader.superclass.constructor.call(this, config);
	 ...
	 *
	 * @param {Grommunio.core.data.IPMRecord} records The records which user want to save in eml format as ZIP.
	 */
	...
	checkForEmbeddedAttachments: function(record, allAsZip)
	{
		...
		if(allAsZip) {
			...
			var dontShowWarning = container.getSettingsModel().get('grommunio/v1/state/dialogs/mixattachitemcontentpanel/dontshowagain');
	...
	/**
	 * Opens a {@link Grommunio.common.attachment.dialogs.MixAttachItemContentPanel MixAttachItemContentPanel} for informing
	 * user that there is some embedded attachments are requested to be included in ZIP, which is not possible.
	 *
	 * @param {Grommunio.core.data.IPMRecord} records The record, or records for which the attachments are
	...
	openMixAttachmentsDialog: function(records, config)
	{
		...
		var componentType = Grommunio.core.data.SharedComponentType['common.attachment.dialog.mixattachitem'];
	...
	displaySaveEmailException: function(responseObject)
	{
		Ext.MessageBox.show({
			...
			msg: responseObject.grommunio.error.info.display_message,
			cls: Ext.MessageBox.ERROR_CLS,
			buttons: Ext.MessageBox.OK
		});
	}
});
Ext.reg('grommunio.attachmentdownloader', Grommunio.common.attachment.ui.AttachmentDownloader);
