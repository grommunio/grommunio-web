...
/**
 * @class Grommunio.common.attachment.ui.UploadAttachmentComponent
 * @extends Ext.Component
 * @xtype grommunio.uploadattachmentcomponent
 */
Grommunio.common.attachment.ui.UploadAttachmentComponent = Ext.extend(Ext.Component, {
	/**
	...
	constructor: function(config)
	{
		...
		Grommunio.common.attachment.ui.UploadAttachmentComponent.superclass.constructor.call(this, config);
	},
	...
	{
		var attachmentInputId = Ext.id(null, 'grommunio-attachment-input-');
...
Ext.reg('grommunio.uploadattachmentcomponent', Grommunio.common.attachment.ui.AttachmentButton);
