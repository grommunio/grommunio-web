...
/**
 * @class Grommunio.common.attachment.dialogs.AttachItemBaseRenderer
 * @extends Object
 *
 * Base renderer that can be used to extend and create different renderers for different type of messages.
 */
Grommunio.common.attachment.dialogs.AttachItemBaseRenderer = Ext.extend(Object, {
	/**
	 ...
	 * @param {Grommunio.core.data.IPMRecord} record record that will be used to get data and generate template based on that data.
	...
	prepareData: function(record, htmlFormat)
	{
		...
		if (data['sensitivity'] === Grommunio.core.mapi.Sensitivity.NONE) {
			delete data['sensitivity'];
		}

		if (data['importance'] === Grommunio.core.mapi.Importance.NORMAL) {
