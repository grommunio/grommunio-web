...
/**
 * @class Grommunio.common.attachment.dialogs.AttachItemPanel
 * @extends Ext.Panel
 * @xtype grommunio.attachitempanel
 */
Grommunio.common.attachment.dialogs.AttachItemPanel = Ext.extend(Ext.Panel, {
	/**
	...
	constructor: function(config)
	{
		...
		Grommunio.common.attachment.dialogs.AttachItemPanel.superclass.constructor.call(this, config);
	},
	...
	initEvents: function()
	{
		Grommunio.common.attachment.dialogs.AttachItemPanel.superclass.initEvents.apply(this, arguments);
	...
	/**
	 * Function will call {@link Grommunio.common.attachment.dialogs.AttachItemGrid#attachItem}.
	 * @private
	 */
	onOK: function()
	{
	...
	/**
	 * Handler will called when user presses the cancel button, this will simply close the {@link Grommunio.common.attachment.AttachItemContentPanel AttachItemContentPanel}
	 * @private
	 */
	onCancel: function()
	{
	...
	/**
	 * Fired when a node is selected in {@link Grommunio.hierarchy.ui.Tree}. It loads items of the folder in grid.
	 * @param {Ext.tree.DefaultSelectionModel} selectionModel selection model that is used in {@link Grommunio.hierarchy.ui.Tree HierarchyTree}
	 ...
	 * @param {Grommunio.core.data.IPMRecord} record record that is selected in grid and which should be added as attachment.
	 * @private
	 */
	 ...
	 * @param {Grommunio.core.data.IPMRecord} record record that is selected in grid and which should be added as text.
	 * @private
	 */
	...
	/**
	 * Function will send an 'open' request to server to get all data of the passed {@link Grommunio.core.data.IPMRecord IPMRecord}.
	 * After record is opened function will call function specified in callback parameter.
	 * @param {Grommunio.core.data.IPMRecord} record record which needs to be opened to get all data.
...
Ext.reg('grommunio.attachitempanel', Grommunio.common.attachment.dialogs.AttachItemPanel);
