...
/**
 * @class Grommunio.common.reminder.dialogs.ReminderPanel
 * @extends Ext.Panel
 * @xtype grommunio.reminderpanel
 */
Grommunio.common.reminder.dialogs.ReminderPanel = Ext.extend(Ext.Panel, {
	/**
	 ...
	 * must be applied to the {@link Grommunio.common.reminder.dialogs.ReminderPanel #activeReminder} to build selected reminder info when the
	 * {@link Grommunio.common.reminder.data.ReminderRecord record} has been {@link #update updated}.
	 * The arguments of this template will be the {@link Grommunio.common.reminder.data.ReminderRecord#data record.data} field.
	 */
	activeReminderTemplate:
		'<tpl>' +
			'<div>'+
				'<span class="grommunio-reminder-dialog-active-reminder-icon {[Grommunio.common.ui.IconClass.getIconClass(values.record)]}"></span>'+
				'<span class="grommunio-reminder-dialog-active-reminder-subject">' +
			...
			'<div>'+
				'<span>' +
					...
					'<tpl if="Grommunio.core.ContainerClass.isClass(values.message_class, &quot;IPM.Task&quot;, true)">' +
	...
	constructor: function(config)
	{
		...
		Grommunio.common.reminder.dialogs.ReminderPanel.superclass.constructor.call(this, config);
	...
	activeReminderPanel: function()
	{
		return {
			xtype: 'panel',
			cls:'grommunio-reminder-dialog-active-reminder',
			layout: 'fit',
			ref: 'activeReminder',
			height: 52
		};
	...
	/**
	 * Create the {@link Grommunio.common.reminder.dialogs.ReminderGrid ReminderGrid} object.
	 * @param {Grommunio.common.reminder.ReminderStore} store reminder store.
	...
	reminderSnooze: function()
	{
		var reminderStore = {
			...
			data: Grommunio.calendar.data.ReminderPeriods.slice(1)
		};

		return{
			xtype: 'panel',
			cls: 'grommunio-reminder-dialog-snooze',
			layout: {
				type: 'vbox',
				align: 'stretch',
				pack: 'start'
			...
			items:[{
				...
				items: [{
					...
					displayField: 'name',
					valueField: 'value',
					value: container.getSettingsModel().get('grommunio/v1/main/reminder/default_snooze_time'),
					lazyInit: false,
					forceSelection: true,
					editable: false
				},{
	...
	/**
	 * initialize events for the {@link Grommunio.common.reminder.dialogs.ReminderPanel ReminderPanel}
	 * @private
	 */
	initEvents: function()
	{
		Grommunio.common.reminder.dialogs.ReminderPanel.superclass.initEvents.call(this);
	...
	/**
	 * Event handler which is fired when the {@link Grommunio.common.reminder.dialogs.ReminderGrid ReminderGrid}
	...
	/**
	 * Event handler which is triggered when the {@link Grommunio.common.reminder.dialogs.ReminderGrid ReminderGrid}
	 * {@link Grommunio.core.data.IPMRecord record} selection is changed. This will inform
	 * the {@link Grommunio.common.reminder.dialogs.ReminderPanel} about the change.
	 *
	...
	/**
	 * Event handler which is triggered when the {@link Grommunio.common.reminder.dialogs.ReminderGrid grid}
	 * {@link Grommunio.core.data.IPMRecord record} selection is changed.
	 *
...
Ext.reg('grommunio.reminderpanel', Grommunio.common.reminder.dialogs.ReminderPanel);
