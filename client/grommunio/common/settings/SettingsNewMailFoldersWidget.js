...
/**
 * @class Grommunio.common.settings.SettingsNewMailFoldersWidget
 * @extends Grommunio.settings.ui.SettingsWidget
 * @xtype grommunio.settingsnewmailfolderswidget
 *
 * The {@link Grommunio.settings.ui.SettingsWidget widget} which restricts the new mail
 * notification to a selection of folders.
 */
Grommunio.common.settings.SettingsNewMailFoldersWidget = Ext.extend(Grommunio.settings.ui.SettingsWidget, {
	/**
	 * @cfg {String} scopeSetting The setting which holds the folder scope.
	 */
	scopeSetting: 'grommunio/v1/main/notifier/info/newmail/folders/scope',

	/**
	 * @cfg {String} selectedSetting The setting which holds the selected folders.
	 */
	selectedSetting: 'grommunio/v1/main/notifier/info/newmail/folders/selected',
	...
	constructor: function(config)
	{
		...
		Grommunio.common.settings.SettingsNewMailFoldersWidget.superclass.constructor.call(this, config);
	},
...
Ext.reg('grommunio.settingsnewmailfolderswidget', Grommunio.common.settings.SettingsNewMailFoldersWidget);
