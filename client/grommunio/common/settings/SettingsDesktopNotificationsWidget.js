...
/**
 * @class Grommunio.common.settings.SettingsDesktopNotificationsWidget
 ...
 * in the {@link Grommunio.common.settings.SettingsDesktopNotificationsCategory SettingsDesktopNotificationsCategory}.
 */
Grommunio.common.settings.SettingsDesktopNotificationsWidget = Ext.extend(Grommunio.settings.ui.SettingsWidget, {
	...
	constructor: function(config)
	{
		...
		Grommunio.common.settings.SettingsDesktopNotificationsWidget.superclass.constructor.call(this, config);
	},
		...
		return [{
			...
			items: [{
				...
				items: [{
					xtype: 'checkbox',
					labelSplitter: '{A}',
					name: 'grommunio/v1/main/desktop_notification/autohide_enable',
					pluginSettingName: 'grommunio/v1/plugins/desktopnotifications/autohide_enable',
					ref: '../../autoHideBox',
					boxLabel: '',
					hideLabel: true,
					checked: true,
					...
					name: 'grommunio/v1/main/desktop_notification/autohide_time',
					pluginSettingName: 'grommunio/v1/plugins/desktopnotifications/autohide_time',
				...
				pluginSettingName: 'grommunio/v1/plugins/desktopnotifications/disable_sound',
				ref: '../disableSound',
				listeners: {
					change: this.onFieldChange,
					scope: this
	...
	{
		Grommunio.common.Actions.authorize(function(perm) {
			if (perm === 'granted') {
				// update ui
	...
	update: function(settingsModel)
	{
		...
		var hasPermission = Grommunio.common.Actions.hasPermission();
		...
		this.pluginSettingsApplied = settingsModel.get('grommunio/v1/plugins/desktopnotifications/enable') === true;
	...
	updateSettings: function(settingsModel)
	{
		...
		if (this.pluginSettingsApplied) {
			settingsModel.remove('grommunio/v1/plugins/desktopnotifications', {type: 'deprecated'});
...
Ext.reg('grommunio.settingsdesktopnotificationswidget', Grommunio.common.settings.SettingsDesktopNotificationsWidget);
