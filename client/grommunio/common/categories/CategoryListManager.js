/*
 * #dependsFile client/grommunio/common/categories/data/CategoriesStore.js
 * #dependsFile client/grommunio/core/data/AbstractResponseHandler.js
 */
Ext.namespace('Grommunio.common.categories');

/**
 * @class Grommunio.common.categories.CategoryListManagerClass
 ...
 * {@link Grommunio.common.categories.data.CategoriesStore} per store entryid,
 * populated from the server, and fires {@link #load} when a store's list
 * arrives so views can refresh.
 *
 * @singleton (instantiated below as Grommunio.common.categories.CategoryListManager)
 */
Grommunio.common.categories.CategoryListManagerClass = Ext.extend(Ext.util.Observable, {
	/**
	...
	constructor: function()
	{
		...
		this.addEvents(
			 ...
			 * @param {Grommunio.common.categories.CategoryListManagerClass} manager
			 * @param {String} storeEntryId The (lower-cased) store entryid
			 * @param {Grommunio.common.categories.data.CategoriesStore} categoriesStore
			 */
			'load'
		);

		Grommunio.common.categories.CategoryListManagerClass.superclass.constructor.call(this);
	},
	 ...
	 * @param {String} storeEntryId
	 * @return {Grommunio.common.categories.data.CategoriesStore|undefined}
	 */
	 ...
	 * {@link Grommunio.common.categories.data.CategoriesStore} and fire
	 * {@link #load}.
	...
	onListResponse: function(response, requestedId)
	{
		...
		var categoriesStore = exists ? new Grommunio.common.categories.data.CategoriesStore({
...
/**
 * @class Grommunio.common.categories.CategoryListManager
 * The singleton instance of {@link Grommunio.common.categories.CategoryListManagerClass}.
 * @singleton
 */
Grommunio.common.categories.CategoryListManager = new Grommunio.common.categories.CategoryListManagerClass();
