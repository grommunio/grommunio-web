...
/**
 * @class Grommunio.common.categories.dialogs.CategoriesContentPanel
 * @extends Grommunio.core.ui.ContentPanel
 * @xtype grommunio.categoriescontentpanel
 *
 * ContentPanel for users to edit the categories on a given {@link Grommunio.core.data.IPMRecord record}
 */
Grommunio.common.categories.dialogs.CategoriesContentPanel = Ext.extend(Grommunio.core.ui.ContentPanel, {
	/**
	 * @cfg {Grommunio.core.ui.IPMRecord[]} record The record(s) for which the
	 ...
	 * {@link Grommunio.core.data.ShadowStore}, this will be set to true, so we know that we
	 ...
	 * belongs to {@link Grommunio.advancesearch.AdvanceSearchStore AdvanceSearchStore}
	 */
	...
	constructor: function(config)
	{
		...
		Grommunio.common.categories.dialogs.CategoriesContentPanel.superclass.constructor.call(this, config);
	},

	/**
	 * Event handler which is raised when the user clicks the "Apply" {@link Ext.Button button}
	 *
	 * This will apply the current categories to all {@link Grommunio.core.data.IPMRecord records}
	...
	onApply: function()
	{
		...
		// Update the categoriesStore in Grommunio.common.categories.Util to make sure
	...
	onNew: function()
	{
		...
		Grommunio.common.Actions.openNewCategoryContent({
			store: gridStore,
	 ...
	 * were created in the {@link Grommunio.core.data.ShadowStore}
	 */
...
Ext.reg('grommunio.categoriescontentpanel', Grommunio.common.categories.dialogs.CategoriesContentPanel);
