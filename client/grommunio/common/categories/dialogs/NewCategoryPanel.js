...
/**
 * @class Grommunio.common.categories.dialogs.NewCategoryPanel
 * @extends Grommunio.core.ui.ContentPanel
 * @xtype grommunio.newcategorypanel
 *
 * This content panel is used to create new categories.
 */
Grommunio.common.categories.dialogs.NewCategoryPanel = Ext.extend(Grommunio.core.ui.ContentPanel, {
	/**
	 * @cfg {Grommunio.common.categories.data.CategoriesStore} When this dialog is created from a
	 * {@link Grommunio.common.categories.dialogs.CategoriesContentPanel} this property will contain
	...
	constructor: function(config)
	{
		...
		Grommunio.common.categories.dialogs.NewCategoryPanel.superclass.constructor.call(this, config);
	},
	...
	onCreate: function()
	{
		...
		var categoryStore = new Grommunio.common.categories.data.CategoriesStore(
	...
	showErrorMessage: function(msg)
	{
		...
		var maxWidth = Grommunio.common.dialogs.MessageBox.maxWidth;
		Grommunio.common.dialogs.MessageBox.maxWidth = 350;
		...
		Grommunio.common.dialogs.MessageBox.alert(
			...
			function(){
				...
				Grommunio.common.dialogs.MessageBox.maxWidth = maxWidth;
...
Ext.reg('grommunio.newcategorypanel', Grommunio.common.categories.dialogs.NewCategoryPanel);
