...
/**
 * @class Grommunio.common.categories.dialogs.RenameCategoryPanel
 * @extends Grommunio.core.ui.ContentPanel
 * @xtype grommunio.renamecategorypanel
 *
 * This content panel is used to rename the categories.
 */
Grommunio.common.categories.dialogs.RenameCategoryPanel = Ext.extend(Grommunio.core.ui.ContentPanel, {
	/**
	 * @cfg {Grommunio.common.categories.data.CategoriesStore} store categories store which
	 ...
	 * {@link Grommunio.common.categories.dialogs.CategoriesContentPanel} this property will be true
	 * else false.
	 */
	 ...
	 * {@link Grommunio.common.ui.ColorPicker ColorPicker} when
	...
	/**
	 * @cfg {Grommunio.core.data.IPMStore} recordStore store which
	 * contains the {@link Grommunio.core.data.MAPIRecord record} on which
	...
	constructor: function(config)
	{
		...
		if (Ext.isEmpty(config.store)) {
			config.store = new Grommunio.common.categories.data.CategoriesStore();
		}
		...
		Grommunio.common.categories.dialogs.RenameCategoryPanel.superclass.constructor.call(this, config);
	},
	 ...
	 * from {@link Grommunio.common.categories.data.CategoriesStore CategoriesStore}.
	...
	onClickNo: function()
	{
		...
		category.commit();
		this.store.save();
		Grommunio.common.categories.Util.addCategory(this.records, this.categoryName, true, this.recordStore);
		this.close();
	},
	 ...
	 * reload the {@link Grommunio.common.categories.data.CategoriesStore CategoriesStore}.
	 *
	...
	doRenameCategory: function (categoryRecord, categoryName)
	{
		...
		Grommunio.common.categories.Util.loadCategoriesStore();
		...
		if(!this.isCategoryGrid) {
			Grommunio.common.categories.Util.addCategory(this.records, categoryName, true, this.recordStore);
		}
		Grommunio.common.categories.Util.updateStoresAfterCategoryUpdate();
	}
});

Ext.reg('grommunio.renamecategorypanel', Grommunio.common.categories.dialogs.RenameCategoryPanel);
