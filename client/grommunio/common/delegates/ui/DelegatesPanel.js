...
Ext.namespace('Grommunio.common.delegates.ui');

/**
 * @class Grommunio.common.delegates.ui.DelegatesPanel
 * @extends Ext.Panel
 * @xtype grommunio.delegatespanel
 * Will generate UI for the {@link Grommunio.common.settings.SettingsDelegateWidget SettingsDelegateWidget}.
 */
Grommunio.common.delegates.ui.DelegatesPanel = Ext.extend(Ext.Panel, {
	/**
	 * @cfg {Grommunio.common.delegates.data.DelegateStore} store Delegate store that will be used to load delegates data
	 */
	store: undefined,
	...
	constructor: function(config)
	{
		...
		if(!config.store) {
			config.store = new Grommunio.common.delegates.data.DelegateStore();
		}
		...
		Grommunio.common.delegates.ui.DelegatesPanel.superclass.constructor.call(this, config);
	},

	/**
	 * Function will create panel items for {@link Grommunio.common.delegates.ui.DelegatesPanel DelegatesPanel}
	 * @return {Array} array of items that should be added to panel.
	 * @param {Grommunio.common.delegates.data.DelegateStore} store store that will be used to load delegates data.
	 * @private
	 */
	createPanelItems: function(store)
	{
		return [{
			...
			fieldClass: 'x-form-display-field grommunio-settings-widget-extrainfo'
		}, {
			xtype: 'container',
			flex: 1,
			layout: {
	...
	initEvents: function()
	{
		Grommunio.common.delegates.ui.DelegatesPanel.superclass.initEvents.call(this);
	 ...
	 * open {@link Grommunio.common.delegates.dialogs.DelegatePermissionContentPanel DelegatePermissionContentPanel}
	 * for the currently added delegate.
	 * @param {Grommunio.common.delegates.data.DelegateStore} store store that was used to add delegate user.
	 * @param {Grommunio.common.delegates.data.DelegateRecord[]} record array of records that are added in store.
	...
	/**
	 * Helper function that will be used when user adds a new {@link Grommunio.common.delegates.data.DelegateRecord DelegateRecord}
	 ...
	 * and then {@link Grommunio.common.delegates.dialogs.DelegatePermissionContentPanel DelegatePermissionContentPanel} can be opened
	 * using the record.
	 * @param {Grommunio.common.delegates.data.DelegateRecord} record delegate record which is added in grid
	 */
	 ...
	 * @param {Grommunio.common.delegates.data.DelegateRecord} record delegate record for which we need to get existing folder permissions
	...
	/**
	 * Event handler will be called when selection in {@link Grommunio.common.delegates.ui.DelegatesGrid DelegatesGrid}
	 * has been changed
	 ...
	 * this will open {@link Grommunio.common.delegates.dialogs.DelegatePermissionContentPanel DelegatePermissionContentPanel}
	...
	/**
	 * Function will be used to reload data in the {@link Grommunio.common.delegates.data.DelegateStore DelegateStore}.
	 */
	...
	/**
	 * Function will be used to save changes in the {@link Grommunio.common.delegates.data.DelegateStore DelegateStore}.
	 */
...
Ext.reg('grommunio.delegatespanel', Grommunio.common.delegates.ui.DelegatesPanel);
