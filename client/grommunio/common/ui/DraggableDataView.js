...
/**
 * @class Grommunio.common.ui.DraggableDataView
 * @extends Ext.DataView
 * @xtype grommunio.draggabledataview
 */
Grommunio.common.ui.DraggableDataView = Ext.extend(Ext.DataView, {
	/**
	...
	constructor: function(config)
	{
		...
		Grommunio.common.ui.DraggableDataView.superclass.constructor.call(this, config);
	},
	...
	onRender: function()
	{
		Grommunio.common.ui.DraggableDataView.superclass.onRender.apply(this, arguments);

		/*
		 * We are using 'grommunio.enablefocusplugin' plugin with this view, the plugin adds
		...
		if ((this.enableDragDrop || this.enableDrag) && !this.dragZone) {
			this.dragZone = new Grommunio.common.ui.DataDragZone(this, this.dragConfig || {
				ddGroup: this.ddGroup || 'DataDD'
			});
		}
	},
	...
	{
		Grommunio.common.ui.DraggableDataView.superclass.afterRender.apply(this, arguments);
	 ...
	 *
	 * @param {Grommunio.common.ui.DraggableDataView} dataView This view
	...
	openContextMenuForNode: function(index, node, event)
	{
		...
		return Grommunio.core.data.UIFactory.openDefaultContextMenu(this.getSelectedRecords(), { position: event.getXY() });
	},
	 ...
	 * {@link Grommunio.core.plugins.EnableFocusPlugin plugin} instead of on a node. Such a
	...
	onKeyboardContextMenu: function(event)
	{
		...
		Grommunio.core.data.UIFactory.initKeyboardMenuNavigation(menu, plugin ? plugin.focusEl : undefined);
	},
	...
	getTemplateTarget: function()
	{
		if(this.templateEl) {
			...
			return Grommunio.common.ui.DraggableDataView.superclass.getTemplateTarget.apply(this);
		}
	},
...
Ext.reg('grommunio.draggabledataview', Grommunio.common.ui.DraggableDataView);
