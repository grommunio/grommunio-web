...
/**
 * @class Grommunio.common.ui.messagepanel.AttachmentLinks
 * @extends Ext.DataView
 * @xtype grommunio.attachmentlinks
 *
 ...
 */
Grommunio.common.ui.messagepanel.AttachmentLinks = Ext.extend(Ext.DataView, {
	/**
	 ...
	 *
	 * Must match {@link Grommunio.common.attachment.AttachmentDragDrop#payloadType},
	...
	constructor: function(config)
	{
		...
		config = Ext.applyIf(config, {
			...
			multiSelect: true,
			overClass: 'grommunio-attachment-link-over',
			itemSelector: 'span.grommunio-attachment-link',
			tpl: new Ext.XTemplate(
				'<div class="preview-header-attachmentbox">' +
					...
					'<div class="preview-attachment-data" style="max-height: {this.maxHeight}px">' +
						'<tpl for=".">' +
							'<span class="grommunio-attachment-link x-grommunio-boxfield-item" viewIndex="{viewIndex}" draggable="true">' +
		...
		Grommunio.common.ui.messagepanel.AttachmentLinks.superclass.constructor.call(this, config);
	},
	...
	{
		Grommunio.common.ui.messagepanel.AttachmentLinks.superclass.initComponent.call(this);
	 ...
	 * @param {Grommunio.core.data.IPMAttachmentRecord} record The attachment record
	 ...
	 * @param {Grommunio.core.data.IPMAttachmentRecord[]} records The attachments
	 ...
	 *
	 * @param {Grommunio.core.data.IPMAttachmentRecord[]} records The attachments to be dragged
	...
	bindStore: function(store, initial)
	{
		...
		Grommunio.common.ui.messagepanel.AttachmentLinks.superclass.bindStore.apply(this, arguments);
	},
	...
	onDestroy: function()
	{
		...
		Grommunio.common.ui.messagepanel.AttachmentLinks.superclass.onDestroy.apply(this, arguments);
	},
	...
	update: function(record, contentReset)
	{
		...
		if (record && record instanceof Grommunio.core.data.MAPIRecord) {
			...
			Grommunio.common.ui.messagepanel.AttachmentLinks.superclass.update.apply(this, arguments);
		}
	},

	/**
	 * Called when the {@link #click} event is fired. This will
	 * {@link Grommunio.core.data.UIFactory#openViewRecord open} the selected attachment
	 *
	...
	onAttachmentClicked: function(dataview, index, node, evt)
	{
		...
		Grommunio.common.Actions.openAttachmentRecord(attachment);
	},
	 ...
	 * @return {Grommunio.core.data.IPMAttachmentRecord[]} The records, possibly empty
	 * @private
	 */
	...
	/**
	 * Called when user right-clicks on an item in {@link Grommunio.common.ui.messagepanel.AttachmentLinks}
	 * invokes {@link Grommunio.core.data.UIFactory#openDefaultContextMenu} with the selected {@link Grommunio.core.data.IPMRecord}
	 *
	 * 🛑 The selection is passed in the config, not as the first argument.
	 * {@link Grommunio.core.data.UIFactory#openContextMenu} first asks the plugins
...
Ext.reg('grommunio.attachmentlinks', Grommunio.common.ui.messagepanel.AttachmentLinks);
