...
/**
 * @class Grommunio.common.ui.messagepanel.MessageHeader
 * @extends Ext.Panel
 * @xtype grommunio.messageheader
 */
Grommunio.common.ui.messagepanel.MessageHeader = Ext.extend(Ext.Panel, {
	 ...
	 * @param {Grommunio.common.ui.messagepanel.MessageHeader} panel This panel
	 */
	...
	headerTemplate:
		'<div class="preview-header-titlebox">' +
			...
			'<tpl if="!Ext.isEmpty(values.subject)">' +
				'<span class="preview-title grommunio-contextmenu-enabled">{subject:htmlEncode}</span>' +
			'</tpl>' +
		'</div>',
	...
	constructor: function(config)
	{
		...
		Grommunio.common.ui.messagepanel.MessageHeader.superclass.constructor.call(this, config);
	...
	createHeaderInfo: function (config)
	{
		...
		// if owner component is "grommunio.taskpreviewpanel", which indicate that we have to
		// load the task request record in preview panel so prepare header accordingly.
		if (config.ownerCt.isXType('grommunio.taskpreviewpanel')) {
			items.push({
	...
	onRender: function()
	{
		Grommunio.common.ui.messagepanel.MessageHeader.superclass.onRender.apply(this, arguments);
...
Ext.reg('grommunio.messageheader', Grommunio.common.ui.messagepanel.MessageHeader);
