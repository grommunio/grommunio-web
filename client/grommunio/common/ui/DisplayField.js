...
/**
 * @class Grommunio.common.ui.DisplayField
 ...
 */
Grommunio.common.ui.DisplayField = Ext.extend(Ext.form.DisplayField, {
	/**
	...
	{
		this.rawValue = value;
		return Grommunio.common.ui.DisplayField.superclass.setRawValue.call(this, this.renderer(value));
	},
...
Ext.reg('grommunio.displayfield', Grommunio.common.ui.DisplayField);
