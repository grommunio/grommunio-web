...
/**
 * @class Grommunio.common.ui.ColorPicker
 ...
 */
Grommunio.common.ui.ColorPicker = Ext.extend(Ext.form.Field, {
	/**
  ...
  constructor: function(config)
  {
	this.addEvents(
			 ...
			 *
			 * @param {Grommunio.common.ui.ColorPicker} this The color picker.
    ...
    Grommunio.common.ui.ColorPicker.superclass.constructor.call(this, config);
  },
    ...
    Grommunio.common.ui.ColorPicker.superclass.onRender.apply(this, arguments);

    if ( this.border ){
	this.cls = (this.cls || '') + ' grommunio-border';
    }
   ...
   */
  initEvents: function(){
    Grommunio.common.ui.ColorPicker.superclass.initEvents.call(this);
	 ...
	 * @return {Grommunio.common.ui.ColorPicker} this
	 */
...
Ext.reg('grommunio.colorpicker', Grommunio.common.ui.ColorPicker);
