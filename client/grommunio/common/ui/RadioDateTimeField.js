...
/**
 * @class Grommunio.common.ui.RadioDateTimeField
 * @extends Grommunio.common.ui.CompositeField
 * @xtype grommunio.radiodatetimefield
 *
 * This class can be used to construct a {@link Ext.form.Field field}
 * which contains a {@link Ext.form.Radio} and a {@link Grommunio.common.ui.DateTimeField}
 */
Grommunio.common.ui.RadioDateTimeField = Ext.extend(Grommunio.common.ui.CompositeField, {
  ...
  constructor: function (config)
  {
    ...
    config = Ext.applyIf(config, {
      items: [{
        ...
        ref: 'dateTimeField',
				cls:'grommunio-radiodatetime-datetimefield',
        minValue: new Date(),
        width: 200,
        listeners: {
    ...
    Grommunio.common.ui.RadioDateTimeField.superclass.constructor.call(this, config);
  },

  /**
   * Event handler which is called when {@link Grommunio.common.ui.DateTimeField dateTimeField} has receives input value,
   * If the input value is number then call the {@link Grommunio.common.ui.DateTimeField doDateChange} function.
   * @param {Grommunio.common.ui.DateTimeField} field The field which fired the event
   */
  ...
  /**
   * Event handler which is called when the {@link Grommunio.common.ui.DateTimeField dateTimeField} receives input focus,
   ...
   * @param {Grommunio.common.ui.DateTimeField} field The field which has fired the event
  ...
  /**
   * Function return the {@link Grommunio.common.ui.DateTimeField dateTimeField} value
   ...
   * set value in {@link Grommunio.common.ui.DateTimeField dateTimeField}
  ...
  /**
   * Function add css class to the {@link Grommunio.common.ui.DateTimeField dateTimeField}
  ...
  /**
   * Function remove css class to the {@link Grommunio.common.ui.DateTimeField dateTimeField}
   * @param {String} cls CSS class name
   */
...
Ext.reg('grommunio.radiodatetimefield', Grommunio.common.ui.RadioDateTimeField);
