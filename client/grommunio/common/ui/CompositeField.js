...
/**
 * @class Grommunio.common.ui.CompositeField
 * @extends Ext.form.CompositeField
 * @xtype grommunio.compositefield
 */
Grommunio.common.ui.CompositeField = Ext.extend(Ext.form.CompositeField, {
	...
	constructor: function(config)
	{
		...
		config.cls = config.cls ? config.cls + ' grommunio-compositefield' : 'grommunio-compositefield';

		Ext.apply(this, config);

		Grommunio.common.ui.CompositeField.superclass.constructor.call(this, config);
	},

	/**
	 * Initialize component
	 * We perform a Ext.create() on each item within the
	 * {@link Grommunio.common.ui.CompositeField CompositeField} to make sure it
	...
	{
		Grommunio.common.ui.CompositeField.superclass.initComponent.call(this);
...
Ext.reg('grommunio.compositefield', Grommunio.common.ui.CompositeField);
