...
/**
 * @class Grommunio.common.ui.BoxField
 * @extends Ext.form.ComboBox
 * @xtype grommunio.boxfield
 *
 * A special input field which displays all contents inside special {@link Grommunio.common.ui.Box}
 ...
 * the {@link Ext.data.Record records} which must be rendered as {@link Grommunio.common.ui.Box box}.
 */
Grommunio.common.ui.BoxField = Ext.extend(Ext.form.ComboBox, {
	/**
	 * @cfg {String} boxType The xtype of the component which is used as box.
	 * This defaults to {@link Grommunio.common.ui.Box 'grommunio.box'}.
	 */
	boxType: 'grommunio.box',
	/**
	 * @cfg {Ext.data.Store} boxStore The store which contains all {@link Ext.data.Record records}
	 * which must be rendered as {@link Grommunio.common.ui.Box}. Before rendering, the contents
	 * will be filtered by {@link #filterRecords}.
	 */
	boxStore: undefined,
	/**
	 * @cfg {Object} boxConfig A configuration object which must be applied to all
	 * {@link Grommunio.common.ui.Box box} components which are rendered into this component
	 * by default.
	 */
	boxConfig: undefined,
	/**
	 * The collection of all {@link Grommunio.common.ui.Box Box} components which have been
	...
	enableComboBox: true,
	/**
	 * The {@link Grommunio.common.ui.Box box} which currently has the userfocus.
	 * @property
	 * @type Grommunio.common.ui.Box
	 */
	currentFocus: false,
	/**
	 ...
	 */
	wrapCls: 'x-form-text x-grommunio-boxfield',
	...
	constructor: function(config)
	{
		...
		Ext.applyIf(config, {
			...
			xtype: 'grommunio.boxfield',
			cls: 'x-grommunio-boxfield-input',
			hideTrigger: true,
		...
		this.addEvents(
			 ...
			 * @param {Grommunio.common.ui.BoxField} boxField Parent of the box
			 * @param {Grommunio.common.ui.Box} box The box that has been focussed
			 ...
			 * @param {Grommunio.common.ui.BoxField} boxField Parent of the box
			 * @param {Grommunio.common.ui.Box} box The box that has been blurred
			 * @param {Ext.data.Record} record The record that belongs to the box
			 */
			'boxblur',
			/**
			 ...
			 * @param {Grommunio.common.ui.BoxField} boxField Parent of the box
			 * @param {Grommunio.common.ui.Box} box The box that has been clicked
			 * @param {Ext.data.Record} record The record that belongs to the box
			 */
			'boxclick',
			/**
			 ...
			 * @param {Grommunio.common.ui.BoxField} boxField Parent of the box
			 * @param {Grommunio.common.ui.Box} box The box that has been doubleclicked
			 * @param {Ext.data.Record} record The record that belongs to the box
			 */
			'boxdblclick',
			/**
			 ...
			 * @param {Grommunio.common.ui.BoxField} boxField Parent of the box
			 * @param {Grommunio.common.ui.Box} box The box for which the contextmenu was requested
			 * @param {Ext.data.Record} record The record that belongs to the box
			 */
			'boxcontextmenu',
			/**
			 ...
			 * @param {Grommunio.common.ui.BoxField} boxField Parent of the to be added box
			 * @param {Grommunio.common.ui.Box} box The box that has been added
			 * @param {Ext.data.Record} record The record that belongs to the box
			 */
			'boxadd',
			/**
			 ...
			 * @param {Grommunio.common.ui.BoxField} boxField Parent of the to be removed box
			 * @param {Grommunio.common.ui.Box} box The box that will be removed
			 * @param {Ext.data.Record} record The record that belongs to the box
			 */
			'boxremove'
		);

		Grommunio.common.ui.BoxField.superclass.constructor.call(this, config);
	...
	{
		Grommunio.common.ui.BoxField.superclass.initComponent.call(this);
	...
	initEvents: function()
	{
		...
		if (this.editable !== false) {
			 ...
			 * Use the Grommunio.core.Event function to ensure compatibility
			 * with all browsers and support for drag & dropping text.
			 */
			Grommunio.core.Events.addPasteEventHandler(this, this.el, this.onPaste, this);
		}
		...
		Grommunio.common.ui.BoxField.superclass.initEvents.call(this);
	},
	...
	initList: function()
	{
		Grommunio.common.ui.BoxField.superclass.initList.call(this);
	...
	{
		if (this.enableComboBox === true) {
			Grommunio.common.ui.BoxField.superclass.onTriggerClick.apply(this, arguments);
		}
	},
	...
	{
		if (this.enableComboBox === true) {
			Grommunio.common.ui.BoxField.superclass.doQuery.apply(this, arguments);
		}
	},
	...
	{
		if (this.enableComboBox === true) {
			Grommunio.common.ui.BoxField.superclass.assertValue.apply(this, arguments);
		}
	},
	...
	{
		Grommunio.common.ui.BoxField.superclass.onBeforeLoad.apply(this, arguments);
	...
	onLoad: function(store, records, options)
	{
		...
		Grommunio.common.ui.BoxField.superclass.onLoad.apply(this, arguments);
	},
	...
	restrictWidth: function(width)
	{
		...
		if (this.minListWidth > desiredWidth) {
			...
			// Don't restrict width of suggestion-list in case of grommunio.userlistbox
			// because container is smaller then the width of content of suggestion list.
			// And we don't want the ellipsis.
			if (this.boxType !== "grommunio.userlistbox"){
		...
		if (availableWidth < desiredWidth) {
			// Don't adjust left-offset of suggestion-list in case of grommunio.userlistbox.
	...
	{
		Grommunio.common.ui.BoxField.superclass.onRender.call(this, ct, position);
		...
		this.inputEl = this.el.wrap({
			tag: 'li',
			cls: 'x-grommunio-boxfield-input-item'
		});

		if (this.border === false) {
			this.el.addClass('x-grommunio-boxfield-input-noborder');
		}
	 ...
	 * {@link Grommunio.common.ui.Box#editable} state on there.
	 * @private
	 */
	updateEditState: function()
	{
		Grommunio.common.ui.BoxField.superclass.updateEditState.apply(this, arguments);
	...
	{
		Grommunio.common.ui.BoxField.superclass.onResize.call(this, w, h, rw, rh);
	...
	sizeContainer: function()
	{
		...
		if ( !Ext.isDefined(target) || !Ext.isDefined(target.dom) ){
			...
			// this element was removed. (See Grommunio.common.ui.Box.doDestroy())
			return;
		}
	 ...
	 * the input into a new {@link Grommunio.common.ui.Box Box}.
	 * @private
	 */
	...
	/**
	 * Find the {@link Grommunio.common.ui.Box} which belongs to the given record.
	 * @param {Ext.data.Record} record The record for which the box is searched
	 * @return {Grommunio.common.ui.Box} The box which belongs to the given record
	 */
	...
	beforeBlur: function()
	{
		Grommunio.common.ui.BoxField.superclass.beforeBlur.apply(this, arguments);
		this.convertInputToBox();
		this.boxBlur();
	},

	/**
	 * Put the focus on a particular box. This will call {@link Grommunio.common.ui.Box#blur}
	 * on the {@link #currentFocus currently focussed} element. And then call
	 * {@link Grommunio.common.ui.Box#focus} on the new box which will be set in {@link #currentFocus}.
	 *
	 * @param {Grommunio.common.ui.Box} box The box to put the focus on
	 * @private
	 */
	 ...
	 * This will call {@link Grommunio.common.ui.Box#blur} on the box, and then
	...
	inputFocus: function(caretPos, selectText)
	{
		...
		if (!Ext.isEmpty(caretPos)) {
			Grommunio.core.Util.setCaretPosition(this.el, caretPos);
		}
		if (selectText === true) {
			this.el.dom.select();
		}
	...
	{
		Grommunio.common.Actions.copyEmailAddress(this.currentFocus.record);
	},
	 ...
	 *
	 * @param {Ext.Element} element The {@link Grommunio.common.ui.BoxField#el combo box} element.
	 * @return {Ext.KeyMap} The keymap for the {@link Grommunio.common.ui.BoxField#el combo box} element.
	 * @private
	 */
	...
	{
		var caret = Grommunio.core.Util.getSelectionRange(this.el);
	 ...
	 * {@link Grommunio.common.recipientfield.data.SuggestionListStore SuggestionListStore}.
	 *
	 * @param {Number} key The key which was pressed
	 * @param {Ext.EventObject} e The event object which fired the event
	 * @private
	 ...
	 * This is fired by the special {@link Grommunio.core.Event#addPasteEventHandler}
	 ...
	 * This will {@link Grommunio.common.ui.Box#update update} the box with the new
	...
	/**
	 * Callback function from {@link Grommunio.common.ui.Box} which indicates
	 ...
	 * @param {Grommunio.common.ui.BoxField} field The field which has fired the event
	 * @param {Grommunio.common.ui.Box} box The box which has been removed
	 ...
	 * @param {Grommunio.common.ui.BoxField} field The field which has fired the event
	 * @param {Grommunio.common.ui.Box} box The box which has been added
	 * @param {Ext.data.Record} record The record which belongs to the given box
	 * @private
	 */
	...
	/**
	 * Adds a box to the field. It will instantiate the {@link Grommunio.common.ui.Box Box} component that will
	...
	/**
	 * Removes a {@link Grommunio.common.ui.Box Box} from the field.
	...
	/**
	 * Load all new {@link Grommunio.common.ui.Box boxes} based on the records from
	 ...
	 * {@link Grommunio.common.ui.Box#destroy destroyed}, and then removed from {@link #items}
	...
	onDestroy: function()
	{
		Grommunio.common.ui.BoxField.superclass.onDestroy.apply(this, arguments);

		if (this.editable !== false) {
			Grommunio.core.Events.removePasteEventHandler(this, this.el, this.onPaste, this);
		}
	}
});

Ext.reg('grommunio.boxfield', Grommunio.common.ui.BoxField);
