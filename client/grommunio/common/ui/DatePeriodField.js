...
/**
 * @class Grommunio.common.ui.DatePeriodField
 ...
 */
Grommunio.common.ui.DatePeriodField = Ext.extend(Grommunio.common.ui.DateRangeField, {
	/**
	...
	constructor: function(config)
	{
		...
		config.startFieldConfig.listeners = Grommunio.core.Util.mergeListeners(config.startFieldConfig.listeners, {
		...
		config.endFieldConfig.listeners = Grommunio.core.Util.mergeListeners(config.endFieldConfig.listeners, {
		...
		if(config.allowBlank && !Ext.isDefined(config.defaultValue)) {
			Ext.applyIf(config, {
				...
				defaultValue: new Grommunio.core.DateRange({ allowBlank: true }),
				defaultPeriod: 30
			});
		}

		Grommunio.common.ui.DatePeriodField.superclass.constructor.call(this, config);
	},
...
Ext.reg('grommunio.dateperiodfield', Grommunio.common.ui.DatePeriodField);
