 ...
 *
 * @class Grommunio.common.ui.ResizableCompositeField
 * @extends Grommunio.common.ui.CompositeField
 * @xtype grommunio.resizablecompositefield
 */
Grommunio.common.ui.ResizableCompositeField = Ext.extend(Grommunio.common.ui.CompositeField, {
	...
	constructor: function(config)
	{
		...
		config.cls = config.cls ? config.cls + ' grommunio-resizable-compositefield' : 'grommunio-resizable-compositefield';

		Ext.apply(this, config);

		Grommunio.common.ui.ResizableCompositeField.superclass.constructor.call(this, config);
	},
  ...
  initComponent: function() {
	...
	if ( item.isXType('grommunio.boxfield') ){
  ...
  onResize: function(adjWidth, adjHeight, rawWidth, rawHeight) {
    ...
    Grommunio.common.ui.ResizableCompositeField.superclass.onResize.apply(this, [adjWidth, adjHeight, rawWidth, rawHeight]);
  }

});

Ext.reg('grommunio.resizablecompositefield', Grommunio.common.ui.ResizableCompositeField);
