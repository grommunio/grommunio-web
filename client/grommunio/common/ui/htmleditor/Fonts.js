...
Ext.namespace('Grommunio.common.ui.htmleditor');

/**
 * @class Grommunio.common.ui.htmleditor.Fonts
 * Singleton holding a list of available fonts for TinyMCE
 * @singleton
 */
Grommunio.common.ui.htmleditor.Fonts = function(){
	return {
		/**
		 * @return {Object} object with fonts, key is the setting in 'grommunio/v1/mail/default_font_size'
		...
		getDefaultFontSize: function()
		{
			...
			var defaultFontSize = container.getSettingsModel().get('grommunio/v1/main/default_font_size');
