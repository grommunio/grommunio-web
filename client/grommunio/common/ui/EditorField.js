...
/**
 * @class Grommunio.common.ui.EditorField
 * @extends Ext.Container
 * @xtype grommunio.editorfield
 *
 * The grommunio Web EditorField is intended as Input area for data. This field
 * offers the possibility for editing using the {@link Grommunio.common.ui.HtmlEditor HtmlEditor}
 * or a simple {@link Ext.form.TextArea textarea}.
 */
Grommunio.common.ui.EditorField = Ext.extend(Ext.Container, {
	/**
	 * @cfg {Boolean} useHtml Use the {@link Grommunio.common.ui.HtmlEditor HTML editor}
	 ...
	 * By default this is {@link Grommunio.common.ui.HtmlEditor grommunio.htmleditor}.
	 */
	htmlXtype: 'grommunio.htmleditor',
	/**
	 * @cfg {String} plaintextXtype The Xtype of the component which is used for the Plain
	 * text editor. By default this is {@link Grommunio.common.form.TextArea textarea}.
	 */
	plaintextXtype: 'grommunio.textarea',
	/**
	 * @cfg {String} htmlName The {@link Ext.form.Field#name name} property of the
	 * {@link Grommunio.common.ui.HtmlEditor grommunio.htmleditor}
	 */
	htmlName: '',
	/**
	 * @cfg {String} plaintextName The {@link Ext.form.Field#name name} property of the
	 * {@link Grommunio.common.form.TextArea textarea}
	 */
	plaintextName: '',
	/**
	 ...
	 * {@link Grommunio.common.ui.HtmlEditor HtmlEditor} and {@link Grommunio.common.ui.TextArea textarea}.
	 * If this object is not set, the configuration object used to create this
	 * {@link Grommunio.common.ui.EditorField component} will be used.
	 */
	componentConfig: undefined,
	/**
	 * @cfg {Array} relayedEvents (optional) the array of event names which must
	 * be relayed from the Editor component to this {@link Grommunio.common.ui.EditorField field}.
	...
	constructor: function(config)
	{
		...
		Grommunio.common.ui.EditorField.superclass.constructor.call(this, config);
	...
	setHtmlEditor: function(useHtml, convert)
	{
		if (this.useHtml !== useHtml) {
			...
			if (convert !== false && !Ext.isEmpty(value)) {
				var newValue;
				if (useHtml) {
					newValue = Grommunio.core.HTMLParser.convertPlainToHTML(value);
				} else {
					newValue = Grommunio.core.HTMLParser.convertHTMLToPlain(value);
				}
	...
	/**
	 * Function is used to set the cursor position in {@link Grommunio.common.form.TextArea}.
	 */
	...
	hasSignature: function()
	{
		...
		if (component instanceof Ext.ux.form.TinyMCETextArea) {
			...
			var plainSignature = Grommunio.core.HTMLParser.convertHTMLToPlain(this.currentSignatureHtml);
	...
	replaceSignatureContent: function(newContent) {
		...
		if (component instanceof Ext.ux.form.TinyMCETextArea) {
			...
			component.setValue(beforeSignature + Grommunio.core.HTMLParser.convertHTMLToPlain(newContent)); // Replace with converted plain text
			}
		}
	},
	...
	getHTMLEditorXtype: function()
	{
		...
		var configuredEditor = container.getSettingsModel().get('grommunio/v1/contexts/mail/html_editor');
...
Ext.reg('grommunio.editorfield', Grommunio.common.ui.EditorField);
