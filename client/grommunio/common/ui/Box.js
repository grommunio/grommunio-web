...
/**
 * @class Grommunio.common.ui.Box
 * @extends Ext.BoxComponent
 * @xtype grommunio.box
 *
 * The Box which is used by {@link Grommunio.common.ui.BoxField} components
 * to display the boxes inside itself. This box is dediciated to the BoxField
 * and cannot be used separately.
 */
Grommunio.common.ui.Box = Ext.extend(Ext.BoxComponent, {
	/**
	...
	/**
	 * @cfg {Grommunio.common.ui.BoxField} parent The boxfield
	...
	constructor: function(config)
	{
		...
		Ext.applyIf(config, {
			autoEl: {
				tag: 'li',
				cls: 'x-grommunio-boxfield-item',
				role: 'option'
			}
		});

		Grommunio.common.ui.Box.superclass.constructor.call(this, config);
	...
	{
		Grommunio.common.ui.Box.superclass.onRender.call(this, ct, position);
	...
	{
		Grommunio.common.ui.Box.superclass.afterRender.call(this, ct);
	...
	focus: function()
	{
		Grommunio.common.ui.Box.superclass.focus.call(this);
	...
	blur: function()
	{
		Grommunio.common.ui.Box.superclass.blur.call(this);
	...
	{
		return Grommunio.common.ui.IconClass.getIconClass(record);
	},
...
Ext.reg('grommunio.box', Grommunio.common.ui.Box);
