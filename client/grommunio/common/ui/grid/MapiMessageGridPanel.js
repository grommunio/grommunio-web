...
/**
 * @class Grommunio.common.ui.grid.MapiMessageGrid
 * @extends Grommunio.common.ui.grid.GridPanel
 * @xtype grommunio.mapimessagegrid
 *
 ...
 */
Grommunio.common.ui.grid.MapiMessageGrid = Ext.extend(Grommunio.common.ui.grid.GridPanel, {
	/*
	 * @TODO:
	 ...
	 * have common key mapping but extends Grommunio.common.ui.grid.GridPanel.
	 */
	...
	initEvents: function()
	{
		Grommunio.common.ui.grid.MapiMessageGrid.superclass.initEvents.call(this);
	 ...
	 * @param (Grommunio.mail.ui.MailGrid) grid this
	 */
	onRenderGrid: function(grid)
	{
		// Create a tooltip that will be used for truncated category labels
	  this.categoryTooltip = new Grommunio.common.categories.ui.Tooltip({
	...
	onCellContextMenu: function(grid, rowIndex, cellIndex, event)
	{
		...
		switch (dataIndex) {
			case 'importance':
				return Grommunio.core.data.UIFactory.openContextMenu(Grommunio.core.data.SharedComponentType['common.contextmenu.importance'], records, { position: event.getXY() });
			default:
				...
				if ( targetElement.hasClass('k-category-block') ){
					return Grommunio.core.data.UIFactory.openContextMenu(Grommunio.core.data.SharedComponentType['common.contextmenu.category'], records, {
	 ...
	 *
	 * @param {Grommunio.common.ui.grid.MapiMessageGrid} grid The grid on which the context menu was requested
	 * @param {Ext.EventObject} event The event structure
	 * @private
	 */
	onContainerContextMenu: function(grid, event)
	{
		if (!Grommunio.core.data.UIFactory.isKeyboardContextMenu(event)) {
			return;
		}
		...
		Grommunio.core.data.UIFactory.initKeyboardMenuNavigation(menu, this.getView().focusEl);
	},
	...
	{
		return !container.getSettingsModel().get('grommunio/v1/contexts/mail/enable_live_scroll') || !this.supportLiveScroll;
	},
	...
	onResize: function()
	{
		Grommunio.common.ui.grid.MapiMessageGrid.superclass.onResize.apply(this, arguments);
	 ...
	 * which contains the {@link Grommunio.common.ui.PagingToolbar PagingToolbar}.
	 */
...
Ext.reg('grommunio.mapimessagegrid', Grommunio.common.ui.grid.MapiMessageGrid);
