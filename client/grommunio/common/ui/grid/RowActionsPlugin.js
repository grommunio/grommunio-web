...
/**
 * @class Grommunio.common.ui.grid.RowActionsPlugin
 * @extends Object
 *
 ...
 */
Grommunio.common.ui.grid.RowActionsPlugin = Ext.extend(Object, {
	/**
	 * @cfg {String} setting The settings path which enables the actions.
	 */
	setting: 'grommunio/v1/contexts/mail/hover_actions',
	...
	/**
	 * @property {Grommunio.core.data.IPMRecord} record The record of {@link #row}.
	 */
	record: undefined,
	 ...
	 * @param {Grommunio.core.data.IPMRecord} record The updated record
	 * @private
	 */
