...
/**
 * @class Grommunio.common.ui.grid.GridView
 * @extends Ext.grid.GridView
 * @xtype grommunio.gridview
 *
 ...
 */
Grommunio.common.ui.grid.GridView = Ext.extend(Ext.grid.GroupingView, {

	/**
	 * @cfg {Boolean} disableScrollToTop {@link Ext.grid.GridView} by default scrolls to top when data is loaded in
	 * {@link Grommunio.core.data.MAPIStore MAPIStore}, but in our case {@link Grommunio.core.ContextModel ContextModel} handles
	 ...
	 * insert in to {@link Grommunio.mail.ui.MailGrid mailgrid} and if it is true means there are some rows
	 * in buffer which are going to insert in {@link Grommunio.mail.ui.MailGrid mailgrid}, also it will not allow
	...
	constructor: function(config)
	{
		...
		this.addEvents(
			 ...
			 * @param {Grommunio.common.ui.grid.GridView} grid view The grid view which fired the event
		...
		Grommunio.common.ui.grid.GridView.superclass.constructor.call(this, config);
	},
	...
	initData: function(newStore, newColModel)
	{
		...
		Grommunio.common.ui.grid.GridView.superclass.initData.apply(this, arguments);
	 ...
	 * {@link Grommunio.core.data.MAPIStore MAPIStore} has completed loading all data, but we don't need this
	 * default behaviour and handle it differently through {@link Grommunio.core.ContextModel ContextModel},
	...
	onLoad: function(store, record, options)
	{
		...
		if (!Ext.isDefined(options.reload) && this.disableScrollToTop !== true && Ext.isDefined(this.scroller.dom) && options.actionType == 'list') {
			Grommunio.common.ui.grid.GridView.superclass.onLoad.apply(this, arguments);
		}
	},
	...
	init: function(grid)
	{
		Grommunio.common.ui.grid.GridView.superclass.init.apply(this, arguments);
	...
	onDataChange: function()
	{
		...
		Grommunio.common.ui.grid.GridView.superclass.onDataChange.apply(this, arguments);
		this.applyEmptyText();
	...
	applyEmptyText: function()
	{
		...
		if (!this.grid.store.isExecuting(Grommunio.core.Actions['list'])) {
			Grommunio.common.ui.grid.GridView.superclass.applyEmptyText.call(this);
		}
	},
	...
	afterRenderUI: function()
	{
		...
		if (this.dragZone) {
			...
			this.dragZone = new Grommunio.common.ui.grid.GridDragZone(this.grid, {
	...
	{
		Grommunio.common.ui.grid.GridView.superclass.afterRender.apply(this, arguments);
	...
	onHeaderClick: function(grid, index)
	{
		...
		if (this.fireEvent('beforesort', this) !== false) {
			Grommunio.common.ui.grid.GridView.superclass.onHeaderClick.apply(this, arguments);
		}
	},
	...
	{
		if(this.fireEvent('beforesort', this) !== false) {
			Grommunio.common.ui.grid.GridView.superclass.handleHdMenuClick.apply(this, arguments);
		}
	},
	...
	onShowGroupsClick: function(mi, checked)
	{
		...
		Grommunio.common.ui.grid.GridView.superclass.onShowGroupsClick.apply(this, arguments);
		...
		container.getSettingsModel().set('grommunio/v1/contexts/mail/enable_grouping', checked);
	},
...
Ext.reg('grommunio.gridview', Grommunio.common.ui.grid.GridView);
