...
/**
 * @class Grommunio.common.ui.grid.RowSelectionModel
 * @extends Ext.grid.RowSelectionModel
 *
 * This selection model makes use of {@link Grommunio.core.data.MAPIStore#getRecordKey} function
 ...
 */
Grommunio.common.ui.grid.RowSelectionModel = Ext.extend(Ext.grid.RowSelectionModel, {
	/**
	 * @constructor
	...
	{
		Grommunio.common.ui.grid.RowSelectionModel.superclass.constructor.call(this, config);
	 ...
	 * This method is overridden to make sure that we don't directly access {@link Grommunio.core.data.MAPIRecord#id}
	 * instead we get uniqueid using {@link Grommunio.core.data.MAPIStore#getRecordKey}.
