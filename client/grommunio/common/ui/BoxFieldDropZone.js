...
/**
 * @class Grommunio.common.ui.BoxFieldDropZone
 * @extends Ext.dd.DropZone
 * @xtype grommunio.boxfielddropzone
 *
 * A {@link Ext.dd.DropZone DropZone} installed on a {@link Grommunio.common.ui.BoxField BoxField}
 * Ensures cooperation between different BoxFields' drag and drop zones in order to enable the dragging
 * of boxes
 */
Grommunio.common.ui.BoxFieldDropZone = Ext.extend(Ext.dd.DropZone, {
	/**
	 * @cfg {Grommunio.common.ui.BoxField} field The field on which this drag zone is installed
	 */
	field: undefined,
	...
	{
		return e.getTarget('.x-grommunio-boxfield');
	},
...
Ext.reg('grommunio.boxfielddropzone', Grommunio.common.ui.BoxFieldDropZone);
