...
/**
 * @class Grommunio.common.ui.ContextMainPanelToolbar
 * @extends Ext.Toolbar
 ...
 */
Grommunio.common.ui.ContextMainPanelToolbar = Ext.extend(Ext.Toolbar, {
	/**
	...
	constructor: function(config)
	{
			...
			container.populateInsertionPoint('context.mainpaneltoolbar.item', config.context),
		{
			...
			tooltip: _('Copy/Move') + Grommunio.core.KeyMapMgr.formatShortcutHint('Ctrl + M', false),
			iconCls: 'icon_copy',
			ref: 'copyButton',
		...
		Grommunio.common.ui.ContextMainPanelToolbar.superclass.constructor.call(this, config);
		this.initEvent();
	},
	...
	onPrint: function()
	{
		Grommunio.common.Actions.openPrintDialog(this.model.getSelectedRecords());
	},
	...
	{
		Grommunio.common.ui.ContextMainPanelToolbar.superclass.onResize.apply(this, arguments);
...
Ext.reg('grommunio.contextmainpaneltoolbar', Grommunio.common.ui.ContextMainPanelToolbar);
