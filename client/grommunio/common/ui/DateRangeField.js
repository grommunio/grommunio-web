...
/**
 * @class Grommunio.common.ui.DateRangeField
 * @extends Ext.Container
 * @xtype grommunio.daterangefield
 *
 * This class can be used to combine two {@link Ext.form.Field fields}
 * objects together to configure a {@link Grommunio.core.DateRange DateRange}.
 ...
 */
Grommunio.common.ui.DateRangeField = Ext.extend(Ext.Container, {
	/**
	...
	/**
	 * @cfg {Grommunio.core.DateRange} defaultValue The default {@link Grommunio.core.DateRange daterange}
	 * object which must be set on this field.
	 */
	defaultValue: undefined,
	/**
	 * @cfg {Number} defaultPeriod The default value which must be assumed for
	 * the {@link Grommunio.core.DateRange daterange}. This value can be in minutes, hours, days, etc...
	...
	constructor: function(config)
	{
		...
		this.addEvents(
			 ...
			 * @param {Grommunio.common.ui.DateRangeField} field The field which has been changed
			 * @param {Grommunio.core.DateRange} newValue The new DateRange
			 * @param {Grommunio.core.DateRange} oldValue the old DateRange
			 */
			'change'
		);
		...
		if (!Ext.isDefined(config.defaultValue)) {
			...
			if (Ext.isDefined(config.defaultPeriod)) {
				...
				config.defaultValue = new Grommunio.core.DateRange({ startDate: start, dueDate: end });
			}
		...
		Grommunio.common.ui.DateRangeField.superclass.constructor.call(this, config);
	...
	addFieldItems: function()
	{
		if (Ext.isDefined(this.startFieldConfig)) {
			if (this.layout !== 'form') {
				this.startFieldConfig.plugins = Ext.value(this.startFieldConfig.plugins, []).concat('grommunio.fieldlabeler');
			}

			this.startFieldConfig.listeners = Grommunio.core.Util.mergeListeners(this.startFieldConfig.listeners, {
		...
		if (Ext.isDefined(this.endFieldConfig)) {
			if (this.layout !== 'form') {
				this.endFieldConfig.plugins = Ext.value(this.endFieldConfig.plugins, []).concat('grommunio.fieldlabeler');
			}

			this.endFieldConfig.listeners = Grommunio.core.Util.mergeListeners(this.endFieldConfig.listeners, {
	...
	/**
	 * Set the {@link Grommunio.core.DateRange DateRange} object, this will replace
	 * the currently set object and attaches event listeners to it.
	 * @param {Grommunio.core.DateRange} daterange The new DateRange object
	 * @private
	 */
	 ...
	 * @param {Grommunio.core.DateRange} The value to set
	 */
	...
	enable: function()
	{
		Grommunio.common.ui.DateRangeField.superclass.enable.call(this);
	...
	disable: function()
	{
		Grommunio.common.ui.DateRangeField.superclass.disable.call(this);
		this.startField.disable();
		this.endField.disable();
	},

	/**
	 * Event handler which is triggered when the {@link Grommunio.core.DateRange daterange}
	 * has been changed. This will write the new value into the {@link Grommunio.core.ui.DateTimeField DateTimeField}
	 * @param {Grommunio.core.DateRange} daterange The daterange which has been update
	 * @param {Grommunio.core.DateRange} olddaterange The copy of the daterange object containing the old values
	 */
...
Ext.reg('grommunio.daterangefield', Grommunio.common.ui.DateRangeField);
