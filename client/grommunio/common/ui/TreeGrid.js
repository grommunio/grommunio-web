...
/**
 * @class Grommunio.common.ui.TreeGrid
 * @extends Ext.ux.tree.TreeGrid
 * @xtype grommunio.treegrid
 *
 ...
 */
Grommunio.common.ui.TreeGrid = Ext.extend(Ext.ux.tree.TreeGrid, {
	/**
	...
	initComponent: function()
	{
		...
		Grommunio.common.ui.TreeGrid.superclass.initComponent.call(this);
	},
	...
	onRender: function()
	{
		Grommunio.common.ui.TreeGrid.superclass.onRender.apply(this, arguments);
	...
	updateColumnWidths: function()
	{
		...
		Grommunio.common.ui.TreeGrid.superclass.updateColumnWidths.call(this);
	}
});

Ext.reg('grommunio.treegrid', Grommunio.common.ui.TreeGrid);
