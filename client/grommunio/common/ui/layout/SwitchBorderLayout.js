...
/**
 * @class Grommunio.common.ui.layout.SwitchBorderLayout
 ...
 * and passing it an {@link Grommunio.common.ui.layout.SwitchBorderLayout.Orientation orientation}.
 *
 ...
 *
 * When {@link Grommunio.common.ui.layout.SwitchBorderLayout.Orientation#OFF} is enabled, then only
 * the 'center' panel will be displayed full-sized. For the orientation
 * {@link Grommunio.common.ui.layout.SwitchBorderLayout.Orientation#HORIZONTAL} the panel located in
 ...
 * {@link Grommunio.common.ui.layout.SwitchBorderLayout.Orientation#VERTICAL} the 'west' panel will be
 * moved to the 'north', or the 'east' panel will be moved to the 'south' (again this depends on the
 * {@link ##switchMap}.
 */
Grommunio.common.ui.layout.SwitchBorderLayout = Ext.extend(Ext.layout.BorderLayout, {
	/**
	...
	/**
	 * @cfg {Grommunio.common.ui.layout.SwitchBorderLayout.Orientation} orientation The currently active
	 * orientation mode.
	 */
	 ...
	 * it will allocate the {@link Grommunio.common.ui.layout.SwitchBorderLayout.SwitchRegion Region}
	 * or {@link Grommunio.common.ui.layout.SwitchBorderLayout.SwitchSplitRegion SplitRegion} depending
	...
	onLayout: function(ct, target)
	{
		if (!this.rendered) {
			...
			for(i = 0; i < len; i++) {
				...
				this[pos] = pos != 'center' && c.split
					? new Grommunio.common.ui.layout.SwitchBorderLayout.SwitchSplitRegion(this, c.initialConfig, pos)
					:new Grommunio.common.ui.layout.SwitchBorderLayout.SwitchRegion(this, c.initialConfig, pos);
				...
				if (pos != 'center') {
					...
					this[altPos] = this[pos].split
						? new Grommunio.common.ui.layout.SwitchBorderLayout.SwitchSplitRegion(this, c.initialConfig, altPos)
						:new Grommunio.common.ui.layout.SwitchBorderLayout.SwitchRegion(this, c.initialConfig, altPos);
		...
		Grommunio.common.ui.layout.SwitchBorderLayout.superclass.onLayout.apply(this, arguments);
	},

	/**
	 * Toggle the currently active {@link Grommunio.common.ui.layout.SwitchBorderLayout.Orientation orientation}
	 * and {@link #layout} the {@link #container} again according to the new orientation.
	 * @param {Grommunio.common.ui.layout.SwitchBorderLayout.Orientation} orientation The new orientation which
	...
	setOrientation: function(orientation)
	{
		...
		switch (orientation) {
			case Grommunio.common.ui.layout.SwitchBorderLayout.Orientation.OFF:
				...
				break;
			case Grommunio.common.ui.layout.SwitchBorderLayout.Orientation.HORIZONTAL:
			/* falls through */
			default:
				...
				break;
			case Grommunio.common.ui.layout.SwitchBorderLayout.Orientation.VERTICAL:
				// In case our previous orientation was 'OFF'
				// we must expand the panel (Again don't use animations
				// to prevent problems with size calculations).
...
Ext.Container.LAYOUTS['grommunio.switchborder'] = Grommunio.common.ui.layout.SwitchBorderLayout;
