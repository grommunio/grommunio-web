...
/**
 * @class Grommunio.common.ui.layout.CollapsibleLayout
 ...
 */
Grommunio.common.ui.layout.CollapsibleLayout = Ext.extend(Ext.layout.FitLayout, {
	/**
	...
	configureItem: function(c)
	{
		...
		Grommunio.common.ui.layout.CollapsibleLayout.superclass.configureItem.call(this, c, position);
	},
	...
	onRemove: function(c)
	{
		...
		Grommunio.common.ui.layout.CollapsibleLayout.superclass.onRemove.call(this, c);
	},
	...
	{
		Grommunio.common.ui.layout.CollapsibleLayout.superclass.onLayout.call(this, ct, target);
		this.doResizeItem();
	}
});

Ext.Container.LAYOUTS['grommunio.collapsible'] = Grommunio.common.ui.layout.CollapsibleLayout;
