 ...
 * #dependsFile client/grommunio/common/ui/layout/SwitchBorderLayoutRegion.js
 */
Ext.namespace('Grommunio.common.ui.layout');

/**
 * @class Grommunio.common.ui.layout.SwitchBorderLayout.SwitchSplitRegion
 * @extends Ext.layout.BorderLayout.SplitRegion
 *
 * Extension to the {@link Ext.layout.BorderLayout.SplitRegion} for usage
 * in the {@link Grommunio.common.ui.layout.SwitchBorderLayout}. This defines
 * a resizable area in the layout
 */
Grommunio.common.ui.layout.SwitchBorderLayout.SwitchSplitRegion = Ext.extend(Ext.layout.BorderLayout.SplitRegion, {
	/**
	...
	{
		Grommunio.common.ui.layout.SwitchBorderLayout.SwitchSplitRegion.superclass.constructor.call(this, layout, config, pos);
	 ...
	 */
	setVisible: Grommunio.common.ui.layout.SwitchBorderLayout.SwitchRegion.prototype.setVisible,
	 ...
	 */
	isVisible: Grommunio.common.ui.layout.SwitchBorderLayout.SwitchRegion.prototype.isVisible,
	 ...
	 * @private
	 */
	restrictSize: Grommunio.common.ui.layout.SwitchBorderLayout.SwitchRegion.prototype.restrictSize,
	...
	render: function(ct, p, fakeId)
	{
		if (fakeId === true) {
			var oldId = p.id;
			p.id += '-switch';
			Grommunio.common.ui.layout.SwitchBorderLayout.SwitchSplitRegion.superclass.render.apply(this, arguments);
			p.id = oldId;
		} else {
			Grommunio.common.ui.layout.SwitchBorderLayout.SwitchSplitRegion.superclass.render.apply(this, arguments);
		}
