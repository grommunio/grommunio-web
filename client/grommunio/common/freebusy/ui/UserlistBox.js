...
/**
 * @class Grommunio.common.freebusy.ui.UserlistBox
 * @extends Grommunio.common.recipientfield.ui.RecipientBox
 * @xtype grommunio.userlistbox
 *
 * Extension of the {@link Grommunio.common.recipientfield.ui.RecipientBox RecipientBox}
 * which must be used in the {@link Grommunio.common.freebusy.ui.UserlistView} where
 * the users are listed
 */
Grommunio.common.freebusy.ui.UserlistBox = Ext.extend(Grommunio.common.recipientfield.ui.RecipientBox, {
	...
	constructor: function(config)
	{
		...
		Grommunio.common.freebusy.ui.UserlistBox.superclass.constructor.call(this, config);
	},
	...
	{
		Grommunio.common.freebusy.ui.UserlistBox.superclass.afterRender.call(this, ct);
	...
	update: function(record)
	{
		...
		Grommunio.common.freebusy.ui.UserlistBox.superclass.update.apply(this, arguments);
...
Ext.reg('grommunio.userlistbox', Grommunio.common.freebusy.ui.UserlistBox);
