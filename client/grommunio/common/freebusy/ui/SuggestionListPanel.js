...
/**
 * @class Grommunio.common.freebusy.ui.SuggestionListPanel
 * @extends Ext.Panel
 ...
 */
Grommunio.common.freebusy.ui.SuggestionListPanel = Ext.extend(Ext.Panel, {
	/**
	 * @constructor
	...
	constructor: function(config)
	{
		...
		this.addEvents([
			 ...
			 * main {@link Grommunio.common.freebusy.ui.FreebusySuggestionListView FreebusySuggestionListView}
			 * @param {Grommunio.common.freebusy.ui.SuggestionListPanel} this This panel
			 * @param {Grommunio.common.freebusy.data.FreebusyBlockRecord} record The record containing the suggestion which was selected
			 */
			'select'
		]);

		Grommunio.common.freebusy.ui.SuggestionListPanel.superclass.constructor.call(this, config);
	},
	...
	initEvents: function()
	{
		Grommunio.common.freebusy.ui.SuggestionListPanel.superclass.initEvents.call(this);
	 ...
	 * accordingly.
	 * @param {Grommunio.core.DateRange} newRange The new DateRange
	 * @param {Grommunio.core.DateRange} oldRange The old DateRange
	 * @private
	 */
...
Ext.reg('grommunio.freebusysuggestionlistpanel', Grommunio.common.freebusy.ui.SuggestionListPanel);
