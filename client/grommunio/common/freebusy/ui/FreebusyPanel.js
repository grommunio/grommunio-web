...
/**
 * @class Grommunio.common.freebusy.ui.FreebusyPanel
 * @extends Ext.Panel
 * @xtype grommunio.freebusypanel
 */
Grommunio.common.freebusy.ui.FreebusyPanel = Ext.extend(Ext.Panel, {
	/**
	 ...
	 * store, but it is preferably an {@link Grommunio.core.data.IPMRecipientStore}.
	 */
	userStore: null,
	/**
	 ...
	 * to the {@link Grommunio.common.freebusy.ui.UserListView UserListView} object.
	 */
	userlistConfig: null,
	/**
	 * @cfg {Object} timelineConfig The configuration object which will be applied
	 * to the {@link Grommunio.common.freebusy.ui.TimelineView TimelineView} object.
	 */
	timelineConfig: null,
	/**
	 * @cfg {Object} suggestionConfig The configuration object which will be applied
	 * to the {@link Grommunio.common.freebusy.ui.SuggestionListView SuggestionListView} object.
	 */
	 ...
	 * Height of the header that will be set for the {@link Grommunio.common.freebusy.ui.UserlistView} and the
	 * {@link Grommunio.common.freebusy.ui.TimelineView} (defaults to 50).
	 */
//	headerHeight: 50,
	// Private
	// Height of inputfield that will be shown in the {@link Grommunio.common.freebusy.ui.UserlistView}.
	inputfieldHeight: 20,
	...
	constructor: function(config)
	{
		...
		var model = new Grommunio.common.freebusy.data.FreebusyModel(modelConfig);
		...
		Grommunio.common.freebusy.ui.FreebusyPanel.superclass.constructor.call(this, config);
	...
	createSuggestionView: function()
	{
		return {
			...
			cls: 'grommunio-freebusy-suggestionlist',
			footer: true,
			footerCfg: {
				tag: 'div',
				cls: 'x-panel-footer'
			...
			items: [Ext.applyIf(this.suggestionConfig, {
				xtype: 'grommunio.freebusysuggestionlistpanel',
	...
	createTimelineView: function()
	{
		return Ext.applyIf(this.timelineConfig, {
			...
			model: this.model,
			selector: new Grommunio.common.freebusy.data.TimelineSelector(),
	...
	/**
	 * Returns the model.
	 * @return {Grommunio.common.freebusy.data.FreebusyModel} Model
	 */
	getModel: function()
	{
		return this.model;
	 ...
	 * @param {Grommunio.common.freebusy.ui.SuggestionListPanel} panel The panel which raised the event
	 * @param {Grommunio.common.freebusy.data.FreebusyBlockRecord} record The selected suggestion
	 * @private
	 */
	...
	/**
	 * Called when the {@link Grommunio.common.freebusy.ui.SuggestionListPanel SuggestionListPanel} fires
	 * the {@link Grommunio.common.freebusy.ui.SuggestionListPanel#dateselect dateselect} event.
	 * @param {Grommunio.common.freebusy.ui.SuggestionListPanel} this This panel
...
Ext.reg('grommunio.freebusypanel',Grommunio.common.freebusy.ui.FreebusyPanel);
