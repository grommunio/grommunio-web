...
/**
 * @class Grommunio.common.freebusy.data.TimelineSelector
 * @extends Ext.util.Observable
 */
Grommunio.common.freebusy.data.TimelineSelector = Ext.extend(Ext.util.Observable,
{
	// Private
	...
	constructor: function(config)
	{
		...
		Grommunio.common.freebusy.data.TimelineSelector.superclass.constructor.call(this, config);
	},

	/**
	 * Initializes the selector
	 * @param {Grommunio.common.freebusy.ui.TimelineView} parent Object of the parent TimelineView
	 */
	 ...
	 * @param {Grommunio.core.DateRange} selectorRange selectorRange
	 ...
	 * @param {Grommunio.core.DateRange} selectorRange Daterange for the new position of the selector.
	 */
	 ...
	 * @param {Grommunio.core.DateRange} selectorRange Changed daterange.
	 */
	 ...
	 * @param {Grommunio.common.freebusy.ui.TimelineView} timelineView TimelineView
	 */
