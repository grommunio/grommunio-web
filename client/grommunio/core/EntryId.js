 ...
 * @singleton
 */
Grommunio.core.EntryId = (function()
{
	/* Bit definitions for abFlags[3] of ENTRYID */
	var GROMMUNIO_FAVORITE = '01';
	...
	var GROMMUNIO_UID_GLOBAL_ADDRESS_BOOK = '01000000';
	...
	var WrappedSEID = Ext.extend(BASE_EID, {
		...
		decomposeEntryId: function(storeEntryId)
		{
			...
			this.unWrappedEntryId = Grommunio.core.EntryId.createEntryIdObj(this.unWrappedEntryId);
		}
	});
	...
	return {
		...
		{
			return '00000000' + MAPI_ONE_OFF_UID + '00000080' + Grommunio.core.Util.encode_utf16(displayname) + '0000' + Grommunio.core.Util.encode_utf16(addrtype) + '0000' + Grommunio.core.Util.encode_utf16(emailaddress) + '0000';
		},
		...
		{
			var entryIdObj = Grommunio.core.EntryId.createEntryIdObj(entryId);

			return (entryIdObj.abFlags.substr(6, 8) === GROMMUNIO_FAVORITE);
		},
