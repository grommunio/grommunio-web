...
Grommunio.core.ColorSchemes = {
	...
	isDark: function(r, g, b)
	{
		...
		return Grommunio.core.ColorSchemes.getLuma(r, g, b) < 155;
	}
};

Grommunio.onReady(function(){
		// Load the color schemes that are defined in the config
		Grommunio.core.ColorSchemes.addColorSchemesFromConfig();
});
