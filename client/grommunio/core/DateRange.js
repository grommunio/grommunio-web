...
/**
 * @class Grommunio.core.DateRange
 ...
 */
Grommunio.core.DateRange = Ext.extend(Ext.util.Observable, {
	/**
	 * @cfg {Date} startDate start date for this {@link Grommunio.core.DateRange DateRange}.
	 * use {@link #getStartDate} and {@link #setStartDate} to modify this value.
	 */
	startDate: null,

	/**
	 * @cfg {Date} dueDate due date for this {@link Grommunio.core.DateRange DateRange}.
	 * use {@link #getDueDate} and {@link #setDueDate} to modify this value.
	 */
	dueDate: null,

	/**
	 * @cfg {Boolean} allowBlank Specifies empty dates are accepted by this {@link Grommunio.core.DateRange DateRange},
	 * if {@link #allowBlank} is true then only we can use empty start/due dates in {@link Grommunio.core.DateRange DateRange}.
	...
	constructor: function(config)
	{
		...
		this.addEvents(
			 ...
			 * @param {Grommunio.core.DateRange} newRange The changed daterange object
			 * @param {Grommunio.core.DateRange} oldRange The original daterange values (clone of the daterange object,
			 * prior of the change).
			 */
			'update'
		);

		Grommunio.core.DateRange.superclass.constructor.call(this);
	},
	 ...
	 * @return {Grommunio.core.DateRange} this date range
	 */
	 ...
	 * @return {Grommunio.core.DateRange} a clone of this date range.
	 */
	clone: function()
	{
		return new Grommunio.core.DateRange({
	 ...
	 * @param {Grommunio.core.DateRange} otherRange a date range to compare with.
	 ...
	 *
	 * @param {Grommunio.core.DateRange} otherRange Date range to compare with.
	...
	/**
	 * @param {Grommunio.core.DateRange} range date range to check against.
