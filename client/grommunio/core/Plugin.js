 ...
 */
Grommunio.core.Plugin = Ext.extend(Grommunio.core.data.StatefulObservable, {
	/**
	 * @cfg {Grommunio.core.PluginMetaData} info The Plugin MetaData object
	 * which was used to {@link Grommunio.core.Container#registerPlugin register}
	 * this Plugin to the {@link Grommunio.core.Container container}.
	 */
	info: undefined,
	...
	/**
	 * Add a About/Copyright notice to grommunio Web, to the {@link Grommunio.settings.ui.SettingsCopyrightCategory About Category}
	 * inside the {@link Grommunio.settings.SettingsContext Settings}. This is a convenience function which will use the
	 * {@link Grommunio.settings.ui.SettingsCopyrightCategory#context.settings.category.copyright context.settings.category.copyright}
	 * insertion point.
	 ...
	 * with this function.
	 *
	 * @param {Grommunio.core.data.SharedComponentType} type Type of component which is requested.
	 * @param {Ext.data.Record} record (optional) Passed record.
