 ...
 */
Grommunio.core.Context = Ext.extend(Grommunio.core.Plugin, {
	/**
	...
	constructor: function(config)
	{
		...
		Grommunio.core.Context.superclass.constructor.call(this, config);
	...
	/**
	 * Function will be used as a default handler for "Print" button of {@link Grommunio.core.ui.MainToolbar MainToolbar}.
	 * It will check if active tab is {@link Grommunio.core.ui.ContextContainer ContextContainer} then it will print the selected record
	...
	onPrintSelected: function (button, evt, msg)
	{
		...
		if (activeTab instanceof Grommunio.core.ui.ContextContainer || button.name !== 'defaultPrintBtn') {
	...
	/**
	 * Set the currently active view inside the {@link Grommunio.core.Context context}.
	...
	/**
	 * Obtain the {@link Grommunio.core.ContextModel mode} which is associated
	 * to this context.
	 * @return {Grommunio.core.ContextModel} The model associated to this context
	 */
	 ...
	 * @param {Grommunio.hierarchy.data.MAPIFolderRecord} folder to bid on.
	...
	{
		Grommunio.core.Context.superclass.initStateEvents.call(this);
	 ...
	 *
	 * @param {Grommunio.core.Context} context the current context
	...
	getState: function()
	{
		var state = Grommunio.core.Context.superclass.getState.call(this) || {};
		var model = this.getModel();
		 ...
		 */
		var isOnlyScrolling = (scrolling && !searching && !Grommunio.mail.data.ViewModes.isMainViewMode(this.current_view_mode));
		 ...
		 */
		var isSearchingAndScrolling = (scrolling && searching && Grommunio.mail.data.ViewModes.isMainViewMode(this.oldViewMode));
