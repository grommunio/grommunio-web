/*
 * #dependsFile client/grommunio/core/MessageClass.js
 */
Ext.namespace('Grommunio.core');

/**
 * @class Grommunio.core.ContainerClass
 *
...
Grommunio.core.ContainerClass = {
	 ...
	 */
	// Implementation is exactly that of the Grommunio.core.MessageClass...
	isClass: Grommunio.core.MessageClass.isClass,
	...
	{
		// Implementation is exact inverse of Grommunio.core.MessageClass, so simply swap arguments.
		return Grommunio.core.MessageClass.isContainerClassCompatible(messageClass, containerClass);
	},
