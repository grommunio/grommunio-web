...
/**
 * @class Grommunio.core.BrowserWindowMgr
 ...
 * @singleton
 */
Grommunio.core.BrowserWindowMgr = Ext.extend(Ext.util.Observable, {
	/**
	...
	constructor: function()
	{
		...
		window.addEventListener("focus", function(event) {
			Grommunio.core.BrowserWindowMgr.setActive('mainBrowserWindow');
		}, false);
	...
	/**
	 * Event handler for the {@link Grommunio.core.plugins.RecordComponentPlugin#userupdaterecord userupdaterecord} event
	 * on the {@link #field}. This will relay the value of {@link Grommunio.core.plugins.RecordComponentPlugin#isChangedByUser} config option.
	...
	/**
	 * Register a newly created browser-window object with the {@link Grommunio.core.BrowserWindowMgr BrowserWindowMgr}.
	 * @param {Object} browserWindowObject The newly created window object which must be registered.
	 * @param {Function} component The constructor of the component which has to be created in the container layer.
	 * @param {Object} config The configuration object which must be
	...
	/**
	 * De-register an already registered browser-window object from the {@link Grommunio.core.BrowserWindowMgr BrowserWindowMgr}.
	...
	createUI: function(separateWindowInstance)
	{
		// Enable tooltips
		Ext.QuickTips.init();
		Grommunio.core.KeyboardFocus.init(separateWindowInstance.document);
		...
		var config = {
			plugins: [ 'grommunio.contentlayerplugin' ],
			confirmClose: false
		};
		...
		var task = new Ext.util.DelayedTask(Grommunio.core.BrowserWindowMgr.displayBlockedPopupWarning.createDelegate(this, [separateWindowInstance], this));
		task.delay(200);
	},
	 ...
	 * This will make respective browser window active into {@link Grommunio.core.BrowserWindowMgr BrowserWindowMgr}.
	 *
	 ...
	 * This will de-register the closed component instance from {@link Grommunio.core.data.ContentPanelMgr ContentPanelMgr}.
	 * This will remove all the child elements of the parent most container of separate window.
	 * This will de-register the closed window instance from {@link Grommunio.core.BrowserWindowMgr BrowserWindowMgr}.
	 *
	 * @param {Object} browserWindowObject The newly created window object which must be registered.
	 * @param {Ext.Component} componentInstance component which is required to be rendered into the separate browser window.
	 * @param {Ext.Container} mainContainer The container which is the parent most container of separate window.
	...
	onSeparateWindowUnload: function(browserWindowObject, componentInstance, mainContainer)
	{
		...
		Grommunio.core.data.ContentPanelMgr.unregister(componentInstance);
		...
		try {
			if (!win || !win.innerWidth) {
				...
				if (!oldRecord.phantom) {
					...
					newRecord = Grommunio.core.data.RecordFactory.createRecordObjectByMessageClass('IPM.Note', recordConfig, oldRecord.get('entryid'));
				} else {
	...
	/**
	 * Event handler which is raised after the {@link Grommunio.core.ui.ContentPanel contentPanel} has been
	 * closed. This will de-register the closed window instance from {@link Grommunio.core.BrowserWindowMgr BrowserWindowMgr}.
	 *
	 * @private
	 */
	 ...
	 * 'grommunio-contextmenu-enabled' class then the Browser contextmenu will be disabled.
	...
	{
		var browserWindows = Grommunio.core.BrowserWindowMgr.browserWindows.items;
	...
	displayBlockedPopupWarning: function() {
		if(Grommunio.core.BrowserWindowMgr.isPopupsBlocked) {
			...
			Grommunio.core.BrowserWindowMgr.isPopupsBlocked = false;
		}
	},
	 ...
	 * @param {Grommunio.core.data.MAPIRecord} record The mapi record
	 * @return {Object} Browser window object
	 */
	getOpenedWindow: function (record)
	{
		...
		return this.browserWindows.find(function (browserWindow) {
			return Grommunio.core.EntryId.compareEntryIds(browserWindow.entryid, entryid);
		}, this);
	},
...
Grommunio.core.BrowserWindowMgr = new Grommunio.core.BrowserWindowMgr();
