 ...
 */
Grommunio.core.KeyMap = Ext.extend(Ext.KeyMap, {
	/**
	...
	constructor: function(component, config, element, eventName)
	{
		...
		Grommunio.core.KeyMap.superclass.constructor.call(this, element, config, eventName);
	},
	 ...
	 * 3) additionally this can accept some more config options which is used in {@link Grommunio.core.KeyMapMgr KeyMapMgr},
	 * <pre>
