	...
	isContainerClassCompatible: function(messageClass, containerClass)
	{
		...
		switch (messageClass) {
			...
			case 'IPM.OLE.CLASS.{00061055-0000-0000-C000-000000000046}':
				return Grommunio.core.ContainerClass.isClass(containerClass, 'IPF.Appointment', true);
			case 'IPM.STICKYNOTE':
				return Grommunio.core.ContainerClass.isClass(containerClass, 'IPF.StickyNote', true);
			case 'IPM.CONTACT':
			case 'IPM.DISTLIST':
				return Grommunio.core.ContainerClass.isClass(containerClass, 'IPF.Contact', true);
			case 'IPM.TASK':
				return Grommunio.core.ContainerClass.isClass(containerClass, 'IPF.Task', true);
			case 'IPM.NOTE':
			case 'REPORT.IPM':
			case 'IPM.SCHEDULE':
