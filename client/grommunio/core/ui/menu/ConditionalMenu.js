...
/**
 * @class Grommunio.core.ui.menu.ConditionalMenu
 ...
 */
Grommunio.core.ui.menu.ConditionalMenu = Ext.extend(Ext.menu.Menu, {
	/**
	 * @cfg {Grommunio.core.data.IPMRecord[]} records The records on which this contextmenu was requested
	 */
	records: undefined,
	...
	constructor: function(config)
	{
		...
		Grommunio.core.ui.menu.ConditionalMenu.superclass.constructor.call(this, config);
...
Ext.reg('grommunio.conditionalmenu', Grommunio.core.ui.menu.ConditionalMenu);
