...
Ext.namespace('Grommunio.core.ui.menu');

/**
 * @class Grommunio.core.ui.menu.ConditionalItem
 ...
 */
Grommunio.core.ui.menu.ConditionalItem = Ext.extend(Ext.menu.Item, {
	/**
  ...
  getTemplateArgs: function() {
	...
	var templateArgs = Grommunio.core.ui.menu.ConditionalItem.superclass.getTemplateArgs.call(this);
	...
	constructor: function(config)
	{
		...
		Grommunio.core.ui.menu.ConditionalItem.superclass.constructor.call(this, config);
	},
	...
	{
		Grommunio.core.ui.menu.ConditionalItem.superclass.initComponent.apply(this, arguments);
	 ...
	 * @param {Grommunio.core.ui.menu.ConditionalItem} item The item which is about to be shown.
	 * @param {Grommunio.core.data.MAPIRecord} record The record which is being shown for this menu
	 */
	...
	/**
	 * Obtain the record/records which are attached to the {@link Grommunio.core.ui.menu.ConditionalMenu menu}
	 * to which this item belongs.
	 * @return {Grommunio.core.data.MAPIRecord[]} records
	 */
	getRecords: function()
	{
	 ...
	 * This will go through all parents of the {@link Grommunio.core.ui.ConditionalItem item}
...
Ext.reg('grommunio.conditionalitem', Grommunio.core.ui.menu.ConditionalItem);
