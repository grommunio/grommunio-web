...
/**
 * @class Grommunio.core.ui.ContentPanel
 * @extends Ext.Container
 * @xtype grommunio.contentpanel
 *
 * FIXME: this documentation needs to be completely rewritten
 * The {@link Grommunio.core.ui.ContentPanel ContentPanel} class a base class for content panels and is therefore not intended to be instantiated
 ...
 * <p>
 * <code><pre>
 * Grommunio.core.ui.ContentPanel.register(MyDialog, 'mydialog');
 * </pre></code>.
 * <p>
 ...
 *
 */
Grommunio.core.ui.ContentPanel = Ext.extend(Ext.Container, {
	/**
	 ...
	 * Only used when using {@link Grommunio.core.data.UIFactoryWindowLayer UIFactoryWindowLayer} to
	 * display this {@link Grommunio.core.ui.ContentPanel ContentPanel}.
	 */
	closeAction: 'closeWrap',

	/**
	 * @cfg {Boolean} standalone If true, the {@link Grommunio.core.ui.ContentPanel contentpanel}
	 * will not be hooked into the {@link Grommunio.core.data.ContentPanelMgr}. This will prevent
	 * listening to events coming from the {@link Grommunio.core.data.ContentPanelMgr ContentPanelMgr}.
	 * Defaults to false.
	 */
	standalone: false,
	...
	constructor: function(config)
	{
		...
		if ( config.useInputAutoFocusPlugin !== false ) {
			...
			config.plugins.push({
				ptype: 'grommunio.inputautofocusplugin'
			});
		}
		...
		Grommunio.core.ui.ContentPanel.superclass.constructor.call(this, config);

		/**
		 * @event beforeclose
		 * Fires before the {@link Grommunio.core.ui.ContentPanel ContentPanel} is closed.
		...
		if (!this.standalone) {
			Grommunio.core.data.ContentPanelMgr.register(this);
	...
	{
		Grommunio.core.ui.ContentPanel.superclass.afterRender.apply(this, arguments);
		var xtypes = this.getXTypes();

		// The first part leading up to grommunio.contentpanel will be stripped
		xtypes = xtypes.replace('component/box/container/grommunio.contentpanel','');

		// Then the "grommunio." will be stripped off from all the xtypes like "grommunio.somecontentpanel".
	 ...
	 * placed within the {@link Grommunio.core.ui.ContentPanel ContentPanel}. The
	 * {@link Ext.Container container} will receive a reference to the
	 * {@link Grommunio.core.ui.ContentPanel ContentPanel} into which it has been embedded.
	...
	doClose: function()
	{
		...
		Grommunio.core.data.ContentPanelMgr.unregister(this);
	},
	...
	{
		return 'dialogs/' + Grommunio.core.ui.ContentPanel.superclass.getStateName.call(this);
	},
	...
	getState: function()
	{
		var state = Grommunio.core.ui.ContentPanel.superclass.getState.call(this) || {};
		return Ext.apply(state, this.getSize());
	}
});

Ext.reg('grommunio.contentpanel', Grommunio.core.ui.ContentPanel);
