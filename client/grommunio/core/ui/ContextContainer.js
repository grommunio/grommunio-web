...
/**
 * @class Grommunio.core.ui.ContextContainer
 * @extends Grommunio.core.ui.SwitchViewContentContainer
 *
 ...
 * context.
 */
Grommunio.core.ui.ContextContainer = Ext.extend(Grommunio.core.ui.SwitchViewContentContainer, {
	/**
	...
	constructor: function(config)
	{
		...
		Grommunio.core.ui.ContextContainer.superclass.constructor.call(this, config);
	...
	/**
	 * Handler for the 'contextswitch' event triggered by the Grommunio.core.Container
	...
	/**
	 * Handler for the 'folderchange' event, triggered by Grommunio.core.Container when a folder is selected in the hierarchy
