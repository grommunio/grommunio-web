...
/**
 * @class Grommunio.core.ui.SwitchViewContentContainer
 ...
 */
Grommunio.core.ui.SwitchViewContentContainer = Ext.extend(Ext.Container, {
	/**
	...
	constructor: function(config)
	{
		...
		this.addEvents(
			 ...
			 * @param {Ext.Container} this The {@link Grommunio.core.ui.SwitchViewContentContainer switchcontainer}.
		...
		Grommunio.core.ui.SwitchViewContentContainer.superclass.constructor.call(this, config);
	},
	...
	onLayout: function()
	{
		Grommunio.core.ui.SwitchViewContentContainer.superclass.onLayout.apply(this, arguments);
	...
	{
		var retval = Grommunio.core.ui.SwitchViewContentContainer.superclass.findById.call(this, id);
		if (!retval) {
	...
	{
		var retval = Grommunio.core.ui.SwitchViewContentContainer.superclass.findBy.apply(this, arguments);
...
Ext.reg('grommunio.switchviewcontentcontainer', Grommunio.core.ui.SwitchViewContentContainer);
