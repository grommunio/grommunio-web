...
/**
 * @class Grommunio.core.ui.notifier.ToastPlugin
 ...
 */
Grommunio.core.ui.notifier.ToastPlugin = Ext.extend(Grommunio.core.ui.notifier.NotifyPlugin, {
	/**
	...
	{
		Grommunio.core.ui.notifier.ToastPlugin.superclass.constructor.call(this, config);
		this.activeToasts = {};
	},
	...
	bindToastEvents: function(toast, config)
	{
		...
		if (copyBtn) {
			var copyDetails = function(e) {
				...
				if (text) {
					Grommunio.core.Util.copyToClipboard(text.textContent);
...
Grommunio.onReady(function() {
	...
	var toast = new Grommunio.core.ui.notifier.ToastPlugin();
