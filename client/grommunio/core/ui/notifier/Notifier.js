...
/**
 * @class Grommunio.core.ui.notifier.Notifier
 * @extends Object
 */
Grommunio.core.ui.notifier.Notifier = Ext.extend(Object, {
	/**
	...
	/**
	 * Register the {@link Grommunio.core.ui.notifier.NotifyPlugin NotifyPlugin} to the
	 ...
	 * to be set in the {@link Grommunio.core.SettingsManager Settings}.
	 *
	 * @param {String} name The name how the plugin must be registered.
	 * @param {Grommunio.core.ui.notifier.NotifyPlugin} plugin The plugin which must be registered.
	 */
	...
	/**
	 * Obtain the {@link Grommunio.core.ui.notifier.NotifyPlugin plugin} which should be used
	 ...
	 * searching for a valid plugin, the {@link Grommunio.core.SettingsManager Settings} is consulted to find the
	 ...
	 * @return {Grommunio.core.ui.notifier.NotifyPlugin} The plugin.
	 */
	getPlugin: function(category)
	{
		var setting = 'grommunio/v1/main/notifier/' + category.replace(/\./g, '/') + (category != 'default' ? '/value' : '');
	 ...
	 * On the plugin the {@link Grommunio.core.ui.notifier.NotifyPlugin#notify notify} function is called to display
