...
/**
 * @class Grommunio.core.ui.widget.Widget
 * @extends Ext.ux.Portlet
 * @xtype grommunio.widget
 *
 ...
 */
Grommunio.core.ui.widget.Widget = Ext.extend(Ext.ux.Portlet, {
	/**
	 * @cfg {Grommunio.core.WidgetInfo} info The Widget Meta Data object
	 * which was used to {@link Grommunio.core.Container#registerWidget register}
	 * this Widget to the {@link Grommunio.core.Container container}.
	 */
	info: undefined,

	/**
	 * @cfg {String} guid The unique identifier used for reference to this particular
	 * widget in side a {@link Grommunio.core.ui.widget.WidgetPanel}. This is used for
	 * {@link #set setting} and {@link #get getting} {@link Grommunio.settings.SettingsModel settings}.
	 */
	guid: undefined,
	...
	constructor: function(config)
	{
		...
		Grommunio.core.ui.widget.Widget.superclass.constructor.call(this, config);
	...
	initEvents: function ()
	{
		Grommunio.core.ui.widget.Widget.superclass.initEvents.call(this);
	...
	/**
	 * Event handler which is called after {@link Grommunio.core.ui.MainViewSidebar panel} get layout
	...
	/**
	 * Event handler which is called before {@link Grommunio.core.ui.MainViewSidebar panel} collapse
	...
	onRender: function()
	{
		Grommunio.core.ui.widget.Widget.superclass.onRender.apply(this, arguments);
		this.widgetPanel = this.findParentByType('grommunio.widgetpanel');
	},
	...
	get: function(key)
	{
		return container.getSettingsModel().get(Grommunio.core.ui.widget.Widget.settingsPath(this.guid, key));
	},
	...
	{
		container.getSettingsModel().set(Grommunio.core.ui.widget.Widget.settingsPath(this.guid, key), value);
	},
...
Ext.reg('grommunio.widget', Grommunio.core.ui.widget.Widget);

/**
 * @param {String} guid The unique identifier for a {@link Grommunio.core.ui.widget.Widget widget}.
 * @param {String} key The setting key which should be updated
 * @return {String} The settings path for the guid & key combination.
 * @static
 */
Grommunio.core.ui.widget.Widget.settingsPath = function(guid, key)
{
	return ('grommunio/v1/widgets/' + guid + '/' + key).replace(/(\/)+/,'/');
};
