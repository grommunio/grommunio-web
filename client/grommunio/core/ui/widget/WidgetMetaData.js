...
/**
 * @class Grommunio.core.ui.widget.WidgetMetaData
 * @extends Object
 *
 * The Meta Data object containing the registration details
 * of a {@link Grommunio.core.ui.widget.Widget}. An instance of this object
 * must be passed to {@link Grommunio.core.Container#registerWidget}.
 */
Grommunio.core.ui.widget.WidgetMetaData = Ext.extend(Object, {
	/**
	...
	/**
	 * @cfg {String} about The about text. If provided, {@link Grommunio.core.ui.widget.Widget#registerAboutText}
	 * will be automatically called during {@link Grommunio.core.ui.widget.Widget#initWidget initialization}.
	 */
	about: undefined,

	/**
	 * @cfg {Constructor} WidgetConstructor (required) The constructor of the
	 * {@link Grommunio.core.ui.widgetWidget} which is described by this WidgetMetaData instance.
	 */
	...
	constructor: function(config)
	{
		...
		Grommunio.core.ui.widget.WidgetMetaData.superclass.constructor.call(this, config);
	...
	/**
	 * Obtain the instance of the {@link Grommunio.core.ui.widget.Widget} which is instantiated
	 * using the {@link #widgetConstructor}.
	 * @param {Object} config The configuration object to apply
	 * @return {Grommunio.core.ui.widget.Widget} The Widget instance
	 */
