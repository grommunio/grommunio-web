...
/**
 * @class Grommunio.core.ui.widget.AbstractFolderWidget
 ...
 */
Grommunio.core.ui.widget.AbstractFolderWidget = Ext.extend(Grommunio.core.ui.widget.Widget, {
	/**
	...
	/**
	 * @cfg {Grommunio.core.data.MAPIStore} store The store which is being used for loading the records
	 */
	store: undefined,

	/**
	 * @cfg {String} folderType The folder type to obtain the desired folder
	 * from the {@link Grommunio.hierarchy.data.HierarchyStore hierarchy}.
	 */
	...
	constructor: function (config)
	{
		...
		Grommunio.core.ui.widget.AbstractFolderWidget.superclass.constructor.call(this, config);
	},

	/**
	 * Initialize the event handlers for the {@link #store} and {@link Grommunio.hierarchy.data.HierarchyStore Hierarchy}.
	 * @protected
	 */
	initEvents: function ()
	{
		Grommunio.core.ui.widget.AbstractFolderWidget.superclass.initEvents.apply(this, arguments);
	...
	onDestroy: function ()
	{
		...
		Grommunio.core.ui.widget.AbstractFolderWidget.superclass.onDestroy.apply(this, arguments);
	},
	...
	viewConfigGetRowClass: function (record, rowIndex, rowParams)
	{
		...
		// Render the subject
		var subject = Grommunio.common.ui.grid.Renderers.subject(record.get('subject'), {});
		...
		var rowClass = Grommunio.task.ui.TaskGridView.prototype.viewConfigGetRowClass(record);
