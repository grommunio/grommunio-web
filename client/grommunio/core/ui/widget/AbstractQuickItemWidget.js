...
/**
 * @class Grommunio.core.ui.widget.AbstractQuickItemWidget
 * @extends Grommunio.core.ui.widget.Widget
 *
 ...
 */
Grommunio.core.ui.widget.AbstractQuickItemWidget = Ext.extend(Grommunio.core.ui.widget.Widget, {
	/**
	 ...
	 * {@link Grommunio.core.ui.MessageContentPanel} in the {@link #wrap} property.
	 */
	wrapCfg: undefined,

	/**
	 * The embedded {@link Grommunio.core.ui.MessageContentPanel} which handles
	 * the sending/saving of the {@link #record}.
	 * @property
	 * @type Grommunio.core.ui.MessageContentPanel
	 * @protected
	 */
	wrap: undefined,
	...
	constructor: function(config)
	{
		...
		this.wrap = new Grommunio.core.ui.MessageContentPanel(config.wrapCfg);
		...
		Grommunio.core.ui.widget.AbstractQuickItemWidget.superclass.constructor.call(this, config);
	},
	...
	initWidget: function()
	{
		Grommunio.core.ui.widget.AbstractQuickItemWidget.superclass.initWidget.apply(this, arguments);
	...
	initEvents: function()
	{
		Grommunio.core.ui.widget.AbstractQuickItemWidget.superclass.initEvents.apply(this, arguments);
	 ...
	 * {@link Grommunio.core.data.UIFactory#openCreateRecord opening it in a new dialog}.
	...
	dialog: function()
	{
		...
		Grommunio.core.data.UIFactory.openCreateRecord(this.record);
	 ...
	 * {@link Grommunio.core.ui.MessageContentPanel#setRecord set it} to the {@link #wrap}.
	 * protected
	 */
	reset: function()
	{
	 ...
	 * This will check if the {@link Grommunio.core.Container#getHierarchyStore hierarchy}
	 ...
	 * active, this will {@link Grommunio.core.data.ShadowStore#remove remove} the
	 * {@link #record} from the {@link Grommunio.core.data.ShadowStore ShadowStore}.
	 * @protected
	 */
	onDestroy: function()
	{
		Grommunio.core.ui.widget.AbstractQuickItemWidget.superclass.onDestroy.apply(this, arguments);
	...
	onBodyChange: function(field, newValue, oldValue)
	{
		...
		if (field.isXType && field.isXType('grommunio.htmleditor')) {
	 ...
	 * This will call {@link Grommunio.core.ui.MessageContentPanel#saveRecord} to start
	 * sending the mail.
	 * @private
	 */
	onSave: function()
