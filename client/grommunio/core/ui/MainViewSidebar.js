...
/**
 * @class Grommunio.core.ui.MainViewSidebar
 * @extends Ext.Panel
 * @xtype mainviewsidebar
 *
 * The sidebars for the {@link Grommunio.core.ui.MainViewport Main Viewport}
 * which support {@link #collapse collapsing} and {@link #stateful}.
 */
Grommunio.core.ui.MainViewSidebar = Ext.extend(Ext.Panel, {

	/**
	 * {@link Ext.QuickTips tooltip} message for {@link Grommunio.core.ui.MainViewSidebar panel}
	...
	constructor: function(config)
	{
		...
		Grommunio.core.ui.MainViewSidebar.superclass.constructor.call(this, config);
	},
...
Ext.reg('mainviewsidebar', Grommunio.core.ui.MainViewSidebar);
