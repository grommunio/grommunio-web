...
/**
 * @class Grommunio.core.PingService
 ...
 */
Grommunio.core.PingService = Ext.extend(Ext.util.Observable, {
	...
	constructor: function(config)
	{
		...
		this.addEvents(
			 ...
			 * @param {Grommunio.core.PingService} service This object
		...
		Grommunio.core.PingService.superclass.constructor.call(this, config);
