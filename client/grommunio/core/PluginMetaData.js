...
/**
 * @class Grommunio.core.PluginMetaData
 * @extends Object
 *
 * The Meta Data object containing the registration details
 * of a {@link Grommunio.core.Plugin}. An instance of this object
 * must be passed to {@link Grommunio.core.Container#registerPlugin}.
 */
Grommunio.core.PluginMetaData = Ext.extend(Object, {
	/**
	 ...
	 * in the {@link Grommunio.settings.SettingsModel settings} in which the settings
	 * for this {@link Grommunio.core.Plugin plugin} are being saved. If not provided,
	...
	/**
	 * @cfg {String} about The about text. If provided, {@link Grommunio.core.Plugin#registerAboutText}
	 * will be automatically called during {@link Grommunio.core.Plugin#initPlugin initialization}.
	 */
	about: undefined,
	 ...
	 * {@link Grommunio.core.Plugin} which is described by this PluginMetaData instance.
	 */
	pluginConstructor: undefined,

	/**
	 * The instance of the {@link Grommunio.core.Plugin} (instantiated using the
	 * {@link #pluginConstructor}). This is obtained using the {@link #getInstance}
	 * function.
	 * @property
	 * @type Grommunio.core.Plugin
	 * @private
	 */
	instance: undefined,
	...
	constructor: function(config)
	{
		...
		Grommunio.core.PluginMetaData.superclass.constructor.call(this, config);
	...
	/**
	 * Obtain the base path for the {@link Grommunio.settings.SettingsModel settings} in which the settings
	...
	{
		return 'grommunio/v1/plugins/' + this.settingsName;
	},

	/**
	 * Obtain the instance of the {@link Grommunio.core.Plugin} which is instantiated
	 ...
	 * {@link Grommunio.core.Plugin} is allowed to be instantiated.
	 * property.
	 * @return {Grommunio.core.Plugin} The Plugin instance
	 */
