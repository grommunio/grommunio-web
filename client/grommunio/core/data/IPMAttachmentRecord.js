...
/**
 * @class Grommunio.core.data.IPMAttachmentRecordFields
 *
 * Array of default fields for the {@link Grommunio.core.data.IPMAttachmentRecord} object.
 * These fields will always be added, regardless of the exact type of
 * {@link Grommunio.core.data.IPMAttachmentRecord record}.
 *
 ...
 */
Grommunio.core.data.IPMAttachmentRecordFields = [
	{name: 'object_type', type: 'int', defaultValue: Grommunio.core.mapi.ObjectType.MAPI_ATTACH},
	{name: 'attach_num', type: 'int', defaultValue: -1},
	{name: 'attach_method', type: 'int', defaultValue: Grommunio.core.mapi.AttachMethod.NO_ATTACHMENT},
...
/**
 * @class Grommunio.core.data.IPMAttachmentRecord
 * @extends Ext.data.Record
 */
Grommunio.core.data.IPMAttachmentRecord = Ext.extend(Ext.data.Record, {
	/**
	...
	/**
	 * Applies all data from an {@link Grommunio.core.data.IPMAttachmentRecord IPMAttachmentRecord}
	 * to this instance. This will update all data.
	 *
	 * @param {Grommunio.core.data.IPMAttachmentRecord} record The record to apply to this
	 * @return {Grommunio.core.data.IPMAttachmentRecord} this
	 */
	...
	copy: function(newId)
	{
		var copy = Grommunio.core.data.IPMAttachmentRecord.superclass.copy.call(this, newId);
	...
	{
		return this.isHidden() && Grommunio.core.MessageClass.isClass(this.get('attach_message_class'), 'IPM.OLE.CLASS.{00061055-0000-0000-C000-000000000046}');
	},
	...
	/**
	 * Checks if {@link Grommunio.core.data.IPMAttachmentRecord IPMAttachmentRecord} is embedded message
	 * @return {Boolean} true if attachment record is an embedded message
	 */
	isEmbeddedMessage: function()
	{
		return this.get('attach_method') === Grommunio.core.mapi.AttachMethod.ATTACH_EMBEDDED_MSG && !this.isRecurrenceException();
	},
	...
	canBeImported: function()
	{
		...
		if (this.isEmbeddedMessage()) {
			isSupportedExtension = Grommunio.core.MessageClass.isClass(this.get('attach_message_class'), ['IPM.Note', 'IPM.Contact', 'IPM.TaskRequest', 'IPM.Schedule.Meeting.Resp', 'IPM.Schedule.Meeting.Request' ,'REPORT.IPM.Note'], true);
		} else {
	 ...
	 * @param {Grommunio.core.data.IPMRecord} parentRecord parent record that holds this attachment
	...
	/**
	 * Convert this attachment into a {@link Grommunio.core.data.IPMRecord record}.
	 *
	 * @return {Grommunio.core.data.IPMRecord} The IPMRecord which is an embedded message as attachment.
	 */
...
Grommunio.core.data.RecordFactory.setBaseClassToObjectType(Grommunio.core.mapi.ObjectType.MAPI_ATTACH, Grommunio.core.data.IPMAttachmentRecord);
Grommunio.core.data.RecordFactory.addFieldToObjectType(Grommunio.core.mapi.ObjectType.MAPI_ATTACH, Grommunio.core.data.IPMAttachmentRecordFields);
