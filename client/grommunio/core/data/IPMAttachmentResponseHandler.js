...
/**
 * @class Grommunio.core.data.IPMAttachmentResponseHandler
 * @extends Grommunio.core.data.ProxyResponseHandler
 *
 * A special response handler for the {@link Grommunio.core.data.IPMAttachmentProxy Attachment Proxy}
 * which can handle responses from the 'upload_attachments' server instruction.
 */
Grommunio.core.data.IPMAttachmentResponseHandler = Ext.extend(Grommunio.core.data.ProxyResponseHandler, {
	/**
