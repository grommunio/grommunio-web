...
/**
 * @class Grommunio.core.data.IPMAttachmentProxy
 * @extends Grommunio.core.data.MAPIProxy
 *
 * Special Proxy for the {@link Grommunio.core.data.IPMAttachmentStore Attachment Store}.
 */
Grommunio.core.data.IPMAttachmentProxy = Ext.extend(Grommunio.core.data.MAPIProxy, {
	/**
	...
	{
		return new Grommunio.core.data.IPMAttachmentResponseHandler({
			proxy: this,
			action: action,
			reader: reader,
			sendRecords: records,
	...
	{
		this.doRequests(args.actionType || Grommunio.core.Actions['upload'], action, records, parameters, reader, callback, scope, args);
	},
