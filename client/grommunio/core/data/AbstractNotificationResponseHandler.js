...
/**
 * @class Grommunio.core.data.AbstractNotificationResponseHandler
 ...
 * and is to be used by the {@link Grommunio.core.ResponseRouter ResponseRouter} to
 * process these notifications.
 */
Grommunio.core.data.AbstractNotificationResponseHandler = Ext.extend(Grommunio.core.data.AbstractResponseHandler, {
	/**
	 ...
	 * <li><b>action</b>: Grommunio.core.data.Notifications<p class="sub-desc">The notification action</p></li>
