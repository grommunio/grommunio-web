...
/**
 * @class Grommunio.core.data.JsonAttachmentWriter
 * @extends Grommunio.core.data.JsonWriter
 */
Grommunio.core.data.JsonAttachmentWriter = Ext.extend(Grommunio.core.data.JsonWriter, {
	/**
	 * Similar to {@link Ext.data.JsonWriter#toHash}
	 *
	 * Convert attachments into a hash. Attachments exists as
	 * {@link Grommunio.core.data.IPMAttachmentRecord IPMAttachmentRecord} within
