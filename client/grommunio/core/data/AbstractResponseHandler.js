...
/**
 * @class Grommunio.core.data.AbstractResponseHandler
 * @extends Object
 *
 * The main interface used by the {@link Grommunio.core.ResponseRouter ResponseRouter}
 ...
 * {@link Grommunio.core.ResponseRouter ResponseRouter} starts processing
 ...
 * they need. Each {@link Grommunio.core.Actions} action will invoke the handler
 * with the same name but with 'do' prefixed. For example, the action
 * {@link Grommunio.core.Actions#item} will cause the function 'doItem' to be
 * invoked. Likewise, the action {@link Grommunio.core.Actions#open} will cause
 ...
 */
Grommunio.core.data.AbstractResponseHandler = Ext.extend(Object, {
	/**
	 * @constructor
