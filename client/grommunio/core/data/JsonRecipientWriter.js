...
/**
 * @class Grommunio.core.data.JsonRecipientWriter
 * @extends Grommunio.core.data.JsonWriter
 */
Grommunio.core.data.JsonRecipientWriter = Ext.extend(Grommunio.core.data.JsonWriter, {
	/**
	 * Similar to {@link Ext.data.JsonWriter#toHash}
	 *
	 * Convert recipients into a hash. Recipients exists as
	 * {@link Grommunio.core.data.IPMRecipientRecord IPMRecipientRecord} within
