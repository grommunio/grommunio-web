...
/**
 * @class Grommunio.core.data.CompositeResponseHandler
 * @extends Grommunio.core.data.AbstractResponseHandler
 *
 * This class specializes in wrapping multiple {@link Grommunio.core.data.AbstractResponseHandler AbstractResponseHandler}
 * objects into a single interface to be used by the {@link Grommunio.core.ResponseRouter ResponseRouter}.
 *
 * Each call into this class, will result in the same call into each {@link Grommunio.core.data.AbstractResponseHandler sub-handler}.
 */
Grommunio.core.data.CompositeResponseHandler = Ext.extend(Grommunio.core.data.AbstractResponseHandler, {
	/**
	 * @cfg {Grommunio.core.data.AbstractResponseHandler[]} handlers The array of notification handlers
	 * which have been wrapped by this composite handler.
	 */
	handlers: undefined,

	/**
	 * Array of objects containing the {@link Grommunio.core.data.AbstractResponseHandler ResponseHandlers} which
