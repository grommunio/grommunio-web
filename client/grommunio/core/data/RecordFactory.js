...
/**
 * @class Grommunio.core.data.RecordFactory
 ...
 * can be configured by {@link Grommunio.core.Context contexts} and {@link Grommunio.core.Plugin plugins}
 ...
 * we have the {@link Grommunio.core.data.RecordCustomObjectType Custom Type} definitions to which
 * they can register their custom type, which can then be used to work together with
 * the record factory.
 *
 * @singleton
 */
Grommunio.core.data.RecordFactory = {
	/**
	 * Key-value map of {@link Grommunio.core.data.RecordDefinition} as registered by
	...
	/**
	 * Obtain the parent {@link Grommunio.core.data.RecordDefinition RecordDefinition}
	 * for this messageclass.
	 * @param {String} The messageclass for the parent is searched for
	 * @return {Grommunio.core.data.RecordDefinition} The parent record definition.
	...
	/**
	 * Create a new {@link Grommunio.core.data.RecordDefinition RecordDefinition}
	 * for the given key value.
	 *
	 * @param {Mixed} key The key value on how the definition is stored
	 * in the definitions table.
	 * @param {Grommunio.core.data.RecordDefinition} parent The parent record
	 * definition.
	 * @param {Object} defaults The default values which must be applied to
	 * the record definition.
	 * @return {Grommunio.core.data.RecordDefinition} The new record definition.
	 */
	createRecordDefinition: function(key, parent, defaults)
	{
		var definition = new Grommunio.core.data.RecordDefinition({
			base: undefined,
			parent: parent,
	...
	/**
	 * Obtain the {@link Grommunio.core.data.RecordDefinition RecordDefinition} object
	 * which belongs to the given custom type. If the custom type is previously unknown
	 * and the {@link Grommunio.core.data.RecordDefinition definition} does not exist,
	 * a new {@link Grommunio.core.data.RecordDefinition definition} will be created and
	 * returned.
	 *
	 * @param {Grommunio.core.data.RecordCustomObjectType} customType The custom type for which the definition is requested.
	 * @return {Grommunio.core.data.RecordDefinition} The definition object for the custom type
	 * @private
	 */
	 ...
	 * returned.
	 *
	 * @param {Grommunio.core.mapi.ObjectType} objectType The object type for which the definition is requested.
	 * @return {Grommunio.core.data.RecordDefinition} The definition object for the object type
	 * @private
	 */
	 ...
	 * @return {Grommunio.core.data.RecordDefinition} The definition object for the messageclass.
	 * @private
	 */
	getRecordDefinitionByMessageClass: function(messageClass)
	{
		...
		if (!Ext.isDefined(parent)){
			 ...
			 * this particular record not able to use Grommunio.core.data.IPMRecord functions.
			 *
	 ...
	 *
	 * @param {Grommunio.core.data.RecordCustomObjectType} customType The custom type for which
	 ...
	 *
	 * @param {Grommunio.core.mapi.ObjectType} objectType The object type for which
	 * the record is created.
	 * @param {Object} data (Optional) An object, the properties of which provide
	 * values for the new Record's fields. If not specified the {@link Ext.data.Field.defaultValue}
	 * for each field will be assigned.
	 ...
	 *
	 * @param {Grommunio.core.data.RecordCustomObjectType} customType The object type for which the
	 ...
	 * objects which is completely tuned for the given object type.
	 *
	 * @param {Grommunio.core.mapi.ObjectType} objectType The object type for which the
	 * record class is requested
	 * @return {Class} The record class definition
	 */
	...
	/**
	 * This will set a new base class on the {@link Grommunio.core.data.RecordDefinition definition}.
	 ...
	 * in the {@link Grommunio.core.data.RecordDefinition definition}. Inside
	 * a SubStore a Table can be loaded like Attachments, recipients, members, etc.
	 *
	 * @param {Grommunio.core.data.RecordCustomObjectType} customType The custom type for which the
	 ...
	 * {@link Grommunio.core.data.RecordDefinition definition}.
	 *
	 * @param {Grommunio.core.data.RecordCustomObjectType} customType The custom type to which the field
	 * should be added.
	 ...
	 * {@link Grommunio.core.data.RecordDefinition definition}.
	 *
	 * @param {Grommunio.core.mapi.ObjectType} objectType The object type to which the field
	 * should be added.
	 * @param {String/Ext.data.Field} field The field which must be added.
	 */
	 ...
	 * to the {@link Grommunio.core.data.RecordDefinition definition}. When
	 * creating a new local item
	 * ({@link Grommunio.core.data.RecordFactory.createRecordObjectByCustomType createRecordObjectByCustomType}
	 * with the phantom argument to true) the default values which be applied
	 * to the newly created {@link Ext.data.Record record}.
	 *
	 * @param {Grommunio.core.data.RecordCustomObjectType} customType The custom type to which the field belongs
	 ...
	 * to the {@link Grommunio.core.data.RecordDefinition definition}. When
	 * creating a new local item
	 * ({@link Grommunio.core.data.RecordFactory.createRecordObjectByObjectType createRecordObjectByObjectType}
	 * with the phantom argument to true) the default values which be applied
	 * to the newly created {@link Ext.data.Record record}.
	 *
	 * @param {Grommunio.core.mapi.ObjectType} objectType The object type to which the field belongs
	 * @param {String/Ext.data.Field} field The field for which the default
	 * value should be applied
	 * @param {Mixed} defaultValue the default value for the given fieldname
	 */
	 ...
	 * to the {@link Grommunio.core.data.RecordDefinition definition}. When
	 * creating a new local item
	 * ({@link Grommunio.core.data.RecordFactory.createRecordObjectByMessageClass createRecordObjectByMessageClass}
	 * with the phantom argument to true) the default values which be applied
	 * to the newly created {@link Ext.data.Record record}.
	 *
	...
	/**
	 * Appends an event handler to the {@link Grommunio.core.data.RecordDefinition RecordDefinition}
	 * for the given CustomType.
	 * @param {Grommunio.core.data.RecordCustomObjectType} customType The custom type to which the event must be added
	 ...
	 * @param {Grommunio.core.mapi.ObjectType} objectType The object type to which the event must be added
	 * @param {String} eventName The name of the event to listen for
	 * @param {Function} handler The method the event invokes
	 * @param {Object} scope (optional) The scope (this reference) in which the handler function is executed.
	 * If omitted, defaults to the object which fired the event.
