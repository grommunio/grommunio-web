...
/**
 * @class Grommunio.core.data.StatefulObservable
 ...
 */
Grommunio.core.data.StatefulObservable = Ext.extend(Ext.util.Observable, {
	/**
	...
	constructor: function(config)
	{
		...
		Grommunio.core.data.StatefulObservable.superclass.constructor.call(this, config);
