...
/**
 * @class Grommunio.core.data.MAPIProxy
 * @extends Ext.data.DataProxy
 */
Grommunio.core.data.MAPIProxy = Ext.extend(Ext.data.DataProxy, {
	/**
	...
	/**
	 * Currently active requests for {@link Grommunio.core.data.MAPIProxy MAPIProxy} mapped by the
	 * action type used in requests, {@link Grommunio.core.data.MAPIProxy MAPIProxy} can use this
	 ...
	 * a given {@link Grommunio.core.Actions action}.
	 * @property
	 * @type Object
	 * @private
	 */
	...
	constructor: function(config)
	{
		...
		Grommunio.core.data.MAPIProxy.superclass.constructor.call(this, config);
	 ...
	 *
	 * @param {Grommunio.core.Action} action The action which is to be checked.
	 ...
	 * @param {Grommunio.core.Actions} action The action for which this request id was generated
	 ...
	 * @param {Grommunio.core.Actions} requestId The unique id which was given to the request.
	 */
	 ...
	 * This will call {@link Grommunio.core.Request#cancelActiveRequest} to cancel
	 * the response handling of all requests which were send out by this proxy for
	 * the given action.
	 * @param {Grommunio.core.Actions} action The action
	 * @protected
	 */
	 ...
	 * @param {Grommunio.core.data.MAPIRecord} record the record for which the listModuleName is requested
	 ...
	 * @param {Grommunio.core.data.MAPIRecord} record the record for which the itemModuleName is requested
	...
	{
		this.doRequests(args.actionType || Grommunio.core.Actions['save'], action, records, parameters, reader, callback, scope, args);
	},
	...
	{
		this.doRequests(args.actionType || Grommunio.core.Actions['delete'], action, records, parameters, reader, callback, scope, args);
	},
	...
	{
		this.doRequests(args.actionType || Grommunio.core.Actions['open'], action, records, parameters, reader, callback, scope, args);
	},
	...
	{
		this.doRequests(args.actionType || Grommunio.core.Actions['import'], action, records, parameters, reader, callback, scope, args);
	},
	...
	{
		this.doRequests(args.actionType || Grommunio.core.Actions['list'], action, records, parameters, reader, callback, scope, args);
	},

	/**
	 * Initialize the {@link Grommunio.core.Request request} structure. The initial
	 * {@link Grommunio.core.Request request} will be reset and new requests will be added
	 * for each individual {@link Grommunio.core.date.MAPIRecord record} which was provided.
	 * @param {Grommunio.core.Actions} serverAction The action to perform on the server.
	 * @param {Ext.data.Api.action} action name of the action to perform.
	 * @param {Ext.data.Record[]} records list of records to operate on.
	 * @param {Object} parameters object containing user parameters such as range (pagination) information, sorting information, etc.
