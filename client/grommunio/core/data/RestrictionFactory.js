...
/*
 * #dependsFile client/grommunio/core/mapi/Restrictions.js
 */
Ext.namespace('Grommunio.core.data');

/**
 * @class Grommunio.core.data.RestrictionFactory
 *
 ...
 * @singleton
 */
Grommunio.core.data.RestrictionFactory = {
	/**
	...
	createResAnd: function(restrictionsArray) {
		return [
			Grommunio.core.mapi.Restrictions.RES_AND,
	...
	createResOr: function(restrictionsArray) {
		return [
			Grommunio.core.mapi.Restrictions.RES_OR,
			restrictionsArray.clone()
		];
	},
	...
	createResNot: function(subRestriction) {
		return [
			Grommunio.core.mapi.Restrictions.RES_NOT,
			subRestriction
		];
	},
	...
	createResCompareProps: function(propTag1, propTag2) {
		var res = [],
			resCondition = Grommunio.core.mapi.Restrictions.RES_COMPAREPROPS,
			resValues = {};

		resValues[Grommunio.core.mapi.Restrictions.ULPROPTAG1] = propTag1;
		resValues[Grommunio.core.mapi.Restrictions.ULPROPTAG2] = propTag2;
	...
	createResSubRestriction: function(propTag, subRestriction) {
		var res = [],
			resCondition = Grommunio.core.mapi.Restrictions.RES_SUBRESTRICTION,
			resValues = {};

		resValues[Grommunio.core.mapi.Restrictions.ULPROPTAG] = propTag;
		resValues[Grommunio.core.mapi.Restrictions.RESTRICTION] = subRestriction;
	...
	createPropertyObject: function(propTag, propValue, propTagForValue) {
		...
		prop[Grommunio.core.mapi.Restrictions.ULPROPTAG] = propTag;
		prop[Grommunio.core.mapi.Restrictions.VALUE] = {};
		prop[Grommunio.core.mapi.Restrictions.VALUE][propTagForValue] = propValue;
	...
	dataResComment: function(subRestriction, propertiesArray) {
		var res = [];
		var resCondition = Grommunio.core.mapi.Restrictions.RES_COMMENT;
		var resValues = {};

		resValues[Grommunio.core.mapi.Restrictions.RESTRICTION] = subRestriction;
		resValues[Grommunio.core.mapi.Restrictions.PROPS] = propertiesArray;
	...
	dataResProperty: function(propTag, relOp, propValue, propTagForValue) {
		var res = [],
			resCondition = Grommunio.core.mapi.Restrictions.RES_PROPERTY,
			resValues = {};
		...
		resValues[Grommunio.core.mapi.Restrictions.RELOP] = relOp;
		resValues[Grommunio.core.mapi.Restrictions.ULPROPTAG] = propTag;
		resValues[Grommunio.core.mapi.Restrictions.VALUE] = {};
		resValues[Grommunio.core.mapi.Restrictions.VALUE][propTagForValue] = propValue;
	...
	dataResExist: function(propTag) {
		var res = [],
			resCondition = Grommunio.core.mapi.Restrictions.RES_EXIST,
			resValues = {};
	...
	dataResSize: function(propTag, relOp, sizeValue) {
		var res = [],
			resCondition = Grommunio.core.mapi.Restrictions.RES_SIZE,
			resValues = {};

		resValues[Grommunio.core.mapi.Restrictions.ULPROPTAG] = propTag;
		resValues[Grommunio.core.mapi.Restrictions.RELOP] = relOp;
		resValues[Grommunio.core.mapi.Restrictions.CB] = sizeValue;
	...
	dataResBitmask: function(propTag, bitMaskType, bitMaskValue) {
		var res = [],
			resCondition = Grommunio.core.mapi.Restrictions.RES_BITMASK,
			resValues = {};

		resValues[Grommunio.core.mapi.Restrictions.ULPROPTAG] = propTag;
		resValues[Grommunio.core.mapi.Restrictions.ULTYPE] = bitMaskType;
		resValues[Grommunio.core.mapi.Restrictions.ULMASK] = bitMaskValue;
	...
	dataResContent: function(propTag, fuzzyLevel, propValue, propTagForValue) {
		var res = [],
			resCondition = Grommunio.core.mapi.Restrictions.RES_CONTENT,
			resValues = {};
		...
		resValues[Grommunio.core.mapi.Restrictions.FUZZYLEVEL] = Grommunio.core.mapi.Restrictions.FL_FULLSTRING;
		if(Ext.isObject(fuzzyLevel)) {
			Ext.each(fuzzyLevel, function(fuzzyFlag) {
				resValues[Grommunio.core.mapi.Restrictions.FUZZYLEVEL] += fuzzyFlag;
			});
		} else {
			resValues[Grommunio.core.mapi.Restrictions.FUZZYLEVEL] = fuzzyLevel;
		}
		resValues[Grommunio.core.mapi.Restrictions.ULPROPTAG] = propTag;
		resValues[Grommunio.core.mapi.Restrictions.VALUE] = {};
		resValues[Grommunio.core.mapi.Restrictions.VALUE][propTagForValue] = propValue;
