...
/**
 * @class Grommunio.core.data.IPFRecord
 * @extends Grommunio.core.data.MAPIRecord
 *
 */
Grommunio.core.data.IPFRecord = Ext.extend(Grommunio.core.data.MAPIRecord, {
	/**
	 ...
	 * on this record. This comparison is done case-insensitive. See {@link Grommunio.core.ContainerClass#isClass}
	 * for further details.
	 *
	...
	{
		return Grommunio.core.ContainerClass.isClass(this.get('container_class'), className, baseOnly);
	}
});
