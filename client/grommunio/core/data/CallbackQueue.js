...
/**
 * @class Grommunio.core.data.CallbackQueue
 ...
 */
Grommunio.core.data.CallbackQueue = Ext.extend(Ext.util.Observable, {
	/**
	...
	constructor: function(config)
	{
		...
		this.addEvents(
			 ...
			 * @param {Grommunio.core.data.CallbackQueue} queue The queue which is started
			 */
			'startqueue',
			/**
			 * @event completequeue
			 * Event which is fired when the last callback from the queue has been completed.
			 * @param {Grommunio.core.data.CallbackQueue} queue The queue which has completed
			 ...
			 * @param {Grommunio.core.data.CallbackQueue} queue The queue to which the task belongs
		...
		Grommunio.core.data.CallbackQueue.superclass.constructor.call(this, config);
	},
