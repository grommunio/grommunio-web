...
/**
 * @class Grommunio.core.data.NoSyncStore
 * @extends Ext.util.Observable
 *
 * The {@link Grommunio.core.data.NoSyncStore NoSyncStore} represents the collection of
 * {@link Ext.data.Record records}. It offers the same interface
 * as {@link Grommunio.core.data.Store Store} without any CRUD operations being
 * send to the server. This implies that the {@link Grommunio.core.data.NoSyncStore NoSyncStore}
 * will only work for working on {@link Ext.data.Record records} offline.
 */
Grommunio.core.data.NoSyncStore = Ext.extend(Ext.util.Observable, {
	/**
	...
	Ext.data.Record.COMMIT
		...
		Grommunio.core.data.NoSyncStore.superclass.constructor.call(this, config);
	...
	/**
	 * Initialize events which can be raised by the {@link Grommunio.core.data.NoSyncStore NoSyncStore}
	 * @private
	 */
	initEvents: function()
	{
	...
	/**
	 * 'Commit' outstanding changes. Since {@link Grommunio.core.data.NoSyncStore NoSyncStore}
