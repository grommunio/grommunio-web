...
/**
 * @class Grommunio.core.data.SettingsStateProvider
 * @type Ext.state.Provider
 *
 * A special {@link Ext.state.Provider} for the {@link Ext.state.Manager}
 * which stores the state of {@link Grommunio.core.ui.ContentPanel content panels}, {@link Ext.Panel panels}
 * and {@link Ext.grid.GridPanel grids} into the {@link Grommunio.settings.SettingsModel settings}.
 */
Grommunio.core.data.SettingsStateProvider = Ext.extend(Ext.state.Provider, {

	/**
	 * @cfg {String} basePath The base path of the {@link Grommunio.settings.SettingsModel settings}
	 * in which all State settings must be saved. The complete name for a settings path is generated
	 * by {@link #getStatePath}.
	 */
	basePath: 'grommunio/v1/state',
	...
	constructor: function(config)
	{
		...
		Grommunio.core.data.SettingsStateProvider.superclass.constructor.call(this, config);
	},

	/**
	 * Create the path of the {@link Grommunio.settings.SettingsModel settings}
