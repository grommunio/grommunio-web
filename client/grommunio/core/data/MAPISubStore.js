...
/**
 * #dependsFile client/grommunio/core/data/MAPIStore.js
 */
Ext.namespace('Grommunio.core.data');

/**
 * @class Grommunio.core.data.MAPISubStore
 * @extends Grommunio.core.data.NoSyncStore
 */
Grommunio.core.data.MAPISubStore = Ext.extend(Grommunio.core.data.NoSyncStore, {
	/**
	...
	/**
	 * @cfg {Grommunio.core.data.JsonReader} reader The {@link Grommunio.core.data.JsonReader Reader} object which processes the
	 * data object and returns an Array of {@link Grommunio.core.data.MAPIRecord MAPIRecord} objects which are cached keyed by their
	 * <b><tt>{@link Grommunio.core.data.MAPIRecord#id id}</tt></b> property.
	 */
	reader: undefined,

	/**
	 * @cfg {Grommunio.core.data.JsonWriter} writer
	 * <p>The {@link Grommunio.core.data.JsonWriter Writer} object which processes a record object for being written
	...
	constructor: function(config)
	{
		...
		Grommunio.core.data.MAPISubStore.superclass.constructor.call(this, config);
	},
	...
	createRecords: function(store, record, index)
	{
		...
		Grommunio.core.data.MAPISubStore.superclass.createRecords.call(this, store, record, index);
	},

	/**
	 * Get the {@link Grommunio.core.data.MAPIRecord IPMRecord} that is the parent of this store.
	 * @return {Grommunio.core.data.MAPIRecord} The parent IPMRecord.
	 */
	...
	/**
	 * Set the {@link Grommunio.core.data.MAPIRecord IPMRecord} that is the parent of this store.
	 * @param {Grommunio.core.data.MAPIRecord} record The parent IPMRecord.
	 */
	...
	getById: function(id)
	{
		...
		var item = Grommunio.core.data.MAPISubStore.superclass.getById.call(this, id);
		...
		if (!item) {
			...
			if (this.reader.meta.idProperty === 'entryid') {
				index = this.findBy(function(record) { return Grommunio.core.EntryId.compareEntryIds(id, record.id); });
			} else if (this.reader.meta.idProperty === 'store_entryid') {
				index = this.findBy(function(record) { return Grommunio.core.EntryId.compareStoreEntryIds(id, record.id); });
			}
	 ...
	 */
	filterBy: Grommunio.core.data.MAPIStore.prototype.filterBy,
	 ...
	 */
	clearFilter: Grommunio.core.data.MAPIStore.prototype.clearFilter,
