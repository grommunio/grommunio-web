...
/**
 * @class Grommunio.core.data.IPMProxy
 ...
 */
Grommunio.core.data.IPMProxy = Ext.extend(Grommunio.core.data.MAPIProxy, {
	/**
	...
	/**
	 * Implementation of {@link Grommunio.core.data.MAPIProxy.readAction}
	...
	readAction: function(action, records, parameters, reader, callback, scope, args)
	{
		...
		Grommunio.core.data.IPMProxy.superclass.readAction.call(this, action, records, parameters, reader, callback, scope, args);
	}
});
