...
/**
 * @class Grommunio.core.data.RecordDefinition
 ...
 * {@link Grommunio.core.data.RecordFactory RecordFactory}.
 */
Grommunio.core.data.RecordDefinition = Ext.extend(Ext.util.Observable, {
	/**
	 * @cfg {Grommunio.core.data.RecordDefinition} parent The parent record definition for this definition.
	 */
	parent: undefined,

	/**
	 * The object class definition for the record.
	 * This type is always a subclass of the {@link Grommunio.core.data.RecordDefinition.base base},
	 * field within this {@link Grommunio.core.data.RecordDefinition definition}.
	 * @property
	 * @type Class
	 * @private
	 */
	 ...
	 * of the {@link Grommunio.core.data.SubStore SubStore} which must be used for the given subStore.
	 *
	 * This is applied on the {@link #cfg} object and can be changed as long as no record has been
	 * created using this definition yet, after that this property can no longer be used.
	 */
	 ...
	 * This is mapped on the server to MAPI properties which are stored in the grommunio-server.
	 *
	 * This is applied on the {@link #cfg} object and can be changed as long as no record has been
	 * created using this definition yet, after that this property can no longer be used.
	 */
	...
	constructor: function(config)
	{
		this.addEvents([
			/**
			 * @event createphantom
			 * Fires when the {@link Grommunio.core.data.RecordFactory RecordFactory} has
		...
		Grommunio.core.data.RecordDefinition.superclass.constructor.call(this, config);
	},

	/**
	 * Create a new {@link Ext.data.Record record} object
	 * based on this {@link Grommunio.core.data.RecordDefinition definition}.
	 *
	 ...
	 * the {@link Grommunio.core.data.RecordFactory Record Factory} which are obtained
	 ...
	 * {@link Grommunio.core.data.RecordDefinition#base base}.
	...
	getType: function()
	{
		if (!Ext.isDefined(this.type)) {
			...
			this.type = Grommunio.core.data.Record.create(fields, baseClass);
		}
		return this.type;
	},

	/**
	 * Set the {@link #base} class for the {@link Grommunio.core.data.RecordDefinition definition}.
	 *
	 ...
	 * from this {@link Grommunio.core.data.RecordDefinition definition}. If
	 ...
	 * this {@link Grommunio.core.data.RecordDefinition definition}. This object
	 * is used to {@link Grommunio.core.data.MAPIRecord#setSubStoreTypes set} on
	 * the {@link Grommunio.core.data.MAPIRecord MAPIRecord} which is created.
	...
	/**
	 * Add a {@link Ext.data.Field field} to the {@link Grommunio.core.data.RecordDefinition definition}.
	 *
	 * NOTE: If {@link #createRecord} has been called, then changes made by this function will
	 * no longer have effect.
	 *
	 ...
	 * for this {@link Grommunio.core.data.RecordDefinition definition}.
	 ...
	 * which have been set for the {@link Grommunio.core.data.RecordDefinition definition}.
	 *
	...
	fireEvent: function()
	{
		...
		Grommunio.core.data.RecordDefinition.superclass.fireEvent.apply(this, arguments);
	}
});
