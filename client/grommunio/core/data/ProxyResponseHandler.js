...
/**
 * @class Grommunio.core.data.ProxyResponseHandler
 * @extends Grommunio.core.data.AbstractResponseHandler
 *
 * A Simple implementation for a {@link Grommunio.core.data.AbstractResponseHandler ResponseHandler}.
 ...
 */
Grommunio.core.data.ProxyResponseHandler = Ext.extend(Grommunio.core.data.AbstractResponseHandler, {
	/**
	 ...
	 * if the {@link Grommunio.core.data.JsonReader JsonReader} is used, and which function is called.
	 * See {@link Grommunio.core.data.JsonReader#readResponse readResponse} and
	 * {@link Grommunio.core.data.JsonReader#readRecords readRecords} for possible return values)
	 ...
	 * @param {Grommunio.core.Actions} action The action which must be executed.
	...
	handle: function(action, data)
	{
		var ret;
		try {
			ret = Grommunio.core.data.ProxyResponseHandler.superclass.handle.call(this, action, data);
		} catch(e) {
	 ...
	 * {@link Grommunio.core.data.UndoManager UndoManager} can pick it up after
	 ...
	 * @param {Grommunio.core.data.MAPIRecord} record The record which was send to the server
	 * @protected
	 */
	compareResponseDataToRecord: function(data, record)
	{
		...
		return record.phantom || Grommunio.core.EntryId.compareEntryIds(data.entryid, record.get('entryid'));
	},
