...
/**
 * @class Grommunio.core.data.UIFactoryLayer
 * @extends Object
 *
 * A Layer object which must be {@link Grommunio.core.data.UIFactory#registerLayer registered}}
 * to the {@link Grommunio.core.data.UIFactory UIFactory}. This object describes the
 * Layer on which a {@link Grommunio.core.ui.ContentPanel Content Panel} can be placed.
 */
Grommunio.core.data.UIFactoryLayer = Ext.extend(Object, {
	/**
	 ...
	 * {@link Grommunio.core.data.UIFactory#getPreferredLayer} for
