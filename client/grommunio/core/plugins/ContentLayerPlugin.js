...
/**
 * @class Grommunio.core.plugins.ContentLayerPlugin
 * @extends Object
 * @ptype grommunio.contentlayerplugin
 *
 * The Plugin which must be installed on the {@link Grommunio.core.ui.ContentPanel}
 ...
 * {@link Grommunio.core.ui.ContentPanel panel} are forwarded correctly to the content layer.
 */
Grommunio.core.plugins.ContentLayerPlugin = Ext.extend(Object, {
	/**
	 * The Content Panel on which this plugin is installed.
	 * @property
	 * @type Grommunio.core.ui.ContentPanel
	 * @protected
	 */
	field: undefined,
	 ...
	 * @param {Grommunio.core.ui.ContentPanel} field The panel on which the plugin is installed
	 */
	init: function(field)
	{
		this.field = field;
	 ...
	 * @param {Grommunio.core.ui.ContentPanel} field The component that triggered the event
...
Ext.preg('grommunio.contentlayerplugin', Grommunio.core.plugins.ContentLayerPlugin);
