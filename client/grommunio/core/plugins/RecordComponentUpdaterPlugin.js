...
/**
 * @class Grommunio.core.plugins.RecordComponentUpdaterPlugin
 * @extends Object
 ...
 * contains the {@link Grommunio.core.plugins.RecordComponentPlugin RecordComponent} plugin.
 *
 * This plugin will hook into the {@link Grommunio.core.plugins.RecordComponentPlugin#setrecord setrecord}
 * {@link Grommunio.core.plugins.RecordComponentPlugin#updaterecord updaterecord} events and call
 * the {@link Ext.Container#update update} function with the {@link Ext.data.Record Record}
 * argument.
 */
Grommunio.core.plugins.RecordComponentUpdaterPlugin = Ext.extend(Object, {
	/**
	 * @cfg {Ext.Container} rootContainer (optional) The container on which
	 * the {@link Grommunio.core.plugins.RecordComponentPlugin RecordComponent} plugin has been
	 ...
	 * {@link Ext.Container container} which has the {@link Grommunio.core.plugins.RecordComponentPlugin RecordComponent}
	 * plugin installed.
	 *
	 ...
	 * {@link #rootContainer} which contains the {@link Grommunio.core.plugins.RecordComponentPlugin RecordComponent}
	...
	onFirstBeforeRender: function()
	{
		...
		while (!(root.recordComponentPlugin instanceof Grommunio.core.plugins.RecordComponentPlugin)) {
			root = root.ownerCt;
	 ...
	 *
	 * This will load the current {@link Grommunio.core.data.IPMRecord Record} using
	 ...
	 * @param {Grommunio.core.data.IPMRecord} record The record which was set
	...
	/**
	 * Event handler for the {@link Grommunio.core.plugins.RecordComponentPlugin#updaterecord updaterecord} event.
	 * This will call the {@link Ext.Container#update update} function
	 * to update the {@link #field} to which this plugin is attached
	 *
	 * @param {Ext.Container} panel The panel to which the record belongs
	...
	/**
	 * Event handler for the {@link Grommunio.core.plugins.RecordComponentPlugin#exceptionrecord exceptionrecord} event.
	...
	/**
	 * Event handler for the {@link Grommunio.core.plugins.RecordComponentPlugin#beforesave beforesave} event.
	...
	/**
	 * Event handler for the {@link Grommunio.core.plugins.RecordComponentPlugin#beforesendrecord beforesendrecord} event.
	 * This will call the 'updateRecord' function to update the {@link #record} based on the
	 * information from the {@link #field}.
	 *
	 * @param {Ext.Container} panel The panel to which the record belongs.
...
Ext.preg('grommunio.recordcomponentupdaterplugin', Grommunio.core.plugins.RecordComponentUpdaterPlugin);
