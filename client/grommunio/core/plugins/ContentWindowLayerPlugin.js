...
/**
 * @class Grommunio.core.plugins.ContentWindowLayerPlugin
 * @extends Grommunio.core.plugins.ContentLayerPlugin
 * @ptype grommunio.contentwindowlayerplugin
 *
 * Implementation of the {@link Grommunio.core.plugins.ContentLayerPlugin ConentLayerPlugin}
 * which supports placing the {@link Grommunio.core.ui.ContentPanel Content Panel} inside a
 * {@link Ext.Window Window}.
 */
Grommunio.core.plugins.ContentWindowLayerPlugin = Ext.extend(Grommunio.core.plugins.ContentLayerPlugin, {
	/**
	...
	/**
	 * @cfg {Array} windowRelays The list of event names which should be {@link Grommunio.core.ui.ContentPanel#relayEvents relayed}
	...
	constructor: function(config)
	{
		...
		Grommunio.core.plugins.ContentWindowLayerPlugin.superclass.constructor.call(this, config);
	},
	...
	initPlugin: function()
	{
		...
		Grommunio.core.plugins.ContentWindowLayerPlugin.superclass.initPlugin.apply(this, arguments);
...
Ext.preg('grommunio.contentwindowlayerplugin', Grommunio.core.plugins.ContentWindowLayerPlugin);
