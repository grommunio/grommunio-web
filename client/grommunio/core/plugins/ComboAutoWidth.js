Ext.ns('Grommunio.core.plugins');

/**
 * @class Grommunio.core.plugins.ComboAutoWidth
 * @extends Ext.util.Observable
 * @ptype grommunio.comboautowidth
 *
 * this plugin will set the width of the combo box to the width of the maximum text in list
 */
Grommunio.core.plugins.ComboAutoWidth = Ext.extend(Ext.util.Observable, {
	/**
...
Ext.preg('grommunio.comboautowidth', Grommunio.core.plugins.ComboAutoWidth);
