...
/**
 * @class Grommunio.core.plugins.RecordComponentPlugin
 * @extends Object
 ...
 * located which share a {@link Grommunio.core.data.MAPIRecord record} for displaying or editing.
 * This can for example occur in a {@link Ext.Window Dialog} which is used for editing a message,
 * or in the {@link Grommunio.core.ui.PreviewPanel PreviewPanel} for displaying a message.
 *
 * If the {@link #allowWrite} option is enabled, the {@link #record} will be editable, this will be done
 * by copying the {@link #record} into the {@link Grommunio.core.data.ShadowStore ShadowStore}
 * from where it can be saved to the server.
 *
 * The components located in the root {@link Ext.Container container} can use the
 * {@link Grommunio.core.ui.RecordComponentUpdaterPlugin RecordComponentUpdaterPlugin} for handling the notifications
 * from this plugin.
 *
 ...
 */
Grommunio.core.plugins.RecordComponentPlugin = Ext.extend(Object, {
	/**
	 ...
	 * made to the {@link #record} from a {@link Grommunio.core.data.MAPIStore Store}. This will force
	 ...
	 * - record {@link Grommunio.core.data.MAPIRecord} The record which is being loaded
	 ...
	 * {@link Grommunio.core.data.MAPIRecord#open open} the {@link #record} when it is set
	 * on the {@link #field}.
	 */
	...
	init: function(field)
	{
		...
		this.field.addEvents(
			 ...
			 * This will allow Subclasses modify the {@link Grommunio.core.data.MAPIRecord record} before
			 * it has been hooked into the {@link #field}.
			 * @param {Ext.Container} panel The panel to which the record was set
			 * @param {Grommunio.core.data.MAPIRecord} record The record which is going to be set
			 * @param {Grommunio.core.data.MAPIRecord} oldrecord The oldrecord which is currently set
			 ...
			 * Fired from {@link #field}
			 *
			 * Fires when a record is going to be {@link Grommunio.core.data.MAPIRecord#isOpened opened},
			 ...
			 * Fired from {@link #field}
			 *
			 * Fires when a record has been {@link Grommunio.core.data.MAPIRecord#isOpened opened},
			 ...
			 * through a {@link Grommunio.core.data.MAPIStore store}.
			 * No event handler may modify any properties inside the provided record.
			 * @param {Ext.Container} panel The panel to which the record was set
			 ...
			 * @param {Ext.Container} panel The panel to which the record was set
			 * @param {Grommunio.core.data.MAPIRecord} record The record which is dirty
			 */
			'userupdaterecord',
			/**
			 ...
			 * Fired from {@link #field}
			 *
			 * Fires when write event was fired by the {@link Grommunio.core.data.MAPIStore store}.
			 * @param {Ext.data.Store} store
			 * @param {String} action [Ext.data.Api.actions.create|update|destroy]
			 * @param {Object} result The 'data' picked-out out of the response for convenience.
			 * @param {Ext.Direct.Transaction} res
			 * @param {Grommunio.core.data.IPMRecord[]} records Store's records, the subject(s) of the write-action
			 */
			'writerecord'
		);
	...
	/**
	 * Start editing on a {@link Grommunio.core.data.MAPIRecord record} by hooking
	 * it into the {@link Grommunio.core.data.ShadowStore ShadowStore} and mark the
	 * {@link Grommunio.core.data.MAPIRecord record} as being edited. This function
	 * should only be called when {@link #useShadowStore} is set to true.
	 *
	 * @param {Grommunio.core.data.MAPIRecord} record The record to edit
	 * @private
	 */
	...
	/**
	 * Stop editing on a {@link Grommunio.core.data.MAPIRecord record} by unhooking it
	 * from the {@link Grommunio.core.data.ShadowStore ShadowStore}. This function
	 * should only be called when {@link #useShadowStore} is set to true.
	 *
	 * @param {Grommunio.core.data.MAPIRecord} record The record to finish editing
	 * @private
	 */
	...
	/**
	 * Check if the given {@link Grommunio.core.data.MAPIRecord record} matches the {@link #record}
	 ...
	 *
	 * @param {Grommunio.core.data.MAPIRecord} record The record to compare
	...
	/**
	 * Set the {@link Grommunio.core.data.MAPIRecord record} which must be shown inside the {@link #field}
	 ...
	 * set on this field. Depending on the {@link Grommunio.core.data.MAPIRecord#isOpened opened} status
	 ...
	 * @param {Grommunio.core.data.MAPIRecord} record The record to be opened
	 ...
	 *
	 * @return {Grommunio.core.data.MAPIRecord} The record which is currently active
	 */
	 ...
	 * @param {Grommunio.core.data.MAPIRecord} record The record to load
	 ...
	 * @param {Grommunio.core.data.MAPIRecord} record The record to perform the action on
	 ...
	 * {@link Grommunio.core.data.MAPIRecord#updateModifications updateModifications} and
	 * {@link Grommunio.core.data.MAPIRecord#updateSubStoreModifications updateSubStoreModifications}
	 * to see if they were modified.
	 * @param {Grommunio.core.data.MAPIRecord} record The record to validate
	 * @private
	 */
	 ...
	 *
	 * This will register additional event handlers on the {@link Grommunio.core.data.MAPIStore store}.
	 *
	 * @param {Grommunio.core.data.MAPIRecord} record The record which has been loaded
	 * @private
	 */
	...
	/**
	 * Event handler will be called when the {@link Grommunio.core.data.MAPIStore Store} has
	 * updated the {@link Grommunio.core.data.MAPIRecord record}. This function will fire
	 * {@link #updaterecord} event to notify that the record is updated.
	 *
	 * @param {Grommunio.core.data.IPMStore} store The store in which the record is located.
	...
	onExceptionRecord: function(proxy, type, action, options, response, args)
	{
		...
		if(!(record instanceof Grommunio.core.data.MAPIRecord) || !this.isRecordInContainer(record)){
			return;
		}
	 ...
	 * This will remove the {@link Grommunio.core.data.MAPIRecord record} from the
	 * {@link Grommunio.core.data.ShadowStore ShadowStore} (when the record was being {@link #allowWrite edited}).
...
Ext.preg('grommunio.recordcomponentplugin', Grommunio.core.plugins.RecordComponentPlugin);
