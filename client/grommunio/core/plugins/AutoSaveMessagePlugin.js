...
/**
 * @class Grommunio.core.plugins.AutoSaveMessagePlugin
 * @extends Object
 ...
 */
Grommunio.core.plugins.AutoSaveMessagePlugin = Ext.extend(Object, {
	/**
	...
	startMessageAutoSaveTimer: function()
	{
		if (!this.messageAutoSaveTimer && this.record && this.record.isUnsent()) {
			var timeout = container.getSettingsModel().get('grommunio/v1/contexts/mail/autosave_time') * 1000;
	 ...
	 * {@link Grommunio.common.Actions.messageAutoSave autosave} the {@link #record}.
	 * @private
	 */
	messageAutoSave: function()
	{
		if (this.record) {
			if (Grommunio.common.ui.SecurityButtons.suspendsAutoSave(this.record)) {
...
Ext.preg('grommunio.autosavemessageplugin', Grommunio.core.plugins.AutoSaveMessagePlugin);
