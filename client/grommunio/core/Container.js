/**
 * @class Grommunio.core.Container
 * @extends Object
 *
 ...
 */
Grommunio.core.Container = Ext.extend(Ext.util.Observable, {
	/**
	 * List of registered {@link Grommunio.core.Context context instances}.
	 * @property
	 * @private
	 * @type Array
	 */
	 ...
	 * of {@link Grommunio.core.ContextMetaData ContextMetaData instances}.
	 * @property
	 * @private
	 * @type Array
	 */
	...
	/**
	 * List of registered {@link Grommunio.core.Plugin plugin instances}
	 ...
	 * of {@link Grommunio.core.PluginMetaData PluginMetaData instances}.
	 * @property
	 * @private
	 * @type Array
	 */
	...
	/**
	 * The Meta Data for all registered {@link Grommunio.core.ui.widget.Widget widgets}. This is an array
	 * of {@link Grommunio.core.ui.widget.WidgetMetaData WidgetMetaData instances}.
	 * @property
	 * @private
	 * @type Array
	 */
	...
	constructor: function()
	{
		this.addEvents([
			 ...
			 * @event folderselect
			 * @param {Grommunio.hierarchy.data.MAPIFolderRecord[]} folder MAPI folder object.
			 */
			'folderselect',
			/**
			...
			'logout',
			/**
			 * Fires when the {@link Grommunio.core.ui.MainContentTabPanel MainContentTabPanel} rendered successfully.
			 * @event afterrendercontentpanel
			 * @param {Grommunio.core.ui.MainContentTabPanel} MainContentTabPanel The main content tab panel.
			 */
			'afterrendercontentpanel'
		]);

		Grommunio.core.Container.superclass.constructor.call(this);
	...
	{
		var user = ((preserveUser === true) ? this.getUser().getUserName() : '');
		...
		if (preserveSession !== true) {
			...
			window.location = 'index.php?load=logon' + ((preserveUser === true) ? ('&user=' + encodeURIComponent(user)) : '');
		}
	},

	/**
	 * Obtain the server configuration data
	 * @return {Grommunio.core.data.ServerConfig} The server configuration data
	 */
	...
	{
		this.serverConfigRecord = new Grommunio.core.data.ServerConfig(serverData);
	},

	/**
	 * Obtain the user data for the currently logged in user.
	 * @return {Grommunio.core.data.User} The user data of the currently logged in user.
	 */
	getUser: function()
	{
	...
	{
		this.userRecord = new Grommunio.core.data.User(userData);
	},

	/**
	 * Obtain the versioning data for grommunio Web environment
	 * @return {Grommunio.core.data.Version} The version data of the grommunio Web environment
	 */
	getVersion: function()
	{
	...
	{
		this.versionRecord = new Grommunio.core.data.Version(versionData);
	},
	...
	/**
	 * Returns the currently active {@link Grommunio.core.Context context}.
	 * @return {Grommunio.core.Context} the currently active context.
	 */
	...
	/**
	 * Returns the global {@link Grommunio.core.Request request} instance.
	 * All server requests should be lodged through this instance.
	 *
	 * @return {Grommunio.core.Request} the global {@link Grommunio.core.Request Request} instance.
	 */
	getRequest: function()
	{
		return this.request || (this.request = new Grommunio.core.Request({ url:"grommunio.php" }));
	},

	/**
	 * Returns the global {@link Grommunio.core.ResponseRouter ResponseRouter} instance.
	 * All server responses are lodged through this instance.
	 *
	 * @return {Grommunio.core.ResponseRouter} the global {@link Grommunio.core.ResponseRouter ResponseRouter} instance.
	 */
	getResponseRouter: function()
	{
		return this.responseRouter || (this.responseRouter = new Grommunio.core.ResponseRouter());
	},

	/**
	 * Returns the global {@link Grommunio.core.data.NotificationResolver NotificationResolver} instance.
	 * All notifications are being resolved through this instance, the constructed
	 * {@link Grommunio.core.data.AbstractResponseHandler ResponseHandler} is then returned to the
	 * {@link Grommunio.core.ResponseRouter ResponseRouter} for further processing.
	 *
	 * @return {Grommunio.core.data.NotificationResolver} the global {@link Grommunio.core.data.NotificationResolver NotificationResolver} instance.
	 */
	getNotificationResolver: function()
	{
		return this.notificationResolver || (this.notificationResolver = new Grommunio.core.data.NotificationResolver());
	},

	/**
	 * Returns the global {@link Grommunio.hierarchy.data.HierarchyStore HierarchyStore} instance.
	 * @return {Grommunio.hierarchy.data.HierarchyStore} the global {@link Grommunio.hierarchy.data.HierarchyStore HierarchyStore} instance.
	 */
	getHierarchyStore: function()
	{
		return this.hierarchyStore || (this.hierarchyStore = new Grommunio.hierarchy.data.HierarchyStore());
	},

	/**
	 * Returns the global {@link Grommunio.common.outofoffice.data.OofStore OofStore} instance.
	 * @return {Grommunio.common.outofoffice.data.OofStore} the global {@link Grommunio.common.outofoffice.data.OofStore} instance.
	 */
	getOutOfOfficeStore: function()
	{
		return this.outOfOfficeStore || (this.outOfOfficeStore = new Grommunio.common.outofoffice.data.OofStore());
	},

	/**
	 * Returns the global {@link Grommunio.settings.SettingsModel SettingsModel} instance.
	 * @return {Grommunio.settings.SettingsModel} the global {@link Grommunio.settings.SettingsModel SettingsModel} instance.
	 */
	getSettingsModel: function()
	{
		return this.settingsModel || (this.settingsModel = new Grommunio.settings.SettingsModel());
	},

	/**
	 * Returns the global {@link Grommunio.settings.PersistentSettingsModel PersistentSettingsModel} instance.
	 * @return {Grommunio.settings.PersistentSettingsModel} the global
	 * {@link Grommunio.settings.PersistentSettingsModel PersistentSettingsModel} instance.
	 */
	getPersistentSettingsModel: function()
	{
		return this.persistentSettingsModel || (this.persistentSettingsModel = new Grommunio.settings.PersistentSettingsModel());
	},

	/**
	 * Returns the {@link Grommunio.core.data.ShadowStore ShadowStore} instance.
	 * @return {Grommunio.core.data.ShadowStore} the {@link Grommunio.core.data.ShadowStore ShadowStore} instance.
	 */
	getShadowStore: function()
	{
		return this.shadowStore || (this.shadowStore = new Grommunio.core.data.ShadowStore());
	},

	/**
	 * Returns the {@link Grommunio.core.ui.notifier.Notifier Notifier} instance which can be used
	 * for sending notifications to the user.
	 * @return {Grommunio.core.ui.notifier.Notifier} The notifier for User notifications
	 */
	getNotifier: function()
	{
		return this.notifier || (this.notifier = new Grommunio.core.ui.notifier.Notifier());
	},

	/**
	 * Returns the {@link Grommunio.core.data.UndoManager UndoManager} instance which
	 * records undoable user actions and performs undo/redo operations.
	 * @return {Grommunio.core.data.UndoManager} the UndoManager instance.
	 */
	getUndoManager: function()
	{
		return this.undoManager || (this.undoManager = new Grommunio.core.data.UndoManager());
	},

	/**
	 * Returns the application main panel.
	 * @return {Grommunio.core.ui.MainViewport} the application main panel.
	 */
	getMainPanel: function()
	{
		return this.mainPanel || (this.mainPanel = new Grommunio.core.ui.MainViewport());
	},

	/**
	 * Returns the applications main toolbar
	 * @return {Grommunio.core.ui.MainToolbar} then application main tool bar
	 */
	 ...
	 * @return {Grommunio.core.ui.WelcomeViewport} the application welcome panel.
	 */
	getWelcomePanel: function()
	{
		return this.welcomePanel || (this.welcomePanel = new Grommunio.core.ui.WelcomeViewport());
	},

	/**
	 * Returns the application tab panel
	 * @return {Grommunio.core.ui.ContextContainer} The application tab panel
	 */
	 ...
	 * @return {Grommunio.common.ui.ContextMainPanel} the application content panel.
	 */
	 ...
	 * @return {Grommunio.core.ui.NavigationPanel} the navigation sidebar
	 */
	 ...
	 * @return {Grommunio.core.ui.widget.WidgetPanel} the application widget sidebar.
	 */
	...
	/**
	 * Returns an array of all registered {@link Grommunio.core.Plugin plugins}.
	...
	/**
	 * Returns the Meta Data for {@link #pluginsMetaData all registered} {@link Grommunio.core.Plugin plugins}.
	...
	/**
	 * Returns an array of all registered {@link Grommunio.core.Context contexts}.
	...
	/**
	 * Returns the Meta Data for {@link #contextsMetaData all registered} {@link Grommunio.core.Context contexts}.
	...
	/**
	 * Returns the Meta Data for {@link #widgetsMetaData all registered} {@link Grommunio.core.ui.widget.Widget widgets}.
	 ...
	 * @return {Grommunio.core.Context} matching context or <code>undefined</code> if not found.
	 */
	 ...
	 * @return {Grommunio.core.ContextMetaData} The Meta Data for the context or <code>undefined</code> if not found.
	 */
	 ...
	 * @return {Grommunio.core.Plugin} matching plug-in or <code>undefined</code> if not found.
	 */
	 ...
	 * @return {Grommunio.core.PluginMetaData} The Meta Data for the plugin or <code>undefined</code> if not found.
	 */
	 ...
	 * @return {Grommunio.core.ui.widget.WidgetMetaData} The Meta Data for the widget or <code>undefined</code> if not found.
	 */
	 ...
	 * @param {Grommunio.core.ContextMetaData} info context to register
	 */
	 ...
	 * @param {Grommunio.core.PluginMetaData} info plugin info to register
	 */
	 ...
	 * @param {Grommunio.core.ui.widget.WidgetMetaData} info widget meta data to register
	 */
	 ...
	 * @param {Grommunio.core.Context} context context to switch to.
	 * @param {Grommunio.hierarchy.data.MAPIFolderRecord} folder folder that should be shown by the selected context.
	 * @param {Boolean} suspended True if the {@link Grommunio.core.ContextModel model} for the
	 * {@link Grommunio.core.Context context} should be enabled {@link Grommunio.core.ContextModel#suspendLoading suspended}.
	 * @private
	 */
	 ...
	 * @param {Grommunio.hierarchy.data.MAPIFolderRecord} folder folder for which we need to find corresponding context.
	 * @return {Grommunio.core.Context} context that should be used to load data from {@link Grommunio.hierarchy.data.MAPIFolderRecord MAPIFolder}.
	 */
	 ...
	 * @param {Grommunio.hierarchy.data.MAPIFolderRecord[]} folder folder to select either as an array of
	 ...
	 * @param {Grommunio.hierarchy.data.MAPIFolderRecord} folder which is changed
	 */
	 ...
	 * {@link Grommunio.core.ContextModel model} fires the {@link Grommunio.core.ContextModel#folderchange} event.
	 ...
	 * @param {Grommunio.hierarchy.data.MAPIFolderRecord[]} folders The folders which are
	 * currently selected
	 * @private
	 */
	...
	/**
	 * Returns the global {@link Grommunio.common.reminder.data.ReminderStore RemimderStore} instance.
	 * @return {Grommunio.common.reminder.data.ReminderStore} instance.
	 */
	getReminderStore: function()
	{
		return this.reminderStore || (this.reminderStore = new Grommunio.common.reminder.data.ReminderStore());
	},
	...
	/**
	 * Returns instance of factory registered with {@link Grommunio.common.data.AbstractRulesFactory} factory
	 * depending on factoryType given in the parameter.
	 *
	 * @param {Grommunio.common.data.RulesFactoryType} factoryType type of the required factory.
	 * @return {Object} factory instance based on factoryType.
	 */
	getRulesFactoryByType: function(factoryType)
	{
		return Grommunio.common.data.AbstractRulesFactory.getFactoryById(factoryType);
	},
	...
	isEnabledConversation: function ()
	{
		return this.getServerConfig().isConversationViewEnabled() &&
			this.getSettingsModel().get("grommunio/v1/contexts/mail/enable_conversation_view", false);
	}
});
