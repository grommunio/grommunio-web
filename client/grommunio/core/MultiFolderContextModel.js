...
/**
 * @class Grommunio.core.MultiFolderContextModel
 ...
 * of tabbed view.
 */
Grommunio.core.MultiFolderContextModel = Ext.extend(Grommunio.core.ContextModel, {
	/**
	...
	constructor: function(config)
	{
		...
		Grommunio.core.MultiFolderContextModel.superclass.constructor.call(this, config);
	...
	{
		Grommunio.core.MultiFolderContextModel.superclass.enable.apply(this, arguments);
	...
	{
		Grommunio.core.MultiFolderContextModel.superclass.onFolderChange.apply(this, arguments);
	...
	onHierarchyLoad: function(hierarchyStore)
	{
		...
		Grommunio.core.MultiFolderContextModel.superclass.onHierarchyLoad.apply(this, arguments);
	...
	getDefaultFolder: function()
	{
		...
		// fallback to parent
		return Grommunio.core.MultiFolderContextModel.superclass.getDefaultFolder.apply(this, arguments);
	},

	/**
	 * Updates a group in the {@link #groupings} to mark it as active.
	 * @param {Grommunio.hierarchy.data.MAPIFolderRecord} folder The folder which is activated
	...
	/**
	 * Moves a {@link Grommunio.hierarchy.data.MAPIFolderRecord folder} from an existing
	 * group to a new Group in the {@link #groupings}.
	 * @param {Grommunio.hierarchy.data.MAPIFolderRecord} folder The folder to move to the other group
	...
	/**
	 * Move a {@link Grommunio.hierarchy.data.MAPIFolderRecord folder} out of the current group and
	 * create a new group into which the folder should be moved.
	 * @param {Grommunio.hierarchy.data.MAPIFolderRecord} folder The folder to move to a new group
	 * @param {String} oldGroup The group from where the folder is moved
	 * @return {String} The groupID to which the folder was added.
	 */
	...
	/**
	 * Remove a {@link Grommunio.hierarchy.data.MAPIFolderRecord folder} out of the current group.
	 * @param {Grommunio.hierarchy.data.MAPIFolderRecord} folder The folder to move to a new group
	 * @param {String} oldGroup The group from where the folder is moved
	 */
	 ...
	 * @return {Object} The color scheme as defined in {@link Grommunio.calendar.ui.ColorSchemes color scheme}
	 * for this folder
	 */
	 ...
	 * @param {Grommunio.hierarchy.data.MAPIFolderRecord} Folder object to map
	...
	{
		Grommunio.core.MultiFolderContextModel.superclass.initStateEvents.call(this);
	...
	getState: function()
	{
		var state = Grommunio.core.MultiFolderContextModel.superclass.getState.call(this) || {};
