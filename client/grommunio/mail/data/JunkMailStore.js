...
/**
 * @class Grommunio.mail.data.JunkMailStore
 ...
 * @singleton
 */
Grommunio.mail.data.JunkMailStore = Ext.extend(Ext.util.Observable, {
	/**
	...
	{
		Grommunio.mail.data.JunkMailStore.superclass.constructor.call(this);
		...
		this.addEvents(
			 ...
			 * @param {Grommunio.mail.data.JunkMailStore} store
			 */
			'load',
			/**
			 * @event save
...
Grommunio.mail.data.JunkMailStore = new Grommunio.mail.data.JunkMailStore();
