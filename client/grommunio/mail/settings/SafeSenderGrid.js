...
/**
 * @class Grommunio.mail.settings.SafeSenderGrid
 * @extends Ext.grid.GridPanel
 * @xtype grommunio.safesendergrid
 *
 * {@link Grommunio.mail.settings.SafeSenderGrid SafeSenderGrid} will be used to display
 * list of safe sender's email address or domain name.
 */
Grommunio.mail.settings.SafeSenderGrid = Ext.extend(Ext.grid.GridPanel, {
	/**
	 * @constructor
	...
	constructor: function (config) {
		...
		Grommunio.mail.settings.SafeSenderGrid.superclass.constructor.call(this, config);
	},

	/**
	 * Event fired when the {@link Grommunio.mail.settings.SafeSenderGrid grid} fires the
	 * {@link Grommunio.mail.settings.SafeSenderGrid#viewready viewready} event. This will check
	 ...
	 * from {@link Grommunio.mail.settings.SafeSenderGrid#store store}
	 * @private
	 */
	...
	addEntry: function(name)
	{
		...
		if (!Grommunio.mail.data.JunkMailStore.isValidEntry(name)) {
			return false;
		}
...
Ext.reg('grommunio.safesendergrid', Grommunio.mail.settings.SafeSenderGrid);
