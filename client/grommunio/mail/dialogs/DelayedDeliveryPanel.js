...
/**
 * @class Grommunio.mail.dialogs.DelayedDeliveryPanel
 * @extends Ext.Panel
 * @xtype grommunio.delayeddeliverypanel
 *
 * Panel for users to set the deferred_send_time on a given {@link Grommunio.mail.MailRecord record}
 */
Grommunio.mail.dialogs.DelayedDeliveryPanel = Ext.extend(Ext.Panel, {
    ...
    constructor: function (config)
    {
        ...
        config = Ext.applyIf(config, {
            xtype: 'grommunio.delayeddeliverypanel',
            border: false,
			cls: 'grommunio-delayeddeliverypanel',
            items: [{
                xtype: 'grommunio.radiospinnerfield',
				cls: 'grommunio-delayeddeliverypanel-radiospinnerfield',
                type: 'hours',
                value: _('hour(s)'),
                listeners: {
				...
				cls:'grommunio-delayeddeliverypanel-displayfield'
            }, {
                xtype: 'grommunio.radiodatetimefield',
                ref: 'delayedDeliveryDateTimeField',
				cls:'grommunio-delayeddeliverypanel-radiodatetimefield',
                listeners: {
                    focus: this.onFieldFocus,
                    change: this.onFieldChange,
                    scope: this
                ...
                xtype: 'displayfield',
				cls: 'grommunio-delayeddeliverypanel-fields',
                ref: 'timeInfofield'
            }],
            listeners: {
        ...
        Grommunio.mail.dialogs.DelayedDeliveryPanel.superclass.constructor.call(this, config);
    },

    /**
     * Event handler which is called when the {@link Grommunio.common.ui.RadioDateTimeField radioDateTimeField} or
     * {@link Grommunio.common.ui.RadioSpinnerField radioSpinnerField} field receives input focus,
     * this will call {@link #createMessage} for updating the delayInfoMessage value
     * @param {Grommunio.common.ui.RadioSpinnerField|Grommunio.common.ui.RadioDateTimeField} field The field which fired the event
     */
    ...
    /**
     * Event handler which is called when the {@link Grommunio.common.ui.RadioDateTimeField radioDateTimeField} or
     * {@link Grommunio.common.ui.RadioSpinnerField radioSpinnerField} value has changed,
     * this will call {@link #createMessage} for updating the delayInfoMessage value
     * @param {Grommunio.common.ui.RadioSpinnerField|Grommunio.common.ui.RadioDateTimeField} field The field which fired the event
    ...
    getMessageDate: function (dateTime)
    {
        ...
        if (isNaN(dateTime.getTime())) {
            ...
            this.delayedDeliveryDateTimeField.addClass('grommunio-delayeddelivery-invalid-date');
            return delayInfoMessage;
        } else {
    ...
    /**
     * Function set default value in {@link Grommunio.common.ui.RadioDateTimeField radioDateTimeField}
...
Ext.reg('grommunio.delayeddeliverypanel', Grommunio.mail.dialogs.DelayedDeliveryPanel);
