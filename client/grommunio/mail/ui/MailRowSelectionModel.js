...
/**
 * @class Grommunio.mail.ui.MailRowSelectionModel
 * @extends Ext.grid.RowSelectionModel
 *
 * The {@link Grommunio.mail.ui.MailRowSelectionModel MailRowSelectionModel}
 * is the {@link Ext.grid.RowSelectionModel RowSelectionModel} used in the
 * {@link Grommunio.mail.ui.MailGrid MailGrid}.
 ...
 */
Grommunio.mail.ui.MailRowSelectionModel = Ext.extend(Ext.grid.RowSelectionModel, {
	/**
	 ...
	 *
	 * @param {Grommunio.mail.ui.MailGrid} g The mail grid from which the event came
	...
	handleMouseDown: function (g, rowIndex, event) {
		...
		if (preventRowSelection === true) {
			...
			Grommunio.mail.ui.MailRowSelectionModel.superclass.handleMouseDown.call(this, g, rowIndex, event);
		}
	},
...
Ext.reg('grommunio.mailrowselectionmodel', Grommunio.mail.ui.MailRowSelectionModel);
