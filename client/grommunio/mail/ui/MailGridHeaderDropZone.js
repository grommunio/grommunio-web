...
/**
 * @class Grommunio.mail.ui.MailGridHeaderDropZone
 * @extends Ext.grid.HeaderDropZone
 */
Grommunio.mail.ui.MailGridHeaderDropZone = Ext.extend(Ext.grid.HeaderDropZone, {
	...
	{
		var result = Grommunio.mail.ui.MailGridHeaderDropZone.superclass.onNodeOver.apply(this, arguments);
