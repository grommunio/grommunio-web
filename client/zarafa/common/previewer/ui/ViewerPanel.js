...
/**
 * @class Zarafa.common.previewer.ui.ViewerPanel
 ...
 */
Zarafa.common.previewer.ui.ViewerPanel = Ext.extend(Ext.BoxComponent, {
	...
	constructor: function (config)
	{
		...
		this.tag = Zarafa.isDeskApp ? 'webview' : 'iframe';
		if (this.tag === 'webview') {
		...
		Zarafa.common.previewer.ui.ViewerPanel.superclass.constructor.call(this, config);
	},
	...
	{
		var formats = Zarafa.common.previewer.data.Formats;
		...
		var language = settings.get('zarafa/v1/main/language').split('.')[0].replace('_', '-');
	...
	{
		Zarafa.common.previewer.ui.ViewerPanel.superclass.afterRender.apply(this, arguments);
...
Ext.reg('zarafa.viewerpanel', Zarafa.common.previewer.ui.ViewerPanel);
